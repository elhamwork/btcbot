...
**$1,723.93** &nbsp; +72.4% since $1,000 &nbsp;&middot;&nbsp; updated 17 Sep 3:31pm California time

| calls settled | won / lost | win rate | break-even it must beat |
|---|---|---|---|
| 284 | 237 / 47 | 83.5% | 79.9% |

Best $1,915.69, worst $583.05, fees paid $419.28.

### Last 8 calls

| closed | result | paid | account after | side | price |
|---|---|---|---|---|---|
| 17 Sep 3:00pm | won | +52.78 | $1,723.93 | NO | 0.75 |
...
Collecting in the background: 91,673 order-book snapshots over 24 days (needs about three weeks).
