...
**$2,644.58** &nbsp; +164.5% since $1,000 &nbsp;&middot;&nbsp; updated 19 Sep 1:46pm California time

| calls settled | won / lost | win rate | break-even it must beat |
|---|---|---|---|
| 263 | 222 / 41 | 84.4% | 80.0% |

Best $2,680.57, worst $675.59, fees paid $480.75.

### Last 8 calls

| closed | result | paid | account after | side | price |
|---|---|---|---|---|---|
| 19 Sep 1:30pm | won | +39.84 | $2,644.58 | NO | 0.86 |
...
Collecting in the background: 99,510 order-book snapshots over 26 days (needs about three weeks).
