...
**$1,024.08** &nbsp; +2.4% since $1,000 &nbsp;&middot;&nbsp; updated 31 Aug 4:39pm California time

| calls settled | won / lost | win rate | break-even it must beat |
|---|---|---|---|
| 111 | 91 / 20 | 82.0% | 79.5% |

Best $1,511.25, worst $926.62, fees paid $185.10.

### Last 8 calls

| closed | result | paid | account after | side | price |
|---|---|---|---|---|---|
| 31 Aug 4:15pm | won | +16.72 | $1,024.08 | NO | 0.85 |
...
Collecting in the background: 23,583 order-book snapshots over 7 days (needs about three weeks).
