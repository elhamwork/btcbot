...
**$1,123.21** &nbsp; +12.3% since $1,000 &nbsp;&middot;&nbsp; updated 28 Aug 4:01am California time

| calls settled | won / lost | win rate | break-even it must beat |
|---|---|---|---|
| 59 | 49 / 10 | 83.1% | 79.3% |

Best $1,279.61, worst $926.62, fees paid $93.67.

### Last 8 calls

| closed | result | paid | account after | side | price |
|---|---|---|---|---|---|
| 28 Aug 3:45am | won | +39.99 | $1,123.21 | YES | 0.72 |
...
59 of the roughly 100 settled calls needed before this win rate
means much. Two or three losses in the first dozen is ordinary;
four or more in twenty would say the model is wrong.

Collecting in the background: 10,097 order-book snapshots over 4 days (needs about three weeks).
