...
**$1,288.28** &nbsp; +28.8% since $1,000 &nbsp;&middot;&nbsp; updated 30 Aug 6:26am California time

| calls settled | won / lost | win rate | break-even it must beat |
|---|---|---|---|
| 91 | 76 / 15 | 83.5% | 79.1% |

Best $1,433.36, worst $926.62, fees paid $152.00.
...
91 of the roughly 100 settled calls needed before this win rate
means much. Two or three losses in the first dozen is ordinary;
four or more in twenty would say the model is wrong.

Collecting in the background: 17,888 order-book snapshots over 6 days (needs about three weeks).
