...
**$1,381.40** &nbsp; +38.1% since $1,000 &nbsp;&middot;&nbsp; updated 28 Aug 11:57pm California time

| calls settled | won / lost | win rate | break-even it must beat |
|---|---|---|---|
| 73 | 62 / 11 | 84.9% | 79.3% |

Best $1,381.40, worst $926.62, fees paid $118.31.
...
73 of the roughly 100 settled calls needed before this win rate
means much. Two or three losses in the first dozen is ordinary;
four or more in twenty would say the model is wrong.

Collecting in the background: 12,905 order-book snapshots over 5 days (needs about three weeks).
