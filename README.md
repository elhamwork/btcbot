...
**$2,630.01** &nbsp; +163.0% since $1,000 &nbsp;&middot;&nbsp; updated 19 Sep 4:10pm California time

| calls settled | won / lost | win rate | break-even it must beat |
|---|---|---|---|
| 265 | 224 / 41 | 84.5% | 80.1% |

Best $2,630.01, worst $652.64, fees paid $467.50.

### Last 8 calls

| closed | result | paid | account after | side | price |
|---|---|---|---|---|---|
| 19 Sep 3:15pm | won | +39.63 | $2,630.01 | NO | 0.86 |
...
Collecting in the background: 99,915 order-book snapshots over 26 days (needs about three weeks).
