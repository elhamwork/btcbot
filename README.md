...
**$1,358.35** &nbsp; +35.8% since $1,000 &nbsp;&middot;&nbsp; updated 30 Aug 10:02am California time

| calls settled | won / lost | win rate | break-even it must beat |
|---|---|---|---|
| 94 | 79 / 15 | 84.0% | 79.2% |

Best $1,433.36, worst $926.62, fees paid $156.32.
...
94 of the roughly 100 settled calls needed before this win rate
means much. Two or three losses in the first dozen is ordinary;
four or more in twenty would say the model is wrong.

Collecting in the background: 18,501 order-book snapshots over 6 days (needs about three weeks).
