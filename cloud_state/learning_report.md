...
Written 02 Sep 2026 7:33pm California time by `check.py --report`.
...
| fees paid | $233.24 |
| contracts looked at | 909 |
| retired (old rule, not counted) | 10 |
| of those, settled and learned from | 908 |
...
The 63-day study is worth 30 observations per row below. So 908 live
...
| 50-55% | 0.558 | 0.532 | 195 (103 hit) | -0.026 ** |
...
Leaned YES 493 times, NO 416 times. Over 63 days of history the
