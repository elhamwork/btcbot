...
Written 13 Sep 2026 5:13am California time by `check.py --report`.
...
| fees paid | $413.22 |
| contracts looked at | 1891 |
| retired (old rule, not counted) | 10 |
| of those, settled and learned from | 1890 |
...
The 63-day study is worth 30 observations per row below. So 1890 live
...
| 60-65% | 0.678 | 0.600 | 149 (87 hit) | -0.078 ** |
...
Leaned YES 1015 times, NO 876 times. Over 63 days of history the
