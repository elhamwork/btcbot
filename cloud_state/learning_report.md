...
Written 10 Sep 2026 4:38pm California time by `check.py --report`.
...
| fees paid | $385.61 |
| contracts looked at | 1649 |
| retired (old rule, not counted) | 10 |
| of those, settled and learned from | 1648 |
...
The 63-day study is worth 30 observations per row below. So 1648 live
...
Leaned YES 872 times, NO 777 times. Over 63 days of history the
