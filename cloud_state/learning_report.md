...
Written 11 Sep 2026 6:15pm California time by `check.py --report`.
...
| fees paid | $399.05 |
| contracts looked at | 1751 |
| retired (old rule, not counted) | 10 |
| of those, settled and learned from | 1750 |
...
The 63-day study is worth 30 observations per row below. So 1750 live
...
Leaned YES 928 times, NO 823 times. Over 63 days of history the
