...
Written 08 Sep 2026 4:38am California time by `check.py --report`.
...
| fees paid | $320.18 |
| contracts looked at | 1417 |
| retired (old rule, not counted) | 10 |
| of those, settled and learned from | 1416 |
...
The 63-day study is worth 30 observations per row below. So 1416 live
...
| 40-45% | 0.384 | 0.388 | 180 (70 hit) | +0.004 |
...
Leaned YES 751 times, NO 666 times. Over 63 days of history the
