...
Written 09 Sep 2026 3:45pm California time by `check.py --report`.
...
| of those, settled and learned from | 1556 |
...
The 63-day study is worth 30 observations per row below. So 1556 live
...
| 45-50% | 0.497 | 0.479 | 314 (150 hit) | -0.017 |
