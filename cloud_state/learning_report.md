...
Written 04 Sep 2026 3:44am California time by `check.py --report`.
...
| fees paid | $253.95 |
| contracts looked at | 1029 |
| retired (old rule, not counted) | 10 |
| of those, settled and learned from | 1028 |
| actual calls (graded GOOD) | 164 |
| calls that have settled | 164 |
| alerts that reached the phone | 112 of 112 |
...
The 63-day study is worth 30 observations per row below. So 1028 live
...
| 40-45% | 0.384 | 0.386 | 127 (49 hit) | +0.001 |
| 45-50% | 0.497 | 0.480 | 195 (93 hit) | -0.017 |
| 50-55% | 0.558 | 0.537 | 217 (116 hit) | -0.020 ** |
| 55-60% | 0.605 | 0.540 | 148 (78 hit) | -0.065 ** |
...
Leaned YES 561 times, NO 468 times. Over 63 days of history the
