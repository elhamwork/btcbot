...
Written 05 Sep 2026 1:41am California time by `check.py --report`.
...
| fees paid | $271.29 |
| contracts looked at | 1117 |
| retired (old rule, not counted) | 10 |
| of those, settled and learned from | 1116 |
...
The 63-day study is worth 30 observations per row below. So 1116 live
...
| 50-55% | 0.558 | 0.529 | 236 (124 hit) | -0.029 ** |
...
Leaned YES 606 times, NO 511 times. Over 63 days of history the
