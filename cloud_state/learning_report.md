...
Written 05 Sep 2026 8:48am California time by `check.py --report`.
...
| fees paid | $273.17 |
| contracts looked at | 1146 |
| retired (old rule, not counted) | 10 |
| of those, settled and learned from | 1145 |
...
The 63-day study is worth 30 observations per row below. So 1145 live
...
| 45-50% | 0.497 | 0.485 | 217 (105 hit) | -0.011 |
...
Leaned YES 623 times, NO 523 times. Over 63 days of history the
