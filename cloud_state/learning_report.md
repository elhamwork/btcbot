...
Written 03 Sep 2026 10:58am California time by `check.py --report`.
...
| fees paid | $240.12 |
| contracts looked at | 962 |
| retired (old rule, not counted) | 10 |
| of those, settled and learned from | 961 |
...
The 63-day study is worth 30 observations per row below. So 961 live
...
Leaned YES 524 times, NO 438 times. Over 63 days of history the
