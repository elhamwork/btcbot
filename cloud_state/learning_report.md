...
Written 29 Aug 2026 6:03pm California time by `check.py --report`.
...
| fees paid | $140.38 |
| contracts looked at | 522 |
| retired (old rule, not counted) | 10 |
| of those, settled and learned from | 521 |
...
The 63-day study is worth 30 observations per row below. So 521 live
...
Leaned YES 293 times, NO 229 times. Over 63 days of history the
