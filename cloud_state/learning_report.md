...
Written 10 Sep 2026 1:46pm California time by `check.py --report`.
...
| fees paid | $385.61 |
| contracts looked at | 1638 |
| retired (old rule, not counted) | 10 |
| of those, settled and learned from | 1636 |
...
The 63-day study is worth 30 observations per row below. So 1636 live
...
| 50-55% | 0.558 | 0.519 | 343 (177 hit) | -0.038 ** |
...
Leaned YES 864 times, NO 774 times. Over 63 days of history the
