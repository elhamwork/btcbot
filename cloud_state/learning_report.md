...
Written 28 Aug 2026 10:21pm California time by `check.py --report`.
...
| fees paid | $115.87 |
| contracts looked at | 445 |
| retired (old rule, not counted) | 10 |
| of those, settled and learned from | 444 |
...
The 63-day study is worth 30 observations per row below. So 444 live
...
Leaned YES 241 times, NO 204 times. Over 63 days of history the
