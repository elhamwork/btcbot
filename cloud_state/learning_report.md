...
Written 30 Aug 2026 1:18am California time by `check.py --report`.
...
| fees paid | $149.89 |
| contracts looked at | 551 |
| retired (old rule, not counted) | 10 |
| of those, settled and learned from | 550 |
...
The 63-day study is worth 30 observations per row below. So 550 live
...
| 40-45% | 0.384 | 0.348 | 72 (24 hit) | -0.036 ** |
...
Leaned YES 309 times, NO 242 times. Over 63 days of history the
