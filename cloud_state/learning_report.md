...
Written 05 Sep 2026 1:23pm California time by `check.py --report`.
...
| fees paid | $278.41 |
| contracts looked at | 1164 |
| retired (old rule, not counted) | 10 |
| of those, settled and learned from | 1163 |
...
The 63-day study is worth 30 observations per row below. So 1163 live
...
| 45-50% | 0.497 | 0.480 | 222 (106 hit) | -0.017 |
...
Leaned YES 629 times, NO 535 times. Over 63 days of history the
