...
Written 28 Aug 2026 4:16pm California time by `check.py --report`.
...
| of those, settled and learned from | 419 |
...
The 63-day study is worth 30 observations per row below. So 419 live
