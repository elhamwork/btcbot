...
Written 28 Aug 2026 7:57am California time by `check.py --report`.
...
| fees paid | $99.20 |
| contracts looked at | 400 |
| retired (old rule, not counted) | 10 |
| of those, settled and learned from | 398 |
...
The 63-day study is worth 30 observations per row below. So 398 live
...
| 50-55% | 0.558 | 0.523 | 88 (45 hit) | -0.035 ** |
...
Leaned YES 222 times, NO 178 times. Over 63 days of history the
