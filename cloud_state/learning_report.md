...
Written 03 Sep 2026 6:54pm California time by `check.py --report`.
...
| fees paid | $243.72 |
| contracts looked at | 994 |
| retired (old rule, not counted) | 10 |
| of those, settled and learned from | 993 |
...
The 63-day study is worth 30 observations per row below. So 993 live
...
Leaned YES 543 times, NO 451 times. Over 63 days of history the
