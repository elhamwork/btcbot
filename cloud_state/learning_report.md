...
Written 11 Sep 2026 5:55am California time by `check.py --report`.
...
| fees paid | $391.76 |
| contracts looked at | 1702 |
| retired (old rule, not counted) | 10 |
| of those, settled and learned from | 1701 |
...
The 63-day study is worth 30 observations per row below. So 1701 live
...
| 40-45% | 0.384 | 0.404 | 214 (87 hit) | +0.019 |
| 45-50% | 0.497 | 0.477 | 341 (162 hit) | -0.020 |
| 50-55% | 0.558 | 0.516 | 363 (186 hit) | -0.042 ** |
...
| 75-80% | 0.836 | 0.810 | 17 (13 hit) | -0.026 ** |
...
Leaned YES 905 times, NO 797 times. Over 63 days of history the
