...
Written 30 Aug 2026 9:01pm California time by `check.py --report`.
...
| of those, settled and learned from | 628 |
...
The 63-day study is worth 30 observations per row below. So 628 live
