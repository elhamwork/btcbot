...
Written 02 Sep 2026 6:35am California time by `check.py --report`.

## The short version

| | |
|---|---|
| **paper account** | **$830.64** (started $1,000, -16.9%) |
| best / worst it has been | $1,511.25 / $797.29 |
| fees paid | $224.50 |
| contracts looked at | 857 |
| retired (old rule, not counted) | 10 |
| of those, settled and learned from | 856 |
| actual calls (graded GOOD) | 140 |
| calls that have settled | 139 |
| alerts that reached the phone | 88 of 88 |
| calls made before delivery was recorded | 52 |
| calls right | 112 of 139 (81%) |
...
The 63-day study is worth 30 observations per row below. So 856 live
...
Leaned YES 470 times, NO 387 times. Over 63 days of history the
...
|---|---|---|---|---|---|
| 13:34 | KXBTC15M-26SEP020945-45 | NO | 0.75 | $83.07 | $26.23 |
