...
Written 07 Sep 2026 8:14am California time by `check.py --report`.
...
| fees paid | $309.66 |
| contracts looked at | 1335 |
| retired (old rule, not counted) | 10 |
| of those, settled and learned from | 1334 |
...
The 63-day study is worth 30 observations per row below. So 1334 live
...
| 45-50% | 0.497 | 0.484 | 261 (126 hit) | -0.013 |
...
Leaned YES 710 times, NO 625 times. Over 63 days of history the
