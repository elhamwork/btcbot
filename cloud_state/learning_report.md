...
Written 31 Aug 2026 3:58am California time by `check.py --report`.
...
| fees paid | $176.51 |
| contracts looked at | 657 |
| retired (old rule, not counted) | 10 |
| of those, settled and learned from | 656 |
...
The 63-day study is worth 30 observations per row below. So 656 live
...
| 30-35% | 0.286 | 0.305 | 21 (7 hit) | +0.020 |
...
Leaned YES 359 times, NO 298 times. Over 63 days of history the
