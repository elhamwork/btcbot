...
Written 10 Sep 2026 2:57pm California time by `check.py --report`.
...
| of those, settled and learned from | 1641 |
...
The 63-day study is worth 30 observations per row below. So 1641 live
...
| 50-55% | 0.558 | 0.519 | 345 (178 hit) | -0.038 ** |
