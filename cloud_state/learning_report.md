...
Written 03 Sep 2026 2:25am California time by `check.py --report`.
...
| of those, settled and learned from | 927 |
...
The 63-day study is worth 30 observations per row below. So 927 live
