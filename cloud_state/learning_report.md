...
Written 28 Aug 2026 11:12pm California time by `check.py --report`.
...
| fees paid | $115.87 |
| contracts looked at | 448 |
| retired (old rule, not counted) | 10 |
| of those, settled and learned from | 447 |
...
The 63-day study is worth 30 observations per row below. So 447 live
...
| 50-55% | 0.558 | 0.525 | 99 (51 hit) | -0.033 ** |
...
Leaned YES 244 times, NO 204 times. Over 63 days of history the
