...
Written 06 Sep 2026 5:41am California time by `check.py --report`.
...
| GOOD | 177 |
| BAD (cheap side) | 157 |
| WEAK (small disagreement) | 69 |
| BAD (last 5 min) | 11 |
| ALMOST (not confirmed yet) | 8 |
| WEAK (5-10 min) | 5 |

Leaned YES 658 times, NO 571 times. Over 63 days of history the
