...
Written 03 Sep 2026 11:49pm California time by `check.py --report`.
...
| fees paid | $249.99 |
| contracts looked at | 1014 |
| retired (old rule, not counted) | 10 |
| of those, settled and learned from | 1013 |
...
The 63-day study is worth 30 observations per row below. So 1013 live
...
Leaned YES 552 times, NO 462 times. Over 63 days of history the
