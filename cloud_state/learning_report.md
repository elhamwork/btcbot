...
Written 08 Sep 2026 10:01am California time by `check.py --report`.
...
| of those, settled and learned from | 1437 |
| actual calls (graded GOOD) | 207 |
| calls that have settled | 207 |
| alerts that reached the phone | 155 of 155 |
...
The 63-day study is worth 30 observations per row below. So 1437 live
...
| 45-50% | 0.497 | 0.484 | 284 (137 hit) | -0.013 |
