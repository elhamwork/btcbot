...
Written 07 Sep 2026 10:41am California time by `check.py --report`.
...
| GOOD | 190 |
| BAD (cheap side) | 171 |
| WEAK (small disagreement) | 76 |
| BAD (last 5 min) | 11 |
| ALMOST (not confirmed yet) | 8 |
| WEAK (5-10 min) | 5 |

Leaned YES 715 times, NO 630 times. Over 63 days of history the
