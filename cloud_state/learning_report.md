...
Written 03 Sep 2026 12:31pm California time by `check.py --report`.
...
| fees paid | $240.99 |
| contracts looked at | 969 |
| retired (old rule, not counted) | 10 |
| of those, settled and learned from | 967 |
...
The 63-day study is worth 30 observations per row below. So 967 live
...
| 40-45% | 0.384 | 0.378 | 122 (46 hit) | -0.006 |
| 45-50% | 0.497 | 0.466 | 180 (83 hit) | -0.031 ** |
| 50-55% | 0.558 | 0.537 | 206 (110 hit) | -0.021 ** |
| 55-60% | 0.605 | 0.557 | 139 (76 hit) | -0.048 ** |
...
Leaned YES 527 times, NO 442 times. Over 63 days of history the
