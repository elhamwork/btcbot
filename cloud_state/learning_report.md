...
Written 28 Aug 2026 10:11pm California time by `check.py --report`.
...
| fees paid | $115.87 |
| contracts looked at | 444 |
| retired (old rule, not counted) | 10 |
| of those, settled and learned from | 443 |
...
The 63-day study is worth 30 observations per row below. So 443 live
...
| 50-55% | 0.558 | 0.522 | 96 (49 hit) | -0.036 ** |
...
Leaned YES 241 times, NO 203 times. Over 63 days of history the
