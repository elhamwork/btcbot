...
Written 30 Aug 2026 6:47pm California time by `check.py --report`.
...
| fees paid | $169.27 |
| contracts looked at | 621 |
| retired (old rule, not counted) | 10 |
| of those, settled and learned from | 620 |
...
The 63-day study is worth 30 observations per row below. So 620 live
...
| 45-50% | 0.497 | 0.434 | 122 (51 hit) | -0.063 ** |
| 50-55% | 0.558 | 0.536 | 143 (76 hit) | -0.022 ** |
...
Leaned YES 344 times, NO 277 times. Over 63 days of history the
