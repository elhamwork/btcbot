...
Written 30 Aug 2026 4:24am California time by `check.py --report`.
...
| fees paid | $152.00 |
| contracts looked at | 563 |
| retired (old rule, not counted) | 10 |
| of those, settled and learned from | 562 |
...
The 63-day study is worth 30 observations per row below. So 562 live
...
Leaned YES 317 times, NO 246 times. Over 63 days of history the
