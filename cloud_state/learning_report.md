...
Written 13 Sep 2026 12:48pm California time by `check.py --report`.
...
| fees paid | $436.64 |
| contracts looked at | 1922 |
| retired (old rule, not counted) | 10 |
| of those, settled and learned from | 1921 |
...
The 63-day study is worth 30 observations per row below. So 1921 live
...
| 50-55% | 0.558 | 0.516 | 409 (210 hit) | -0.041 ** |
...
Leaned YES 1038 times, NO 884 times. Over 63 days of history the
