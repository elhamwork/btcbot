...
Written 05 Sep 2026 6:50pm California time by `check.py --report`.
...
| fees paid | $282.57 |
| contracts looked at | 1186 |
| retired (old rule, not counted) | 10 |
| of those, settled and learned from | 1185 |
...
The 63-day study is worth 30 observations per row below. So 1185 live
...
Leaned YES 637 times, NO 549 times. Over 63 days of history the
