...
Written 01 Sep 2026 1:25pm California time by `check.py --report`.
...
| fees paid | $203.91 |
| contracts looked at | 788 |
| retired (old rule, not counted) | 10 |
| of those, settled and learned from | 787 |
...
The 63-day study is worth 30 observations per row below. So 787 live
...
| 50-55% | 0.558 | 0.536 | 173 (92 hit) | -0.022 ** |
...
Leaned YES 437 times, NO 351 times. Over 63 days of history the
