...
Written 08 Sep 2026 7:52pm California time by `check.py --report`.
...
| fees paid | $331.83 |
| contracts looked at | 1478 |
| retired (old rule, not counted) | 10 |
| of those, settled and learned from | 1477 |
...
The 63-day study is worth 30 observations per row below. So 1477 live
...
| 45-50% | 0.497 | 0.478 | 294 (140 hit) | -0.019 |
...
Leaned YES 782 times, NO 696 times. Over 63 days of history the
