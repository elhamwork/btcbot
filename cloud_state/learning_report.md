...
Written 07 Sep 2026 1:54pm California time by `check.py --report`.
...
| fees paid | $312.69 |
| contracts looked at | 1358 |
| retired (old rule, not counted) | 10 |
| of those, settled and learned from | 1357 |
...
The 63-day study is worth 30 observations per row below. So 1357 live
...
Leaned YES 725 times, NO 633 times. Over 63 days of history the
