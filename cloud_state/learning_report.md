...
Written 02 Sep 2026 1:08pm California time by `check.py --report`.
...
| fees paid | $230.35 |
| contracts looked at | 883 |
| retired (old rule, not counted) | 10 |
| of those, settled and learned from | 882 |
...
The 63-day study is worth 30 observations per row below. So 882 live
...
| 50-55% | 0.558 | 0.528 | 191 (100 hit) | -0.029 ** |
...
Leaned YES 486 times, NO 397 times. Over 63 days of history the
