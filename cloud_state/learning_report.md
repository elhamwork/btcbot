...
Written 13 Sep 2026 6:09am California time by `check.py --report`.
...
| fees paid | $415.55 |
| contracts looked at | 1895 |
| retired (old rule, not counted) | 10 |
| of those, settled and learned from | 1894 |
...
The 63-day study is worth 30 observations per row below. So 1894 live
...
| 40-45% | 0.384 | 0.402 | 235 (95 hit) | +0.018 |
...
Leaned YES 1017 times, NO 878 times. Over 63 days of history the
