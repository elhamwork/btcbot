...
Written 30 Aug 2026 9:57am California time by `check.py --report`.
...
| fees paid | $156.32 |
| contracts looked at | 585 |
| retired (old rule, not counted) | 10 |
| of those, settled and learned from | 584 |
...
The 63-day study is worth 30 observations per row below. So 584 live
...
Leaned YES 328 times, NO 257 times. Over 63 days of history the
