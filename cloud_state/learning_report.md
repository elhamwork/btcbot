...
Written 03 Sep 2026 7:31am California time by `check.py --report`.
...
| fees paid | $237.61 |
| contracts looked at | 949 |
| retired (old rule, not counted) | 10 |
| of those, settled and learned from | 947 |
...
The 63-day study is worth 30 observations per row below. So 947 live
...
| 55-60% | 0.605 | 0.547 | 133 (71 hit) | -0.058 ** |
...
Leaned YES 516 times, NO 433 times. Over 63 days of history the
