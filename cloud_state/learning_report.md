...
Written 01 Sep 2026 10:50am California time by `check.py --report`.
...
| fees paid | $203.91 |
| contracts looked at | 778 |
| retired (old rule, not counted) | 10 |
| of those, settled and learned from | 777 |
...
The 63-day study is worth 30 observations per row below. So 777 live
...
| 30-35% | 0.286 | 0.291 | 27 (8 hit) | +0.005 |
| 35-40% | 0.354 | 0.354 | 48 (17 hit) | +0.000 |
| 40-45% | 0.384 | 0.364 | 98 (35 hit) | -0.021 ** |
| 45-50% | 0.497 | 0.449 | 150 (66 hit) | -0.047 ** |
| 50-55% | 0.558 | 0.544 | 170 (92 hit) | -0.014 |
| 55-60% | 0.605 | 0.522 | 110 (55 hit) | -0.082 ** |
...
Leaned YES 429 times, NO 349 times. Over 63 days of history the
