...
Written 30 Aug 2026 6:36pm California time by `check.py --report`.
...
| of those, settled and learned from | 619 |
...
The 63-day study is worth 30 observations per row below. So 619 live
