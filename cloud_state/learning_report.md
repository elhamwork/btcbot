...
Written 09 Sep 2026 10:05am California time by `check.py --report`.
...
| fees paid | $346.03 |
| contracts looked at | 1535 |
| retired (old rule, not counted) | 10 |
| of those, settled and learned from | 1534 |
...
The 63-day study is worth 30 observations per row below. So 1534 live
...
| 45-50% | 0.497 | 0.482 | 308 (148 hit) | -0.015 |
...
Leaned YES 811 times, NO 724 times. Over 63 days of history the
