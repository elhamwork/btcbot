...
Written 29 Aug 2026 4:56am California time by `check.py --report`.
...
| fees paid | $121.55 |
| contracts looked at | 469 |
| retired (old rule, not counted) | 10 |
| of those, settled and learned from | 468 |
...
The 63-day study is worth 30 observations per row below. So 468 live
...
| 50-55% | 0.558 | 0.517 | 105 (53 hit) | -0.041 ** |
...
Leaned YES 256 times, NO 213 times. Over 63 days of history the
