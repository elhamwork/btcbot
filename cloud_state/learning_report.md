...
Written 12 Sep 2026 10:03am California time by `check.py --report`.
...
| fees paid | $409.43 |
| contracts looked at | 1815 |
| retired (old rule, not counted) | 10 |
| of those, settled and learned from | 1814 |
...
The 63-day study is worth 30 observations per row below. So 1814 live
...
| 45-50% | 0.497 | 0.468 | 369 (172 hit) | -0.028 ** |
| 50-55% | 0.558 | 0.518 | 383 (197 hit) | -0.040 ** |
| 55-60% | 0.605 | 0.537 | 270 (143 hit) | -0.068 ** |
...
Leaned YES 969 times, NO 846 times. Over 63 days of history the
