...
Written 13 Sep 2026 4:22pm California time by `check.py --report`.
...
| of those, settled and learned from | 1935 |
...
The 63-day study is worth 30 observations per row below. So 1935 live
...
| 45-50% | 0.497 | 0.456 | 389 (176 hit) | -0.041 ** |
