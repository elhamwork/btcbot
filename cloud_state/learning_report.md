...
Written 04 Sep 2026 1:35pm California time by `check.py --report`.
...
| fees paid | $263.92 |
| contracts looked at | 1069 |
| retired (old rule, not counted) | 10 |
| of those, settled and learned from | 1068 |
...
The 63-day study is worth 30 observations per row below. So 1068 live
...
Leaned YES 582 times, NO 487 times. Over 63 days of history the
