...
Written 01 Sep 2026 5:59pm California time by `check.py --report`.
...
| fees paid | $208.28 |
| contracts looked at | 806 |
| retired (old rule, not counted) | 10 |
| of those, settled and learned from | 805 |
...
The 63-day study is worth 30 observations per row below. So 805 live
...
| 50-55% | 0.558 | 0.535 | 179 (95 hit) | -0.023 ** |
...
Leaned YES 447 times, NO 359 times. Over 63 days of history the
