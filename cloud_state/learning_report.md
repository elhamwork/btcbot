...
Written 11 Sep 2026 2:51am California time by `check.py --report`.
...
| fees paid | $388.68 |
| contracts looked at | 1690 |
| retired (old rule, not counted) | 10 |
| of those, settled and learned from | 1689 |
...
The 63-day study is worth 30 observations per row below. So 1689 live
...
| 45-50% | 0.497 | 0.477 | 337 (160 hit) | -0.020 ** |
...
Leaned YES 898 times, NO 792 times. Over 63 days of history the
