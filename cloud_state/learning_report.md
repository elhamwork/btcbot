...
Written 09 Sep 2026 6:15am California time by `check.py --report`.
...
| fees paid | $346.03 |
| contracts looked at | 1519 |
| retired (old rule, not counted) | 10 |
| of those, settled and learned from | 1518 |
...
The 63-day study is worth 30 observations per row below. So 1518 live
...
| 50-55% | 0.558 | 0.526 | 319 (167 hit) | -0.031 ** |
...
| GOOD | 213 |
| BAD (cheap side) | 198 |
| WEAK (small disagreement) | 88 |
| BAD (last 5 min) | 12 |
| ALMOST (not confirmed yet) | 8 |
| WEAK (5-10 min) | 5 |

Leaned YES 806 times, NO 713 times. Over 63 days of history the
