...
Written 05 Sep 2026 7:26pm California time by `check.py --report`.
...
| fees paid | $282.57 |
| contracts looked at | 1188 |
| retired (old rule, not counted) | 10 |
| of those, settled and learned from | 1187 |
...
The 63-day study is worth 30 observations per row below. So 1187 live
...
Leaned YES 638 times, NO 550 times. Over 63 days of history the
