...
Written 05 Sep 2026 4:39am California time by `check.py --report`.
...
| fees paid | $273.17 |
| contracts looked at | 1129 |
| retired (old rule, not counted) | 10 |
| of those, settled and learned from | 1128 |
...
The 63-day study is worth 30 observations per row below. So 1128 live
...
| 50-55% | 0.558 | 0.527 | 239 (125 hit) | -0.031 ** |
...
Leaned YES 612 times, NO 517 times. Over 63 days of history the
