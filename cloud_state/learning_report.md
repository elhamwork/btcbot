...
Written 31 Aug 2026 11:36pm California time by `check.py --report`.
...
| of those, settled and learned from | 732 |
...
The 63-day study is worth 30 observations per row below. So 732 live
