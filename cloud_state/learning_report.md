...
Written 04 Sep 2026 8:33pm California time by `check.py --report`.
...
| fees paid | $267.08 |
| contracts looked at | 1097 |
| retired (old rule, not counted) | 10 |
| of those, settled and learned from | 1096 |
...
The 63-day study is worth 30 observations per row below. So 1096 live
...
| 50-55% | 0.558 | 0.528 | 231 (121 hit) | -0.030 ** |
| 55-60% | 0.605 | 0.552 | 164 (89 hit) | -0.053 ** |
...
Leaned YES 598 times, NO 499 times. Over 63 days of history the
