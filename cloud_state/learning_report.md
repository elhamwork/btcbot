...
Written 10 Sep 2026 5:52pm California time by `check.py --report`.
...
| fees paid | $385.61 |
| contracts looked at | 1654 |
| retired (old rule, not counted) | 10 |
| of those, settled and learned from | 1653 |
...
The 63-day study is worth 30 observations per row below. So 1653 live
...
| 50-55% | 0.558 | 0.519 | 351 (181 hit) | -0.039 ** |
...
Leaned YES 876 times, NO 778 times. Over 63 days of history the
