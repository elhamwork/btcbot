...
Written 30 Aug 2026 1:43am California time by `check.py --report`.
...
| fees paid | $149.89 |
| contracts looked at | 552 |
| retired (old rule, not counted) | 10 |
| of those, settled and learned from | 551 |
...
The 63-day study is worth 30 observations per row below. So 551 live
...
Leaned YES 309 times, NO 243 times. Over 63 days of history the
