...
Written 01 Sep 2026 9:06am California time by `check.py --report`.
...
| fees paid | $203.91 |
| contracts looked at | 771 |
| retired (old rule, not counted) | 10 |
| of those, settled and learned from | 770 |
...
The 63-day study is worth 30 observations per row below. So 770 live
...
| 55-60% | 0.605 | 0.530 | 108 (55 hit) | -0.075 ** |
...
Leaned YES 425 times, NO 346 times. Over 63 days of history the
