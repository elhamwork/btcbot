...
Written 05 Sep 2026 9:42pm California time by `check.py --report`.
...
| fees paid | $284.46 |
| contracts looked at | 1197 |
| retired (old rule, not counted) | 10 |
| of those, settled and learned from | 1196 |
...
The 63-day study is worth 30 observations per row below. So 1196 live
...
| 55-60% | 0.605 | 0.554 | 178 (97 hit) | -0.051 ** |
| 60-65% | 0.678 | 0.598 | 91 (52 hit) | -0.080 ** |
| 65-70% | 0.738 | 0.665 | 62 (39 hit) | -0.073 ** |
...
| grade | times |
|---|---|
| NONE (no disagreement) | 566 |
| WEAK (50-70c) | 216 |
| GOOD | 174 |
| BAD (cheap side) | 150 |
| WEAK (small disagreement) | 67 |
| BAD (last 5 min) | 11 |
| ALMOST (not confirmed yet) | 8 |
| WEAK (5-10 min) | 5 |

Leaned YES 644 times, NO 553 times. Over 63 days of history the
