...
Written 05 Sep 2026 8:16pm California time by `check.py --report`.
...
| fees paid | $282.57 |
| contracts looked at | 1192 |
| retired (old rule, not counted) | 10 |
| of those, settled and learned from | 1190 |
| actual calls (graded GOOD) | 181 |
| calls that have settled | 181 |
| alerts that reached the phone | 129 of 129 |
...
The 63-day study is worth 30 observations per row below. So 1190 live
...
| 55-60% | 0.605 | 0.551 | 177 (96 hit) | -0.054 ** |
...
Leaned YES 641 times, NO 551 times. Over 63 days of history the
