...
Written 02 Sep 2026 10:06am California time by `check.py --report`.
...
| fees paid | $228.08 |
| contracts looked at | 871 |
| retired (old rule, not counted) | 10 |
| of those, settled and learned from | 870 |
...
The 63-day study is worth 30 observations per row below. So 870 live
...
| 70-75% | 0.814 | 0.800 | 18 (14 hit) | -0.014 |
...
Leaned YES 477 times, NO 394 times. Over 63 days of history the
