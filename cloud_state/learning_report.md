...
Written 31 Aug 2026 8:50am California time by `check.py --report`.
...
| fees paid | $178.41 |
| contracts looked at | 675 |
| retired (old rule, not counted) | 10 |
| of those, settled and learned from | 674 |
...
The 63-day study is worth 30 observations per row below. So 674 live
...
Leaned YES 364 times, NO 311 times. Over 63 days of history the
