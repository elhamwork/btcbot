...
Written 12 Sep 2026 12:10pm California time by `check.py --report`.
...
| fees paid | $409.43 |
| contracts looked at | 1823 |
| retired (old rule, not counted) | 10 |
| of those, settled and learned from | 1822 |
...
The 63-day study is worth 30 observations per row below. So 1822 live
...
| 50-55% | 0.558 | 0.514 | 386 (197 hit) | -0.044 ** |
...
Leaned YES 974 times, NO 849 times. Over 63 days of history the
