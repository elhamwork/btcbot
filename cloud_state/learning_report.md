...
Written 04 Sep 2026 8:23pm California time by `check.py --report`.
...
| fees paid | $267.08 |
| contracts looked at | 1096 |
| retired (old rule, not counted) | 10 |
| of those, settled and learned from | 1095 |
...
The 63-day study is worth 30 observations per row below. So 1095 live
...
Leaned YES 597 times, NO 499 times. Over 63 days of history the
