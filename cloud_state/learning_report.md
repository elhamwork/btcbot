...
Written 10 Sep 2026 5:33pm California time by `check.py --report`.
...
| fees paid | $385.61 |
| contracts looked at | 1653 |
| retired (old rule, not counted) | 10 |
| of those, settled and learned from | 1652 |
...
The 63-day study is worth 30 observations per row below. So 1652 live
...
Leaned YES 875 times, NO 778 times. Over 63 days of history the
