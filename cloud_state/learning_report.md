...
Written 06 Sep 2026 5:16am California time by `check.py --report`.
...
| of those, settled and learned from | 1226 |
...
The 63-day study is worth 30 observations per row below. So 1226 live
...
| 50-55% | 0.558 | 0.529 | 255 (134 hit) | -0.029 ** |
