...
Written 03 Sep 2026 3:51am California time by `check.py --report`.
...
| fees paid | $236.74 |
| contracts looked at | 934 |
| retired (old rule, not counted) | 10 |
| of those, settled and learned from | 933 |
...
The 63-day study is worth 30 observations per row below. So 933 live
...
| 55-60% | 0.605 | 0.545 | 130 (69 hit) | -0.060 ** |
...
Leaned YES 505 times, NO 429 times. Over 63 days of history the
