...
Written 06 Sep 2026 5:20pm California time by `check.py --report`.
...
| fees paid | $304.72 |
| contracts looked at | 1276 |
| retired (old rule, not counted) | 10 |
| of those, settled and learned from | 1275 |
...
The 63-day study is worth 30 observations per row below. So 1275 live
...
| 40-45% | 0.384 | 0.399 | 162 (65 hit) | +0.014 |
...
Leaned YES 678 times, NO 598 times. Over 63 days of history the
