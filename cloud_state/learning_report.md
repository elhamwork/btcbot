...
Written 30 Aug 2026 3:14am California time by `check.py --report`.
...
| fees paid | $149.89 |
| contracts looked at | 558 |
| retired (old rule, not counted) | 10 |
| of those, settled and learned from | 557 |
...
The 63-day study is worth 30 observations per row below. So 557 live
...
| 40-45% | 0.384 | 0.355 | 73 (25 hit) | -0.030 ** |
| 45-50% | 0.497 | 0.438 | 109 (46 hit) | -0.059 ** |
| 50-55% | 0.558 | 0.532 | 131 (69 hit) | -0.025 ** |
| 55-60% | 0.605 | 0.555 | 73 (39 hit) | -0.050 ** |
...
Leaned YES 312 times, NO 246 times. Over 63 days of history the
