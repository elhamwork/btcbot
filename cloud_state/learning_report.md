...
Written 30 Aug 2026 12:12am California time by `check.py --report`.
...
| fees paid | $149.89 |
| contracts looked at | 546 |
| retired (old rule, not counted) | 10 |
| of those, settled and learned from | 545 |
...
The 63-day study is worth 30 observations per row below. So 545 live
...
| 45-50% | 0.497 | 0.444 | 105 (45 hit) | -0.053 ** |
| 50-55% | 0.558 | 0.543 | 126 (68 hit) | -0.015 |
...
Leaned YES 306 times, NO 240 times. Over 63 days of history the
