...
Written 12 Sep 2026 4:07pm California time by `check.py --report`.
...
| fees paid | $411.66 |
| contracts looked at | 1839 |
| retired (old rule, not counted) | 10 |
| of those, settled and learned from | 1838 |
...
The 63-day study is worth 30 observations per row below. So 1838 live
...
| 55-60% | 0.605 | 0.538 | 277 (147 hit) | -0.067 ** |
...
Leaned YES 985 times, NO 854 times. Over 63 days of history the
