...
Written 07 Sep 2026 5:19pm California time by `check.py --report`.
...
| fees paid | $314.03 |
| contracts looked at | 1372 |
| retired (old rule, not counted) | 10 |
| of those, settled and learned from | 1371 |
...
The 63-day study is worth 30 observations per row below. So 1371 live
...
| 40-45% | 0.384 | 0.386 | 176 (68 hit) | +0.002 |
...
Leaned YES 730 times, NO 642 times. Over 63 days of history the
