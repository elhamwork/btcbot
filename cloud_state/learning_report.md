...
Written 02 Sep 2026 2:37pm California time by `check.py --report`.
...
| of those, settled and learned from | 888 |
...
The 63-day study is worth 30 observations per row below. So 888 live
