...
Written 07 Sep 2026 6:00pm California time by `check.py --report`.
...
| fees paid | $314.03 |
| contracts looked at | 1375 |
| retired (old rule, not counted) | 10 |
| of those, settled and learned from | 1373 |
...
The 63-day study is worth 30 observations per row below. So 1373 live
...
Leaned YES 730 times, NO 645 times. Over 63 days of history the
