...
Written 03 Sep 2026 6:26am California time by `check.py --report`.
...
| of those, settled and learned from | 943 |
...
The 63-day study is worth 30 observations per row below. So 943 live
...
| 35-40% | 0.354 | 0.368 | 64 (24 hit) | +0.014 |
