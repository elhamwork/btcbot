...
Written 12 Sep 2026 3:42pm California time by `check.py --report`.
...
| fees paid | $411.66 |
| contracts looked at | 1837 |
| retired (old rule, not counted) | 10 |
| of those, settled and learned from | 1836 |
...
The 63-day study is worth 30 observations per row below. So 1836 live
...
| 60-65% | 0.678 | 0.597 | 143 (83 hit) | -0.081 ** |
...
Leaned YES 983 times, NO 854 times. Over 63 days of history the
