...
Written 02 Sep 2026 2:07am California time by `check.py --report`.
...
| fees paid | $218.78 |
| contracts looked at | 839 |
| retired (old rule, not counted) | 10 |
| of those, settled and learned from | 838 |
...
The 63-day study is worth 30 observations per row below. So 838 live
...
Leaned YES 463 times, NO 376 times. Over 63 days of history the
