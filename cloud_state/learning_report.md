...
Written 06 Sep 2026 11:43am California time by `check.py --report`.
...
| fees paid | $295.52 |
| contracts looked at | 1253 |
| retired (old rule, not counted) | 10 |
| of those, settled and learned from | 1252 |
...
The 63-day study is worth 30 observations per row below. So 1252 live
...
| 55-60% | 0.605 | 0.547 | 184 (99 hit) | -0.058 ** |
...
Leaned YES 668 times, NO 585 times. Over 63 days of history the
