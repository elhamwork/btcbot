...
Written 31 Aug 2026 3:38am California time by `check.py --report`.
...
| fees paid | $176.51 |
| contracts looked at | 656 |
| retired (old rule, not counted) | 10 |
| of those, settled and learned from | 655 |
...
The 63-day study is worth 30 observations per row below. So 655 live
...
| 40-45% | 0.384 | 0.360 | 88 (31 hit) | -0.024 ** |
...
| GOOD | 97 |
| BAD (cheap side) | 82 |
| WEAK (small disagreement) | 42 |
| BAD (last 5 min) | 11 |
| ALMOST (not confirmed yet) | 5 |
| WEAK (5-10 min) | 4 |

Leaned YES 359 times, NO 297 times. Over 63 days of history the
