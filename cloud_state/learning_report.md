...
Written 07 Sep 2026 4:46am California time by `check.py --report`.
...
| fees paid | $308.56 |
| contracts looked at | 1322 |
| retired (old rule, not counted) | 10 |
| of those, settled and learned from | 1320 |
...
The 63-day study is worth 30 observations per row below. So 1320 live
...
| 45-50% | 0.497 | 0.482 | 258 (124 hit) | -0.014 |
| 50-55% | 0.558 | 0.527 | 277 (145 hit) | -0.031 ** |
| 55-60% | 0.605 | 0.545 | 196 (105 hit) | -0.060 ** |
...
Leaned YES 705 times, NO 617 times. Over 63 days of history the
