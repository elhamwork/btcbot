...
Written 31 Aug 2026 9:45pm California time by `check.py --report`.
...
| of those, settled and learned from | 724 |
...
The 63-day study is worth 30 observations per row below. So 724 live
...
| 60-65% | 0.678 | 0.663 | 55 (36 hit) | -0.015 |
