...
Written 30 Aug 2026 3:53pm California time by `check.py --report`.
...
| fees paid | $168.12 |
| contracts looked at | 609 |
| retired (old rule, not counted) | 10 |
| of those, settled and learned from | 608 |
...
The 63-day study is worth 30 observations per row below. So 608 live
...
Leaned YES 340 times, NO 269 times. Over 63 days of history the
