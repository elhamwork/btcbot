...
Written 08 Sep 2026 8:14am California time by `check.py --report`.
...
| fees paid | $324.53 |
| contracts looked at | 1431 |
| retired (old rule, not counted) | 10 |
| of those, settled and learned from | 1430 |
...
The 63-day study is worth 30 observations per row below. So 1430 live
...
| 45-50% | 0.497 | 0.480 | 282 (135 hit) | -0.016 |
...
Leaned YES 756 times, NO 675 times. Over 63 days of history the
