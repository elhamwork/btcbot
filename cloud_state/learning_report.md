...
Written 02 Sep 2026 11:57am California time by `check.py --report`.
...
| fees paid | $230.35 |
| contracts looked at | 878 |
| retired (old rule, not counted) | 10 |
| of those, settled and learned from | 877 |
...
The 63-day study is worth 30 observations per row below. So 877 live
...
| 50-55% | 0.558 | 0.524 | 189 (98 hit) | -0.034 ** |
...
Leaned YES 483 times, NO 395 times. Over 63 days of history the
