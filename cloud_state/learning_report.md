...
Written 01 Sep 2026 7:06pm California time by `check.py --report`.
...
| fees paid | $208.28 |
| contracts looked at | 811 |
| retired (old rule, not counted) | 10 |
| of those, settled and learned from | 810 |
...
The 63-day study is worth 30 observations per row below. So 810 live
...
Leaned YES 449 times, NO 362 times. Over 63 days of history the
