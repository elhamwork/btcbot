...
Written 11 Sep 2026 8:19am California time by `check.py --report`.
...
| fees paid | $391.76 |
| contracts looked at | 1712 |
| retired (old rule, not counted) | 10 |
| of those, settled and learned from | 1711 |
...
The 63-day study is worth 30 observations per row below. So 1711 live
...
| 55-60% | 0.605 | 0.544 | 248 (133 hit) | -0.061 ** |
...
Leaned YES 910 times, NO 802 times. Over 63 days of history the
