...
Written 05 Sep 2026 12:48pm California time by `check.py --report`.
...
| fees paid | $278.41 |
| contracts looked at | 1162 |
| retired (old rule, not counted) | 10 |
| of those, settled and learned from | 1161 |
...
The 63-day study is worth 30 observations per row below. So 1161 live
...
| 45-50% | 0.497 | 0.482 | 221 (106 hit) | -0.015 |
...
Leaned YES 628 times, NO 534 times. Over 63 days of history the
