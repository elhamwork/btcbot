...
Written 28 Aug 2026 5:51am California time by `check.py --report`.
...
| fees paid | $98.02 |
| contracts looked at | 392 |
| retired (old rule, not counted) | 10 |
| of those, settled and learned from | 390 |
...
The 63-day study is worth 30 observations per row below. So 390 live
...
Leaned YES 217 times, NO 175 times. Over 63 days of history the
