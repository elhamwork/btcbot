...
Written 31 Aug 2026 7:09pm California time by `check.py --report`.
...
| fees paid | $188.08 |
| contracts looked at | 715 |
| retired (old rule, not counted) | 10 |
| of those, settled and learned from | 714 |
...
The 63-day study is worth 30 observations per row below. So 714 live
...
| 50-55% | 0.558 | 0.544 | 159 (86 hit) | -0.014 |
...
Leaned YES 388 times, NO 327 times. Over 63 days of history the
