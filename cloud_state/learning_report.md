...
Written 07 Sep 2026 7:26pm California time by `check.py --report`.
...
| fees paid | $314.03 |
| contracts looked at | 1380 |
| retired (old rule, not counted) | 10 |
| of those, settled and learned from | 1379 |
...
The 63-day study is worth 30 observations per row below. So 1379 live
...
| 35-40% | 0.354 | 0.382 | 100 (39 hit) | +0.028 ** |
| 40-45% | 0.384 | 0.384 | 177 (68 hit) | -0.000 |
| 45-50% | 0.497 | 0.488 | 271 (132 hit) | -0.009 |
| 50-55% | 0.558 | 0.526 | 289 (151 hit) | -0.032 ** |
...
Leaned YES 733 times, NO 647 times. Over 63 days of history the
