...
Written 01 Sep 2026 5:22pm California time by `check.py --report`.
...
| fees paid | $208.28 |
| contracts looked at | 804 |
| retired (old rule, not counted) | 10 |
| of those, settled and learned from | 803 |
...
The 63-day study is worth 30 observations per row below. So 803 live
...
Leaned YES 445 times, NO 359 times. Over 63 days of history the
