...
Written 12 Sep 2026 2:34pm California time by `check.py --report`.
...
| fees paid | $411.66 |
| contracts looked at | 1833 |
| retired (old rule, not counted) | 10 |
| of those, settled and learned from | 1832 |
...
The 63-day study is worth 30 observations per row below. So 1832 live
...
Leaned YES 980 times, NO 853 times. Over 63 days of history the
