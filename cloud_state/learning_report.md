...
Written 30 Aug 2026 2:18am California time by `check.py --report`.
...
| fees paid | $149.89 |
| contracts looked at | 555 |
| retired (old rule, not counted) | 10 |
| of those, settled and learned from | 554 |
...
The 63-day study is worth 30 observations per row below. So 554 live
...
| 50-55% | 0.558 | 0.536 | 130 (69 hit) | -0.022 ** |
...
Leaned YES 311 times, NO 244 times. Over 63 days of history the
