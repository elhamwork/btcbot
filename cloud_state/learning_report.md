...
Written 09 Sep 2026 7:06am California time by `check.py --report`.
...
| fees paid | $346.03 |
| contracts looked at | 1523 |
| retired (old rule, not counted) | 10 |
| of those, settled and learned from | 1522 |
...
The 63-day study is worth 30 observations per row below. So 1522 live
...
| 50-55% | 0.558 | 0.523 | 321 (167 hit) | -0.034 ** |
...
Leaned YES 808 times, NO 715 times. Over 63 days of history the
