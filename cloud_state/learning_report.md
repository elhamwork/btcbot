...
Written 31 Aug 2026 1:57am California time by `check.py --report`.
...
| fees paid | $174.74 |
| contracts looked at | 649 |
| retired (old rule, not counted) | 10 |
| of those, settled and learned from | 648 |
...
The 63-day study is worth 30 observations per row below. So 648 live
...
| 40-45% | 0.384 | 0.364 | 87 (31 hit) | -0.021 ** |
| 45-50% | 0.497 | 0.449 | 128 (56 hit) | -0.048 ** |
| 50-55% | 0.558 | 0.535 | 149 (79 hit) | -0.023 ** |
...
Leaned YES 356 times, NO 293 times. Over 63 days of history the
