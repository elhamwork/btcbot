...
Written 29 Aug 2026 8:03pm California time by `check.py --report`.
...
| fees paid | $146.82 |
| contracts looked at | 530 |
| retired (old rule, not counted) | 10 |
| of those, settled and learned from | 529 |
...
The 63-day study is worth 30 observations per row below. So 529 live
...
Leaned YES 298 times, NO 232 times. Over 63 days of history the
