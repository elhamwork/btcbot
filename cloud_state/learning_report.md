...
Written 05 Sep 2026 2:52pm California time by `check.py --report`.
...
| fees paid | $278.41 |
| contracts looked at | 1170 |
| retired (old rule, not counted) | 10 |
| of those, settled and learned from | 1169 |
...
The 63-day study is worth 30 observations per row below. So 1169 live
...
| 45-50% | 0.497 | 0.484 | 226 (109 hit) | -0.013 |
...
Leaned YES 631 times, NO 539 times. Over 63 days of history the
