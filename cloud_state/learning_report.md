...
Written 09 Sep 2026 11:25am California time by `check.py --report`.
...
| fees paid | $348.08 |
| contracts looked at | 1540 |
| retired (old rule, not counted) | 10 |
| of those, settled and learned from | 1539 |
...
The 63-day study is worth 30 observations per row below. So 1539 live
...
| 40-45% | 0.384 | 0.391 | 194 (76 hit) | +0.006 |
...
Leaned YES 813 times, NO 727 times. Over 63 days of history the
