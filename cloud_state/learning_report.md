...
Written 03 Sep 2026 1:46pm California time by `check.py --report`.
...
| of those, settled and learned from | 972 |
...
The 63-day study is worth 30 observations per row below. So 972 live
