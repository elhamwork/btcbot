...
Written 28 Aug 2026 10:01pm California time by `check.py --report`.
...
| of those, settled and learned from | 442 |
...
The 63-day study is worth 30 observations per row below. So 442 live
...
| 50-55% | 0.558 | 0.518 | 95 (48 hit) | -0.040 ** |
