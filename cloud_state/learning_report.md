...
Written 27 Aug 2026 10:21pm California time by `check.py --report`.
...
| fees paid | $90.20 |
| contracts looked at | 372 |
| retired (old rule, not counted) | 10 |
| of those, settled and learned from | 371 |
...
The 63-day study is worth 30 observations per row below. So 371 live
...
Leaned YES 202 times, NO 170 times. Over 63 days of history the
