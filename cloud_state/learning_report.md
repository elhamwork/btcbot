...
Written 26 Aug 2026 10:21pm California time by `check.py --report`.
...
| fees paid | $70.43 |
| contracts looked at | 312 |
| retired (old rule, not counted) | 10 |
| of those, settled and learned from | 311 |
...
The 63-day study is worth 30 observations per row below. So 311 live
...
| 45-50% | 0.497 | 0.469 | 55 (25 hit) | -0.027 ** |
| 50-55% | 0.558 | 0.497 | 70 (33 hit) | -0.060 ** |
...
Leaned YES 181 times, NO 131 times. Over 63 days of history the
