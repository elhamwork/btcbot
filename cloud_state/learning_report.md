...
Written 14 Sep 2026 10:39am California time by `check.py --report`.

## The short version

| | |
|---|---|
| **paper account** | **$2,118.67** (started $1,000, +111.9%) |
...
| alerts that reached the phone | 234 of 234 |
| calls made before delivery was recorded | 52 |
| calls right | 239 of 286 (84%) |
...
| 45-50% | 0.497 | 0.463 | 404 (186 hit) | -0.034 ** |
