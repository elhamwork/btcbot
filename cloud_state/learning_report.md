...
Written 05 Sep 2026 5:16pm California time by `check.py --report`.
...
| fees paid | $282.57 |
| contracts looked at | 1180 |
| retired (old rule, not counted) | 10 |
| of those, settled and learned from | 1178 |
...
The 63-day study is worth 30 observations per row below. So 1178 live
...
Leaned YES 636 times, NO 544 times. Over 63 days of history the
