...
Written 05 Sep 2026 11:19am California time by `check.py --report`.
...
| fees paid | $276.36 |
| contracts looked at | 1156 |
| retired (old rule, not counted) | 10 |
| of those, settled and learned from | 1155 |
...
The 63-day study is worth 30 observations per row below. So 1155 live
...
| 45-50% | 0.497 | 0.482 | 219 (105 hit) | -0.015 |
...
Leaned YES 627 times, NO 529 times. Over 63 days of history the
