...
Written 29 Aug 2026 4:15am California time by `check.py --report`.
...
| of those, settled and learned from | 465 |
...
The 63-day study is worth 30 observations per row below. So 465 live
