...
Written 12 Sep 2026 3:15pm California time by `check.py --report`.
...
| fees paid | $411.66 |
| contracts looked at | 1835 |
| retired (old rule, not counted) | 10 |
| of those, settled and learned from | 1834 |
...
The 63-day study is worth 30 observations per row below. So 1834 live
...
| 50-55% | 0.558 | 0.516 | 388 (199 hit) | -0.042 ** |
| 55-60% | 0.605 | 0.536 | 276 (146 hit) | -0.069 ** |
| 60-65% | 0.678 | 0.601 | 142 (83 hit) | -0.077 ** |
...
Leaned YES 981 times, NO 854 times. Over 63 days of history the
