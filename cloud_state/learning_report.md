...
Written 28 Aug 2026 4:41pm California time by `check.py --report`.
...
| of those, settled and learned from | 421 |
...
The 63-day study is worth 30 observations per row below. So 421 live
