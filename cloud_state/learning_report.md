...
Written 28 Aug 2026 5:21pm California time by `check.py --report`.
...
| fees paid | $108.49 |
| contracts looked at | 425 |
| retired (old rule, not counted) | 10 |
| of those, settled and learned from | 424 |
...
The 63-day study is worth 30 observations per row below. So 424 live
...
Leaned YES 233 times, NO 192 times. Over 63 days of history the
