...
Written 30 Aug 2026 6:41am California time by `check.py --report`.
...
| of those, settled and learned from | 571 |
...
The 63-day study is worth 30 observations per row below. So 571 live
