...
Written 06 Sep 2026 9:24am California time by `check.py --report`.
...
| fees paid | $292.03 |
| contracts looked at | 1244 |
| retired (old rule, not counted) | 10 |
| of those, settled and learned from | 1243 |
...
The 63-day study is worth 30 observations per row below. So 1243 live
...
| 45-50% | 0.497 | 0.481 | 240 (115 hit) | -0.016 |
...
Leaned YES 665 times, NO 579 times. Over 63 days of history the
