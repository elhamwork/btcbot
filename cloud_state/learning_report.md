...
Written 06 Sep 2026 9:40am California time by `check.py --report`.
...
| fees paid | $292.03 |
| contracts looked at | 1245 |
| retired (old rule, not counted) | 10 |
| of those, settled and learned from | 1244 |
...
The 63-day study is worth 30 observations per row below. So 1244 live
...
| 35-40% | 0.354 | 0.378 | 88 (34 hit) | +0.024 ** |
...
Leaned YES 665 times, NO 580 times. Over 63 days of history the
