...
Written 31 Aug 2026 3:43pm California time by `check.py --report`.
...
| fees paid | $184.04 |
| contracts looked at | 701 |
| retired (old rule, not counted) | 10 |
| of those, settled and learned from | 700 |
...
The 63-day study is worth 30 observations per row below. So 700 live
...
Leaned YES 380 times, NO 321 times. Over 63 days of history the
