...
Written 30 Aug 2026 1:03am California time by `check.py --report`.
...
| fees paid | $149.89 |
| contracts looked at | 550 |
| retired (old rule, not counted) | 10 |
| of those, settled and learned from | 549 |
...
The 63-day study is worth 30 observations per row below. So 549 live
...
| 50-55% | 0.558 | 0.536 | 128 (68 hit) | -0.021 ** |
...
Leaned YES 308 times, NO 242 times. Over 63 days of history the
