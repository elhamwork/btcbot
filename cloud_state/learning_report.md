...
Written 05 Sep 2026 7:02am California time by `check.py --report`.
...
| fees paid | $273.17 |
| contracts looked at | 1139 |
| retired (old rule, not counted) | 10 |
| of those, settled and learned from | 1138 |
...
The 63-day study is worth 30 observations per row below. So 1138 live
...
| 55-60% | 0.605 | 0.550 | 174 (94 hit) | -0.055 ** |
...
Leaned YES 619 times, NO 520 times. Over 63 days of history the
