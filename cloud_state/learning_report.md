...
Written 10 Sep 2026 4:00am California time by `check.py --report`.

## The short version

| | |
|---|---|
| **paper account** | **$1,075.48** (started $1,000, +7.5%) |
...
The 63-day study is worth 30 observations per row below. So 1597 live
