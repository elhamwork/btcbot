...
Written 13 Sep 2026 1:02am California time by `check.py --report`.
...
| fees paid | $411.66 |
| contracts looked at | 1875 |
| retired (old rule, not counted) | 10 |
| of those, settled and learned from | 1874 |
...
The 63-day study is worth 30 observations per row below. So 1874 live
...
| 45-50% | 0.497 | 0.459 | 377 (172 hit) | -0.038 ** |
...
Leaned YES 1006 times, NO 869 times. Over 63 days of history the
