...
Written 01 Sep 2026 12:51pm California time by `check.py --report`.
...
| fees paid | $203.91 |
| contracts looked at | 786 |
| retired (old rule, not counted) | 10 |
| of those, settled and learned from | 785 |
...
The 63-day study is worth 30 observations per row below. So 785 live
...
| 50-55% | 0.558 | 0.538 | 172 (92 hit) | -0.019 |
| 55-60% | 0.605 | 0.526 | 111 (56 hit) | -0.079 ** |
| 60-65% | 0.678 | 0.623 | 62 (37 hit) | -0.055 ** |
...
Leaned YES 435 times, NO 351 times. Over 63 days of history the
