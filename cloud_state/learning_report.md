...
Written 01 Sep 2026 9:48am California time by `check.py --report`.
...
| fees paid | $203.91 |
| contracts looked at | 774 |
| retired (old rule, not counted) | 10 |
| of those, settled and learned from | 773 |
...
The 63-day study is worth 30 observations per row below. So 773 live
...
| 50-55% | 0.558 | 0.541 | 169 (91 hit) | -0.016 |
...
Leaned YES 427 times, NO 347 times. Over 63 days of history the
