...
Written 03 Sep 2026 9:35am California time by `check.py --report`.
...
| fees paid | $238.20 |
| contracts looked at | 957 |
| retired (old rule, not counted) | 10 |
| of those, settled and learned from | 956 |
...
The 63-day study is worth 30 observations per row below. So 956 live
...
Leaned YES 521 times, NO 436 times. Over 63 days of history the
