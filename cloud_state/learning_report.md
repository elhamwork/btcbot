...
Written 05 Sep 2026 1:59pm California time by `check.py --report`.
...
| fees paid | $278.41 |
| contracts looked at | 1166 |
| retired (old rule, not counted) | 10 |
| of those, settled and learned from | 1165 |
...
The 63-day study is worth 30 observations per row below. So 1165 live
...
| 50-55% | 0.558 | 0.528 | 246 (129 hit) | -0.030 ** |
...
Leaned YES 631 times, NO 535 times. Over 63 days of history the
