...
Written 12 Sep 2026 11:36pm California time by `check.py --report`.
...
| fees paid | $411.66 |
| contracts looked at | 1869 |
| retired (old rule, not counted) | 10 |
| of those, settled and learned from | 1868 |
...
The 63-day study is worth 30 observations per row below. So 1868 live
...
| 55-60% | 0.605 | 0.544 | 283 (152 hit) | -0.061 ** |
...
Leaned YES 1003 times, NO 866 times. Over 63 days of history the
