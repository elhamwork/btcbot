...
Written 29 Aug 2026 12:42pm California time by `check.py --report`.
...
| fees paid | $135.10 |
| contracts looked at | 500 |
| retired (old rule, not counted) | 10 |
| of those, settled and learned from | 499 |
| actual calls (graded GOOD) | 82 |
...
The 63-day study is worth 30 observations per row below. So 499 live
...
| 50-55% | 0.558 | 0.526 | 116 (60 hit) | -0.032 ** |
| 55-60% | 0.605 | 0.578 | 62 (35 hit) | -0.027 ** |
...
Leaned YES 280 times, NO 220 times. Over 63 days of history the
