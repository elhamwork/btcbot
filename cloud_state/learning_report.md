...
Written 28 Aug 2026 7:12pm California time by `check.py --report`.
...
| fees paid | $109.76 |
| contracts looked at | 432 |
| retired (old rule, not counted) | 10 |
| of those, settled and learned from | 431 |
...
The 63-day study is worth 30 observations per row below. So 431 live
...
| 45-50% | 0.497 | 0.438 | 84 (35 hit) | -0.059 ** |
...
Leaned YES 234 times, NO 198 times. Over 63 days of history the
