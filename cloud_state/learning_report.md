...
Written 03 Sep 2026 7:41am California time by `check.py --report`.
...
| of those, settled and learned from | 948 |
...
The 63-day study is worth 30 observations per row below. So 948 live
