...
Written 08 Sep 2026 7:54am California time by `check.py --report`.
...
| fees paid | $324.53 |
| contracts looked at | 1430 |
| retired (old rule, not counted) | 10 |
| of those, settled and learned from | 1429 |
...
The 63-day study is worth 30 observations per row below. So 1429 live
...
| 40-45% | 0.384 | 0.385 | 182 (70 hit) | +0.000 |
...
Leaned YES 756 times, NO 674 times. Over 63 days of history the
