...
Written 31 Aug 2026 10:57am California time by `check.py --report`.
...
| fees paid | $179.52 |
| contracts looked at | 683 |
| retired (old rule, not counted) | 10 |
| of those, settled and learned from | 682 |
...
The 63-day study is worth 30 observations per row below. So 682 live
...
Leaned YES 369 times, NO 314 times. Over 63 days of history the
