...
Written 08 Sep 2026 5:31pm California time by `check.py --report`.
...
| fees paid | $331.83 |
| contracts looked at | 1469 |
| retired (old rule, not counted) | 10 |
| of those, settled and learned from | 1467 |
...
The 63-day study is worth 30 observations per row below. So 1467 live
...
| 50-55% | 0.558 | 0.520 | 306 (158 hit) | -0.038 ** |
...
Leaned YES 777 times, NO 692 times. Over 63 days of history the
