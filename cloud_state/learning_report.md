...
Written 01 Sep 2026 2:23am California time by `check.py --report`.
...
| fees paid | $195.64 |
| contracts looked at | 744 |
| retired (old rule, not counted) | 10 |
| of those, settled and learned from | 743 |
...
The 63-day study is worth 30 observations per row below. So 743 live
...
Leaned YES 409 times, NO 335 times. Over 63 days of history the
