...
Written 11 Sep 2026 6:34pm California time by `check.py --report`.
...
| fees paid | $399.05 |
| contracts looked at | 1753 |
| retired (old rule, not counted) | 10 |
| of those, settled and learned from | 1752 |
...
The 63-day study is worth 30 observations per row below. So 1752 live
...
Leaned YES 930 times, NO 823 times. Over 63 days of history the
