...
Written 12 Sep 2026 7:01am California time by `check.py --report`.
...
| of those, settled and learned from | 1801 |
...
The 63-day study is worth 30 observations per row below. So 1801 live
...
| 45-50% | 0.497 | 0.469 | 362 (169 hit) | -0.028 ** |
