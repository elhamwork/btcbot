...
Written 08 Sep 2026 9:05am California time by `check.py --report`.
...
| fees paid | $324.53 |
| contracts looked at | 1435 |
| retired (old rule, not counted) | 10 |
| of those, settled and learned from | 1434 |
...
The 63-day study is worth 30 observations per row below. So 1434 live
...
| 30-35% | 0.286 | 0.295 | 50 (15 hit) | +0.009 |
| 35-40% | 0.354 | 0.387 | 106 (42 hit) | +0.033 ** |
| 40-45% | 0.384 | 0.390 | 184 (72 hit) | +0.006 |
| 45-50% | 0.497 | 0.482 | 283 (136 hit) | -0.015 |
...
Leaned YES 758 times, NO 677 times. Over 63 days of history the
