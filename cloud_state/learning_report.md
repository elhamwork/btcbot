...
Written 13 Sep 2026 3:15am California time by `check.py --report`.
...
| fees paid | $413.22 |
| contracts looked at | 1883 |
| retired (old rule, not counted) | 10 |
| of those, settled and learned from | 1882 |
...
The 63-day study is worth 30 observations per row below. So 1882 live
...
| 45-50% | 0.497 | 0.459 | 379 (173 hit) | -0.037 ** |
...
Leaned YES 1009 times, NO 874 times. Over 63 days of history the
