...
Written 01 Sep 2026 3:58am California time by `check.py --report`.
...
| fees paid | $197.59 |
| contracts looked at | 750 |
| retired (old rule, not counted) | 10 |
| of those, settled and learned from | 749 |
...
The 63-day study is worth 30 observations per row below. So 749 live
...
Leaned YES 413 times, NO 337 times. Over 63 days of history the
