...
Written 29 Aug 2026 11:12pm California time by `check.py --report`.
...
| fees paid | $149.89 |
| contracts looked at | 542 |
| retired (old rule, not counted) | 10 |
| of those, settled and learned from | 541 |
...
The 63-day study is worth 30 observations per row below. So 541 live
...
| 45-50% | 0.497 | 0.443 | 103 (44 hit) | -0.054 ** |
| 50-55% | 0.558 | 0.540 | 125 (67 hit) | -0.017 |
| 55-60% | 0.605 | 0.556 | 71 (38 hit) | -0.049 ** |
...
Leaned YES 304 times, NO 238 times. Over 63 days of history the
