...
Written 28 Aug 2026 3:11am California time by `check.py --report`.
...
| of those, settled and learned from | 380 |
...
The 63-day study is worth 30 observations per row below. So 380 live
...
| 50-55% | 0.558 | 0.515 | 82 (41 hit) | -0.042 ** |
