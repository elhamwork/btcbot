...
Written 12 Sep 2026 9:52pm California time by `check.py --report`.
...
| fees paid | $411.66 |
| contracts looked at | 1862 |
| retired (old rule, not counted) | 10 |
| of those, settled and learned from | 1861 |
...
The 63-day study is worth 30 observations per row below. So 1861 live
...
| 40-45% | 0.384 | 0.401 | 233 (94 hit) | +0.017 |
...
Leaned YES 997 times, NO 865 times. Over 63 days of history the
