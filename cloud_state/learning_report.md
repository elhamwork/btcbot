...
Written 03 Sep 2026 6:04pm California time by `check.py --report`.
...
| fees paid | $243.72 |
| contracts looked at | 991 |
| retired (old rule, not counted) | 10 |
| of those, settled and learned from | 990 |
...
The 63-day study is worth 30 observations per row below. So 990 live
...
Leaned YES 540 times, NO 451 times. Over 63 days of history the
