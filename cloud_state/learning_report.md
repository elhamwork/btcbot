...
Written 31 Aug 2026 2:12am California time by `check.py --report`.
...
| fees paid | $174.74 |
| contracts looked at | 650 |
| retired (old rule, not counted) | 10 |
| of those, settled and learned from | 649 |
...
The 63-day study is worth 30 observations per row below. So 649 live
...
Leaned YES 357 times, NO 293 times. Over 63 days of history the
