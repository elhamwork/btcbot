...
Written 09 Sep 2026 5:32pm California time by `check.py --report`.
...
| fees paid | $352.21 |
| contracts looked at | 1565 |
| retired (old rule, not counted) | 10 |
| of those, settled and learned from | 1564 |
...
The 63-day study is worth 30 observations per row below. So 1564 live
...
Leaned YES 828 times, NO 737 times. Over 63 days of history the
