...
Written 06 Sep 2026 1:17pm California time by `check.py --report`.
...
| fees paid | $297.46 |
| contracts looked at | 1260 |
| retired (old rule, not counted) | 10 |
| of those, settled and learned from | 1259 |
...
The 63-day study is worth 30 observations per row below. So 1259 live
...
| 45-50% | 0.497 | 0.480 | 245 (117 hit) | -0.017 |
...
Leaned YES 669 times, NO 591 times. Over 63 days of history the
