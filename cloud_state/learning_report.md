...
Written 03 Sep 2026 9:25am California time by `check.py --report`.
...
| fees paid | $238.20 |
| contracts looked at | 956 |
| retired (old rule, not counted) | 10 |
| of those, settled and learned from | 955 |
...
The 63-day study is worth 30 observations per row below. So 955 live
...
| 45-50% | 0.497 | 0.466 | 176 (81 hit) | -0.031 ** |
...
Leaned YES 520 times, NO 436 times. Over 63 days of history the
