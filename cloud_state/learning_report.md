...
Written 29 Aug 2026 7:28am California time by `check.py --report`.
...
| fees paid | $125.34 |
| contracts looked at | 479 |
| retired (old rule, not counted) | 10 |
| of those, settled and learned from | 478 |
...
The 63-day study is worth 30 observations per row below. So 478 live
...
| 50-55% | 0.558 | 0.516 | 111 (56 hit) | -0.042 ** |
...
Leaned YES 264 times, NO 215 times. Over 63 days of history the
