...
Written 01 Sep 2026 3:11pm California time by `check.py --report`.
...
| of those, settled and learned from | 794 |
...
The 63-day study is worth 30 observations per row below. So 794 live
