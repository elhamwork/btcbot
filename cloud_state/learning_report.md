...
Written 07 Sep 2026 2:50am California time by `check.py --report`.
...
| fees paid | $306.83 |
| contracts looked at | 1314 |
| retired (old rule, not counted) | 10 |
| of those, settled and learned from | 1313 |
...
The 63-day study is worth 30 observations per row below. So 1313 live
...
| 50-55% | 0.558 | 0.527 | 275 (144 hit) | -0.031 ** |
...
Leaned YES 699 times, NO 615 times. Over 63 days of history the
