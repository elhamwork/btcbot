...
Written 12 Sep 2026 5:39pm California time by `check.py --report`.
...
| fees paid | $411.66 |
| contracts looked at | 1845 |
| retired (old rule, not counted) | 10 |
| of those, settled and learned from | 1844 |
...
The 63-day study is worth 30 observations per row below. So 1844 live
...
| 50-55% | 0.558 | 0.514 | 390 (199 hit) | -0.044 ** |
...
Leaned YES 989 times, NO 856 times. Over 63 days of history the
