...
Written 02 Sep 2026 9:40pm California time by `check.py --report`.
...
| of those, settled and learned from | 916 |
...
The 63-day study is worth 30 observations per row below. So 916 live
