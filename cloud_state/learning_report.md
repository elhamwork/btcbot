...
Written 03 Sep 2026 4:21am California time by `check.py --report`.
...
| fees paid | $236.74 |
| contracts looked at | 936 |
| retired (old rule, not counted) | 10 |
| of those, settled and learned from | 935 |
...
The 63-day study is worth 30 observations per row below. So 935 live
...
| 55-60% | 0.605 | 0.548 | 131 (70 hit) | -0.057 ** |
...
Leaned YES 507 times, NO 429 times. Over 63 days of history the
