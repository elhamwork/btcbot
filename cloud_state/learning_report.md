...
Written 01 Sep 2026 4:06pm California time by `check.py --report`.
...
| of those, settled and learned from | 798 |
...
The 63-day study is worth 30 observations per row below. So 798 live
