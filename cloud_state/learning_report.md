...
Written 31 Aug 2026 9:10am California time by `check.py --report`.
...
| fees paid | $178.41 |
| contracts looked at | 676 |
| retired (old rule, not counted) | 10 |
| of those, settled and learned from | 675 |
...
The 63-day study is worth 30 observations per row below. So 675 live
...
Leaned YES 365 times, NO 311 times. Over 63 days of history the
