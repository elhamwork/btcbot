...
Written 09 Sep 2026 11:50am California time by `check.py --report`.
...
| fees paid | $348.08 |
| contracts looked at | 1542 |
| retired (old rule, not counted) | 10 |
| of those, settled and learned from | 1541 |
...
The 63-day study is worth 30 observations per row below. So 1541 live
...
| 55-60% | 0.605 | 0.536 | 222 (117 hit) | -0.069 ** |
...
Leaned YES 814 times, NO 728 times. Over 63 days of history the
