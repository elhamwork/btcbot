...
Written 01 Sep 2026 12:16pm California time by `check.py --report`.
...
| of those, settled and learned from | 782 |
...
The 63-day study is worth 30 observations per row below. So 782 live
