...
Written 29 Aug 2026 3:27pm California time by `check.py --report`.
...
| fees paid | $139.26 |
| contracts looked at | 511 |
| retired (old rule, not counted) | 10 |
| of those, settled and learned from | 510 |
...
The 63-day study is worth 30 observations per row below. So 510 live
...
| 50-55% | 0.558 | 0.528 | 119 (62 hit) | -0.029 ** |
| 55-60% | 0.605 | 0.564 | 66 (36 hit) | -0.041 ** |
...
Leaned YES 287 times, NO 224 times. Over 63 days of history the
