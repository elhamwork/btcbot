...
Written 12 Sep 2026 6:04pm California time by `check.py --report`.
...
| fees paid | $411.66 |
| contracts looked at | 1847 |
| retired (old rule, not counted) | 10 |
| of those, settled and learned from | 1846 |
...
The 63-day study is worth 30 observations per row below. So 1846 live
...
Leaned YES 991 times, NO 856 times. Over 63 days of history the
