...
Written 10 Sep 2026 9:24pm California time by `check.py --report`.
...
| fees paid | $387.27 |
| contracts looked at | 1668 |
| retired (old rule, not counted) | 10 |
| of those, settled and learned from | 1667 |
...
The 63-day study is worth 30 observations per row below. So 1667 live
...
| 55-60% | 0.605 | 0.539 | 241 (128 hit) | -0.066 ** |
...
Leaned YES 885 times, NO 783 times. Over 63 days of history the
