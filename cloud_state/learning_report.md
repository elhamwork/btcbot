...
Written 03 Sep 2026 10:38am California time by `check.py --report`.

## The short version

| | |
|---|---|
| **paper account** | **$855.19** (started $1,000, -14.5%) |
| best / worst it has been | $1,511.25 / $746.12 |
| fees paid | $238.80 |
| contracts looked at | 961 |
| retired (old rule, not counted) | 10 |
| of those, settled and learned from | 960 |
| actual calls (graded GOOD) | 154 |
| calls that have settled | 153 |
| alerts that reached the phone | 102 of 102 |
| calls made before delivery was recorded | 52 |
| calls right | 124 of 153 (81%) |
...
The 63-day study is worth 30 observations per row below. So 960 live
...
| 20-25% | 0.178 | 0.153 | 5 (0 hit) | -0.025 ** |
| 25-30% | 0.238 | 0.277 | 21 (7 hit) | +0.039 ** |
| 30-35% | 0.286 | 0.292 | 37 (11 hit) | +0.007 |
| 35-40% | 0.354 | 0.381 | 66 (26 hit) | +0.027 ** |
| 40-45% | 0.384 | 0.384 | 120 (46 hit) | -0.001 |
| 45-50% | 0.497 | 0.466 | 178 (82 hit) | -0.031 ** |
| 50-55% | 0.558 | 0.535 | 205 (109 hit) | -0.023 ** |
| 55-60% | 0.605 | 0.552 | 137 (74 hit) | -0.053 ** |
| 60-65% | 0.678 | 0.596 | 78 (44 hit) | -0.082 ** |
| 65-70% | 0.738 | 0.672 | 52 (33 hit) | -0.065 ** |
| 70-75% | 0.814 | 0.777 | 22 (16 hit) | -0.037 ** |
...
Leaned YES 524 times, NO 437 times. Over 63 days of history the
...
|---|---|---|---|---|---|
| 17:34 | KXBTC15M-26SEP031345-45 | YES | 0.78 | $85.52 | $22.80 |
