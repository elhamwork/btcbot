...
Written 10 Sep 2026 6:53pm California time by `check.py --report`.
...
| fees paid | $387.27 |
| contracts looked at | 1658 |
| retired (old rule, not counted) | 10 |
| of those, settled and learned from | 1657 |
...
The 63-day study is worth 30 observations per row below. So 1657 live
...
| 45-50% | 0.497 | 0.476 | 331 (157 hit) | -0.021 ** |
| 50-55% | 0.558 | 0.520 | 352 (182 hit) | -0.037 ** |
| 55-60% | 0.605 | 0.534 | 238 (125 hit) | -0.071 ** |
| 60-65% | 0.678 | 0.586 | 126 (71 hit) | -0.092 ** |
...
Leaned YES 878 times, NO 780 times. Over 63 days of history the
