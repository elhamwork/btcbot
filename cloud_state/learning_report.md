...
Written 09 Sep 2026 2:12pm California time by `check.py --report`.
...
| fees paid | $348.08 |
| contracts looked at | 1551 |
| retired (old rule, not counted) | 10 |
| of those, settled and learned from | 1550 |
...
The 63-day study is worth 30 observations per row below. So 1550 live
...
| 50-55% | 0.558 | 0.520 | 327 (169 hit) | -0.037 ** |
...
Leaned YES 820 times, NO 731 times. Over 63 days of history the
