...
Written 11 Sep 2026 8:49pm California time by `check.py --report`.
...
| fees paid | $399.05 |
| contracts looked at | 1762 |
| retired (old rule, not counted) | 10 |
| of those, settled and learned from | 1761 |
...
The 63-day study is worth 30 observations per row below. So 1761 live
...
Leaned YES 936 times, NO 826 times. Over 63 days of history the
