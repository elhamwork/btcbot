...
Written 01 Sep 2026 6:26pm California time by `check.py --report`.
...
| fees paid | $208.28 |
| contracts looked at | 808 |
| retired (old rule, not counted) | 10 |
| of those, settled and learned from | 807 |
...
The 63-day study is worth 30 observations per row below. So 807 live
...
| 50-55% | 0.558 | 0.532 | 180 (95 hit) | -0.026 ** |
...
Leaned YES 448 times, NO 360 times. Over 63 days of history the
