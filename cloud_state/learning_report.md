...
Written 04 Sep 2026 7:43am California time by `check.py --report`.
...
| fees paid | $257.18 |
| contracts looked at | 1045 |
| retired (old rule, not counted) | 10 |
| of those, settled and learned from | 1044 |
...
The 63-day study is worth 30 observations per row below. So 1044 live
...
| 50-55% | 0.558 | 0.535 | 220 (117 hit) | -0.023 ** |
...
Leaned YES 568 times, NO 477 times. Over 63 days of history the
