...
Written 09 Sep 2026 1:16pm California time by `check.py --report`.
...
| fees paid | $348.08 |
| contracts looked at | 1548 |
| retired (old rule, not counted) | 10 |
| of those, settled and learned from | 1546 |
...
The 63-day study is worth 30 observations per row below. So 1546 live
...
Leaned YES 818 times, NO 730 times. Over 63 days of history the
