...
Written 11 Sep 2026 4:59pm California time by `check.py --report`.
...
| fees paid | $396.98 |
| contracts looked at | 1746 |
| retired (old rule, not counted) | 10 |
| of those, settled and learned from | 1745 |
...
The 63-day study is worth 30 observations per row below. So 1745 live
...
Leaned YES 925 times, NO 821 times. Over 63 days of history the
