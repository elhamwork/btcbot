...
Written 27 Aug 2026 7:13am California time by `check.py --report`.
...
| fees paid | $72.48 |
| contracts looked at | 327 |
| retired (old rule, not counted) | 10 |
| of those, settled and learned from | 326 |
...
The 63-day study is worth 30 observations per row below. So 326 live
...
| 40-45% | 0.384 | 0.361 | 38 (13 hit) | -0.024 ** |
| 45-50% | 0.497 | 0.471 | 59 (27 hit) | -0.026 ** |
...
Leaned YES 186 times, NO 141 times. Over 63 days of history the
