...
Written 12 Sep 2026 5:27pm California time by `check.py --report`.
...
| fees paid | $411.66 |
| contracts looked at | 1844 |
| retired (old rule, not counted) | 10 |
| of those, settled and learned from | 1843 |
...
The 63-day study is worth 30 observations per row below. So 1843 live
...
| 55-60% | 0.605 | 0.538 | 279 (148 hit) | -0.067 ** |
| 60-65% | 0.678 | 0.596 | 145 (84 hit) | -0.082 ** |
...
| grade | times |
|---|---|
| NONE (no disagreement) | 958 |
| WEAK (50-70c) | 274 |
| GOOD | 246 |
| BAD (cheap side) | 233 |
| WEAK (small disagreement) | 103 |
| BAD (last 5 min) | 12 |
...
Leaned YES 989 times, NO 855 times. Over 63 days of history the
