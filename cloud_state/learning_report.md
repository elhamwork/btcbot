...
Written 10 Sep 2026 9:51am California time by `check.py --report`.
...
| fees paid | $380.84 |
| contracts looked at | 1622 |
| retired (old rule, not counted) | 10 |
| of those, settled and learned from | 1621 |
...
The 63-day study is worth 30 observations per row below. So 1621 live
...
| 60-65% | 0.678 | 0.590 | 123 (70 hit) | -0.088 ** |
...
Leaned YES 856 times, NO 766 times. Over 63 days of history the
