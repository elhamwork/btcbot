...
Written 07 Sep 2026 4:44pm California time by `check.py --report`.
...
| fees paid | $312.69 |
| contracts looked at | 1369 |
| retired (old rule, not counted) | 10 |
| of those, settled and learned from | 1368 |
...
The 63-day study is worth 30 observations per row below. So 1368 live
...
Leaned YES 729 times, NO 640 times. Over 63 days of history the
