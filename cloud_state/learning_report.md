...
Written 05 Sep 2026 4:19am California time by `check.py --report`.
...
| fees paid | $273.17 |
| contracts looked at | 1128 |
| retired (old rule, not counted) | 10 |
| of those, settled and learned from | 1127 |
...
The 63-day study is worth 30 observations per row below. So 1127 live
...
| 40-45% | 0.384 | 0.398 | 142 (57 hit) | +0.014 |
...
| GOOD | 168 |
| BAD (cheap side) | 138 |
| WEAK (small disagreement) | 63 |
| BAD (last 5 min) | 11 |
| ALMOST (not confirmed yet) | 7 |
| WEAK (5-10 min) | 5 |

Leaned YES 611 times, NO 517 times. Over 63 days of history the
