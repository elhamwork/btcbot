...
Written 06 Sep 2026 10:00am California time by `check.py --report`.
...
| fees paid | $292.03 |
| contracts looked at | 1246 |
| retired (old rule, not counted) | 10 |
| of those, settled and learned from | 1245 |
| actual calls (graded GOOD) | 187 |
| calls that have settled | 187 |
| alerts that reached the phone | 135 of 135 |
...
The 63-day study is worth 30 observations per row below. So 1245 live
...
| 35-40% | 0.354 | 0.383 | 89 (35 hit) | +0.029 ** |
| 40-45% | 0.384 | 0.396 | 158 (63 hit) | +0.012 |
| 45-50% | 0.497 | 0.483 | 241 (116 hit) | -0.014 |
...
Leaned YES 665 times, NO 581 times. Over 63 days of history the
