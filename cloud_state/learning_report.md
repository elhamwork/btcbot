...
Written 29 Aug 2026 5:47am California time by `check.py --report`.
...
| fees paid | $123.26 |
| contracts looked at | 473 |
| retired (old rule, not counted) | 10 |
| of those, settled and learned from | 472 |
...
The 63-day study is worth 30 observations per row below. So 472 live
...
| 50-55% | 0.558 | 0.513 | 108 (54 hit) | -0.045 ** |
...
Leaned YES 260 times, NO 213 times. Over 63 days of history the
