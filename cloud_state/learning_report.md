...
Written 01 Sep 2026 1:42am California time by `check.py --report`.
...
| fees paid | $193.54 |
| contracts looked at | 741 |
| retired (old rule, not counted) | 10 |
| of those, settled and learned from | 740 |
...
The 63-day study is worth 30 observations per row below. So 740 live
...
Leaned YES 407 times, NO 334 times. Over 63 days of history the
