...
Written 30 Aug 2026 7:52pm California time by `check.py --report`.
...
| fees paid | $169.27 |
| contracts looked at | 625 |
| retired (old rule, not counted) | 10 |
| of those, settled and learned from | 624 |
...
The 63-day study is worth 30 observations per row below. So 624 live
...
Leaned YES 345 times, NO 280 times. Over 63 days of history the
