...
Written 11 Sep 2026 1:35pm California time by `check.py --report`.
...
| fees paid | $394.66 |
| contracts looked at | 1733 |
| retired (old rule, not counted) | 10 |
| of those, settled and learned from | 1732 |
...
The 63-day study is worth 30 observations per row below. So 1732 live
...
| 40-45% | 0.384 | 0.405 | 221 (90 hit) | +0.020 ** |
...
Leaned YES 918 times, NO 815 times. Over 63 days of history the
