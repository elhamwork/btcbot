...
Written 29 Aug 2026 2:43pm California time by `check.py --report`.
...
| fees paid | $139.26 |
| contracts looked at | 508 |
| retired (old rule, not counted) | 10 |
| of those, settled and learned from | 507 |
...
The 63-day study is worth 30 observations per row below. So 507 live
...
Leaned YES 284 times, NO 224 times. Over 63 days of history the
