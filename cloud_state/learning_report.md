...
Written 05 Sep 2026 1:08pm California time by `check.py --report`.
...
| fees paid | $278.41 |
| contracts looked at | 1163 |
| retired (old rule, not counted) | 10 |
| of those, settled and learned from | 1162 |
...
The 63-day study is worth 30 observations per row below. So 1162 live
...
Leaned YES 629 times, NO 534 times. Over 63 days of history the
