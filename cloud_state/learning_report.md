...
Written 05 Sep 2026 3:17pm California time by `check.py --report`.
...
| fees paid | $278.41 |
| contracts looked at | 1172 |
| retired (old rule, not counted) | 10 |
| of those, settled and learned from | 1171 |
...
The 63-day study is worth 30 observations per row below. So 1171 live
...
Leaned YES 632 times, NO 540 times. Over 63 days of history the
