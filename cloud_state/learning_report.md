...
Written 31 Aug 2026 1:22am California time by `check.py --report`.
...
| fees paid | $174.74 |
| contracts looked at | 647 |
| retired (old rule, not counted) | 10 |
| of those, settled and learned from | 646 |
...
The 63-day study is worth 30 observations per row below. So 646 live
...
| 40-45% | 0.384 | 0.367 | 86 (31 hit) | -0.018 |
...
Leaned YES 354 times, NO 293 times. Over 63 days of history the
