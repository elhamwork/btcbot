...
Written 30 Aug 2026 7:16am California time by `check.py --report`.
...
| of those, settled and learned from | 573 |
...
The 63-day study is worth 30 observations per row below. So 573 live
...
| 35-40% | 0.354 | 0.358 | 36 (13 hit) | +0.004 |
