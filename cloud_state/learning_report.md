...
Written 03 Sep 2026 6:51am California time by `check.py --report`.
...
| fees paid | $237.61 |
| contracts looked at | 946 |
| retired (old rule, not counted) | 10 |
| of those, settled and learned from | 945 |
...
The 63-day study is worth 30 observations per row below. So 945 live
...
| 35-40% | 0.354 | 0.375 | 65 (25 hit) | +0.021 ** |
...
Leaned YES 514 times, NO 432 times. Over 63 days of history the
