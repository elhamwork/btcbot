...
Written 10 Sep 2026 3:09am California time by `check.py --report`.

## The short version

| | |
|---|---|
| **paper account** | **$1,196.85** (started $1,000, +19.7%) |
| best / worst it has been | $1,511.25 / $746.12 |
| fees paid | $368.85 |
| contracts looked at | 1595 |
| retired (old rule, not counted) | 10 |
| of those, settled and learned from | 1594 |
| actual calls (graded GOOD) | 234 |
| calls that have settled | 234 |
| alerts that reached the phone | 182 of 182 |
| calls made before delivery was recorded | 52 |
| calls right | 192 of 234 (82%) |
...
The 63-day study is worth 30 observations per row below. So 1594 live
...
| 45-50% | 0.497 | 0.478 | 319 (152 hit) | -0.019 |
| 50-55% | 0.558 | 0.524 | 334 (174 hit) | -0.034 ** |
| 55-60% | 0.605 | 0.533 | 229 (120 hit) | -0.072 ** |
...
Leaned YES 844 times, NO 751 times. Over 63 days of history the
