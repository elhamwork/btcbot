...
Written 12 Sep 2026 5:04am California time by `check.py --report`.
...
| fees paid | $407.55 |
| contracts looked at | 1795 |
| retired (old rule, not counted) | 10 |
| of those, settled and learned from | 1794 |
...
The 63-day study is worth 30 observations per row below. So 1794 live
...
Leaned YES 962 times, NO 833 times. Over 63 days of history the
