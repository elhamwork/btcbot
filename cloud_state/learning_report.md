...
Written 26 Aug 2026 12:41am California time by `check.py --report`.
...
| fees paid | $52.97 |
| contracts looked at | 246 |
| retired (old rule, not counted) | 10 |
| of those, settled and learned from | 245 |
...
The 63-day study is worth 30 observations per row below. So 245 live
...
| 45-50% | 0.497 | 0.484 | 40 (19 hit) | -0.012 |
| 50-55% | 0.558 | 0.521 | 52 (26 hit) | -0.037 ** |
| 55-60% | 0.605 | 0.554 | 37 (19 hit) | -0.051 ** |
...
Leaned YES 149 times, NO 97 times. Over 63 days of history the
