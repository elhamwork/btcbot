...
Written 03 Sep 2026 3:51pm California time by `check.py --report`.
...
| of those, settled and learned from | 981 |
...
The 63-day study is worth 30 observations per row below. So 981 live
...
| 40-45% | 0.384 | 0.384 | 125 (48 hit) | -0.000 |
