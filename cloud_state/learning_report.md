...
Written 31 Aug 2026 2:07pm California time by `check.py --report`.
...
| of those, settled and learned from | 694 |
...
The 63-day study is worth 30 observations per row below. So 694 live
...
| 55-60% | 0.605 | 0.551 | 90 (48 hit) | -0.054 ** |
