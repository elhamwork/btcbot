...
Written 12 Sep 2026 4:28am California time by `check.py --report`.
...
| fees paid | $407.55 |
| contracts looked at | 1792 |
| retired (old rule, not counted) | 10 |
| of those, settled and learned from | 1791 |
...
The 63-day study is worth 30 observations per row below. So 1791 live
...
| 50-55% | 0.558 | 0.518 | 381 (196 hit) | -0.040 ** |
...
Leaned YES 960 times, NO 832 times. Over 63 days of history the
