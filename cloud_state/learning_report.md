...
Written 04 Sep 2026 9:49am California time by `check.py --report`.
...
| fees paid | $257.18 |
| contracts looked at | 1054 |
| retired (old rule, not counted) | 10 |
| of those, settled and learned from | 1053 |
...
The 63-day study is worth 30 observations per row below. So 1053 live
...
Leaned YES 574 times, NO 480 times. Over 63 days of history the
