...
Written 06 Sep 2026 1:18am California time by `check.py --report`.
...
| fees paid | $285.48 |
| contracts looked at | 1212 |
| retired (old rule, not counted) | 10 |
| of those, settled and learned from | 1211 |
...
The 63-day study is worth 30 observations per row below. So 1211 live
...
| 40-45% | 0.384 | 0.402 | 153 (62 hit) | +0.017 |
...
Leaned YES 651 times, NO 561 times. Over 63 days of history the
