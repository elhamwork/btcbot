...
Written 02 Sep 2026 11:59pm California time by `check.py --report`.
...
| of those, settled and learned from | 925 |
...
The 63-day study is worth 30 observations per row below. So 925 live
