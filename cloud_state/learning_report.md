...
Written 28 Aug 2026 11:22pm California time by `check.py --report`.
...
| fees paid | $115.87 |
| contracts looked at | 449 |
| retired (old rule, not counted) | 10 |
| of those, settled and learned from | 448 |
...
The 63-day study is worth 30 observations per row below. So 448 live
...
| 45-50% | 0.497 | 0.423 | 88 (35 hit) | -0.074 ** |
...
Leaned YES 244 times, NO 205 times. Over 63 days of history the
