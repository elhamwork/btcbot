...
Written 30 Aug 2026 10:06pm California time by `check.py --report`.
...
| fees paid | $170.13 |
| contracts looked at | 634 |
| retired (old rule, not counted) | 10 |
| of those, settled and learned from | 633 |
...
The 63-day study is worth 30 observations per row below. So 633 live
...
Leaned YES 348 times, NO 286 times. Over 63 days of history the
