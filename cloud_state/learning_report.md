...
Written 30 Aug 2026 6:10pm California time by `check.py --report`.
...
| fees paid | $169.27 |
| contracts looked at | 618 |
| retired (old rule, not counted) | 10 |
| of those, settled and learned from | 617 |
...
The 63-day study is worth 30 observations per row below. So 617 live
...
| 50-55% | 0.558 | 0.542 | 141 (76 hit) | -0.015 |
...
Leaned YES 342 times, NO 276 times. Over 63 days of history the
