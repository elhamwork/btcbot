...
Written 11 Sep 2026 1:10pm California time by `check.py --report`.
...
| fees paid | $394.66 |
| contracts looked at | 1731 |
| retired (old rule, not counted) | 10 |
| of those, settled and learned from | 1730 |
...
The 63-day study is worth 30 observations per row below. So 1730 live
...
Leaned YES 918 times, NO 813 times. Over 63 days of history the
