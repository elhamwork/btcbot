...
Written 07 Sep 2026 12:03pm California time by `check.py --report`.
...
| fees paid | $311.46 |
| contracts looked at | 1351 |
| retired (old rule, not counted) | 10 |
| of those, settled and learned from | 1350 |
...
The 63-day study is worth 30 observations per row below. So 1350 live
...
| 55-60% | 0.605 | 0.550 | 203 (110 hit) | -0.055 ** |
...
Leaned YES 721 times, NO 630 times. Over 63 days of history the
