...
Written 05 Sep 2026 7:05pm California time by `check.py --report`.
...
| fees paid | $282.57 |
| contracts looked at | 1187 |
| retired (old rule, not counted) | 10 |
| of those, settled and learned from | 1186 |
...
The 63-day study is worth 30 observations per row below. So 1186 live
...
| 40-45% | 0.384 | 0.403 | 150 (61 hit) | +0.019 |
| 45-50% | 0.497 | 0.488 | 230 (112 hit) | -0.009 |
...
Leaned YES 638 times, NO 549 times. Over 63 days of history the
