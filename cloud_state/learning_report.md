...
Written 09 Sep 2026 1:47am California time by `check.py --report`.
...
| fees paid | $339.87 |
| contracts looked at | 1502 |
| retired (old rule, not counted) | 10 |
| of those, settled and learned from | 1501 |
...
The 63-day study is worth 30 observations per row below. So 1501 live
...
| 50-55% | 0.558 | 0.524 | 315 (164 hit) | -0.034 ** |
...
Leaned YES 797 times, NO 705 times. Over 63 days of history the
