...
Written 02 Sep 2026 5:33pm California time by `check.py --report`.
...
| fees paid | $233.24 |
| contracts looked at | 901 |
| retired (old rule, not counted) | 10 |
| of those, settled and learned from | 900 |
...
The 63-day study is worth 30 observations per row below. So 900 live
...
| GOOD | 139 |
| BAD (cheap side) | 105 |
| WEAK (small disagreement) | 57 |
| BAD (last 5 min) | 11 |
| WEAK (5-10 min) | 5 |
| ALMOST (not confirmed yet) | 5 |

Leaned YES 490 times, NO 411 times. Over 63 days of history the
