...
Written 03 Sep 2026 12:24am California time by `check.py --report`.
...
| fees paid | $236.74 |
| contracts looked at | 926 |
| retired (old rule, not counted) | 10 |
| of those, settled and learned from | 926 |
...
The 63-day study is worth 30 observations per row below. So 926 live
...
Leaned YES 500 times, NO 426 times. Over 63 days of history the
