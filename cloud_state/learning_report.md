...
Written 01 Sep 2026 3:42pm California time by `check.py --report`.
...
| of those, settled and learned from | 796 |
...
The 63-day study is worth 30 observations per row below. So 796 live
...
| 45-50% | 0.497 | 0.450 | 152 (67 hit) | -0.047 ** |
