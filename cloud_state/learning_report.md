...
Written 07 Sep 2026 10:46am California time by `check.py --report`.

## The short version

| | |
|---|---|
| **paper account** | **$1,252.41** (started $1,000, +25.2%) |
| best / worst it has been | $1,511.25 / $746.12 |
| fees paid | $311.46 |
| contracts looked at | 1346 |
| retired (old rule, not counted) | 10 |
| of those, settled and learned from | 1344 |
| actual calls (graded GOOD) | 198 |
| calls that have settled | 198 |
| alerts that reached the phone | 146 of 146 |
| calls made before delivery was recorded | 52 |
| calls right | 163 of 198 (82%) |
...
The 63-day study is worth 30 observations per row below. So 1344 live
...
| 30-35% | 0.286 | 0.293 | 47 (14 hit) | +0.008 |
| 35-40% | 0.354 | 0.375 | 97 (37 hit) | +0.021 ** |
| 40-45% | 0.384 | 0.392 | 173 (68 hit) | +0.007 |
| 45-50% | 0.497 | 0.483 | 262 (126 hit) | -0.014 |
| 50-55% | 0.558 | 0.525 | 282 (147 hit) | -0.033 ** |
| 55-60% | 0.605 | 0.548 | 200 (108 hit) | -0.057 ** |
| 60-65% | 0.678 | 0.600 | 99 (57 hit) | -0.078 ** |
| 65-70% | 0.738 | 0.668 | 69 (44 hit) | -0.070 ** |
...
| grade | times |
|---|---|
| NONE (no disagreement) | 654 |
| WEAK (50-70c) | 230 |
| GOOD | 190 |
| BAD (cheap side) | 171 |
| WEAK (small disagreement) | 77 |
| BAD (last 5 min) | 11 |
| ALMOST (not confirmed yet) | 8 |
| WEAK (5-10 min) | 5 |

Leaned YES 716 times, NO 630 times. Over 63 days of history the
