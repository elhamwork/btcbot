...
Written 07 Sep 2026 3:13pm California time by `check.py --report`.
...
| fees paid | $312.69 |
| contracts looked at | 1363 |
| retired (old rule, not counted) | 10 |
| of those, settled and learned from | 1362 |
...
The 63-day study is worth 30 observations per row below. So 1362 live
...
| 40-45% | 0.384 | 0.390 | 174 (68 hit) | +0.005 |
...
Leaned YES 727 times, NO 636 times. Over 63 days of history the
