...
Written 31 Aug 2026 5:18am California time by `check.py --report`.
...
| fees paid | $176.51 |
| contracts looked at | 663 |
| retired (old rule, not counted) | 10 |
| of those, settled and learned from | 662 |
...
The 63-day study is worth 30 observations per row below. So 662 live
...
| 45-50% | 0.497 | 0.450 | 132 (58 hit) | -0.047 ** |
...
Leaned YES 360 times, NO 303 times. Over 63 days of history the
