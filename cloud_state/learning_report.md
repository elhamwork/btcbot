...
Written 08 Sep 2026 8:43pm California time by `check.py --report`.
...
| fees paid | $333.87 |
| contracts looked at | 1481 |
| retired (old rule, not counted) | 10 |
| of those, settled and learned from | 1480 |
| actual calls (graded GOOD) | 213 |
| calls that have settled | 213 |
| alerts that reached the phone | 161 of 161 |
...
The 63-day study is worth 30 observations per row below. So 1480 live
...
| 30-35% | 0.286 | 0.291 | 51 (15 hit) | +0.005 |
| 35-40% | 0.354 | 0.381 | 108 (42 hit) | +0.027 ** |
| 40-45% | 0.384 | 0.384 | 190 (73 hit) | -0.000 |
| 45-50% | 0.497 | 0.475 | 296 (140 hit) | -0.022 ** |
| 50-55% | 0.558 | 0.523 | 310 (161 hit) | -0.035 ** |
| 55-60% | 0.605 | 0.539 | 215 (114 hit) | -0.066 ** |
...
| 80-85% | 0.885 | 0.880 | 7 (6 hit) | -0.005 |
...
Leaned YES 782 times, NO 699 times. Over 63 days of history the
