...
Written 30 Aug 2026 4:14am California time by `check.py --report`.
...
| fees paid | $152.00 |
| contracts looked at | 562 |
| retired (old rule, not counted) | 10 |
| of those, settled and learned from | 561 |
...
The 63-day study is worth 30 observations per row below. So 561 live
...
| 65-70% | 0.738 | 0.697 | 29 (19 hit) | -0.041 ** |
...
Leaned YES 316 times, NO 246 times. Over 63 days of history the
