...
Written 30 Aug 2026 2:05pm California time by `check.py --report`.
...
| fees paid | $163.71 |
| contracts looked at | 602 |
| retired (old rule, not counted) | 10 |
| of those, settled and learned from | 601 |
...
The 63-day study is worth 30 observations per row below. So 601 live
...
Leaned YES 336 times, NO 266 times. Over 63 days of history the
...
|---|---|---|---|---|---|
| 21:03 | KXBTC15M-26AUG301715-15 | NO | 0.82 | $148.06 | $30.63 |
