...
Written 01 Sep 2026 12:07am California time by `check.py --report`.
...
| fees paid | $193.54 |
| contracts looked at | 735 |
| retired (old rule, not counted) | 10 |
| of those, settled and learned from | 734 |
...
The 63-day study is worth 30 observations per row below. So 734 live
...
| 45-50% | 0.497 | 0.447 | 142 (62 hit) | -0.050 ** |
...
Leaned YES 401 times, NO 334 times. Over 63 days of history the
