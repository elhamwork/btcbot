...
Written 30 Aug 2026 11:09am California time by `check.py --report`.
...
| fees paid | $157.94 |
| contracts looked at | 590 |
| retired (old rule, not counted) | 10 |
| of those, settled and learned from | 589 |
...
The 63-day study is worth 30 observations per row below. So 589 live
...
| 60-65% | 0.678 | 0.671 | 45 (30 hit) | -0.007 |
...
Leaned YES 330 times, NO 260 times. Over 63 days of history the
