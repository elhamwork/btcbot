...
Written 31 Aug 2026 6:54pm California time by `check.py --report`.
...
| fees paid | $188.08 |
| contracts looked at | 714 |
| retired (old rule, not counted) | 10 |
| of those, settled and learned from | 713 |
...
The 63-day study is worth 30 observations per row below. So 713 live
...
Leaned YES 388 times, NO 326 times. Over 63 days of history the
