...
Written 30 Aug 2026 7:17pm California time by `check.py --report`.
...
| fees paid | $169.27 |
| contracts looked at | 623 |
| retired (old rule, not counted) | 10 |
| of those, settled and learned from | 622 |
...
The 63-day study is worth 30 observations per row below. So 622 live
...
| 40-45% | 0.384 | 0.365 | 81 (29 hit) | -0.019 |
...
Leaned YES 344 times, NO 279 times. Over 63 days of history the
