...
Written 28 Aug 2026 3:01am California time by `check.py --report`.

## The short version

| | |
|---|---|
| **paper account** | **$1,083.22** (started $1,000, +8.3%) |
| best / worst it has been | $1,279.61 / $926.62 |
| fees paid | $91.54 |
| contracts looked at | 381 |
| retired (old rule, not counted) | 10 |
| of those, settled and learned from | 379 |
| actual calls (graded GOOD) | 58 |
| calls that have settled | 58 |
| alerts that reached the phone | 6 of 6 |
| calls made before delivery was recorded | 52 |
| calls right | 48 of 58 (83%) |
...
The 63-day study is worth 30 observations per row below. So 379 live
...
| 45-50% | 0.497 | 0.447 | 75 (32 hit) | -0.050 ** |
| 50-55% | 0.558 | 0.520 | 81 (41 hit) | -0.038 ** |
...
Leaned YES 207 times, NO 174 times. Over 63 days of history the
