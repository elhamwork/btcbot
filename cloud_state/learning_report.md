...
Written 03 Sep 2026 4:56pm California time by `check.py --report`.
...
| of those, settled and learned from | 985 |
...
The 63-day study is worth 30 observations per row below. So 985 live
