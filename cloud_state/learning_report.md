...
Written 08 Sep 2026 12:44pm California time by `check.py --report`.
...
| fees paid | $326.24 |
| contracts looked at | 1449 |
| retired (old rule, not counted) | 10 |
| of those, settled and learned from | 1448 |
| actual calls (graded GOOD) | 208 |
| calls that have settled | 208 |
| alerts that reached the phone | 156 of 156 |
...
The 63-day study is worth 30 observations per row below. So 1448 live
...
| 45-50% | 0.497 | 0.484 | 286 (138 hit) | -0.013 |
...
| 70-75% | 0.814 | 0.770 | 29 (21 hit) | -0.044 ** |
...
Leaned YES 766 times, NO 683 times. Over 63 days of history the
