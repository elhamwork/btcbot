...
Written 29 Aug 2026 11:22pm California time by `check.py --report`.
...
| fees paid | $149.89 |
| contracts looked at | 543 |
| retired (old rule, not counted) | 10 |
| of those, settled and learned from | 542 |
...
The 63-day study is worth 30 observations per row below. So 542 live
...
| 45-50% | 0.497 | 0.440 | 104 (44 hit) | -0.057 ** |
...
Leaned YES 305 times, NO 238 times. Over 63 days of history the
