...
Written 02 Sep 2026 12:36am California time by `check.py --report`.
...
| fees paid | $217.61 |
| contracts looked at | 833 |
| retired (old rule, not counted) | 10 |
| of those, settled and learned from | 832 |
...
The 63-day study is worth 30 observations per row below. So 832 live
...
| 30-35% | 0.286 | 0.293 | 30 (9 hit) | +0.007 |
...
Leaned YES 460 times, NO 373 times. Over 63 days of history the
