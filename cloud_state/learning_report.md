...
Written 04 Sep 2026 7:48am California time by `check.py --report`.
...
| fees paid | $257.18 |
| contracts looked at | 1046 |
| retired (old rule, not counted) | 10 |
| of those, settled and learned from | 1045 |
...
The 63-day study is worth 30 observations per row below. So 1045 live
...
| 50-55% | 0.558 | 0.533 | 221 (117 hit) | -0.025 ** |
...
Leaned YES 569 times, NO 477 times. Over 63 days of history the
