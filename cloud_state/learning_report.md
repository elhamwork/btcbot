...
Written 04 Sep 2026 7:17pm California time by `check.py --report`.
...
| fees paid | $267.08 |
| contracts looked at | 1092 |
| retired (old rule, not counted) | 10 |
| of those, settled and learned from | 1091 |
...
The 63-day study is worth 30 observations per row below. So 1091 live
...
Leaned YES 594 times, NO 498 times. Over 63 days of history the
