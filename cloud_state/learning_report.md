...
Written 13 Sep 2026 9:01pm California time by `check.py --report`.
...
| fees paid | $452.03 |
| contracts looked at | 1955 |
| retired (old rule, not counted) | 10 |
| of those, settled and learned from | 1953 |
...
The 63-day study is worth 30 observations per row below. So 1953 live
...
| 45-50% | 0.497 | 0.460 | 394 (180 hit) | -0.037 ** |
...
Leaned YES 1056 times, NO 899 times. Over 63 days of history the
