...
Written 01 Sep 2026 12:47am California time by `check.py --report`.
...
| fees paid | $193.54 |
| contracts looked at | 738 |
| retired (old rule, not counted) | 10 |
| of those, settled and learned from | 737 |
...
The 63-day study is worth 30 observations per row below. So 737 live
...
| 55-60% | 0.605 | 0.535 | 101 (52 hit) | -0.069 ** |
...
Leaned YES 404 times, NO 334 times. Over 63 days of history the
