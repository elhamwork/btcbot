...
Written 12 Sep 2026 7:15pm California time by `check.py --report`.
...
| fees paid | $411.66 |
| contracts looked at | 1851 |
| retired (old rule, not counted) | 10 |
| of those, settled and learned from | 1850 |
...
The 63-day study is worth 30 observations per row below. So 1850 live
...
| 50-55% | 0.558 | 0.515 | 391 (200 hit) | -0.043 ** |
...
Leaned YES 994 times, NO 857 times. Over 63 days of history the
