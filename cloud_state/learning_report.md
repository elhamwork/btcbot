...
Written 07 Sep 2026 10:10am California time by `check.py --report`.
...
| fees paid | $311.46 |
| contracts looked at | 1343 |
| retired (old rule, not counted) | 10 |
| of those, settled and learned from | 1342 |
...
The 63-day study is worth 30 observations per row below. So 1342 live
...
| 55-60% | 0.605 | 0.547 | 199 (107 hit) | -0.058 ** |
...
Leaned YES 715 times, NO 628 times. Over 63 days of history the
