...
Written 04 Sep 2026 9:19am California time by `check.py --report`.
...
| fees paid | $257.18 |
| contracts looked at | 1052 |
| retired (old rule, not counted) | 10 |
| of those, settled and learned from | 1051 |
...
The 63-day study is worth 30 observations per row below. So 1051 live
...
| 50-55% | 0.558 | 0.531 | 222 (117 hit) | -0.027 ** |
...
Leaned YES 573 times, NO 479 times. Over 63 days of history the
