...
Written 06 Sep 2026 4:45pm California time by `check.py --report`.
...
| fees paid | $304.72 |
| contracts looked at | 1273 |
| retired (old rule, not counted) | 10 |
| of those, settled and learned from | 1272 |
...
The 63-day study is worth 30 observations per row below. So 1272 live
...
Leaned YES 677 times, NO 596 times. Over 63 days of history the
