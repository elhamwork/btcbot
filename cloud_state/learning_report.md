...
Written 10 Sep 2026 8:44pm California time by `check.py --report`.
...
| fees paid | $387.27 |
| contracts looked at | 1665 |
| retired (old rule, not counted) | 10 |
| of those, settled and learned from | 1664 |
...
The 63-day study is worth 30 observations per row below. So 1664 live
...
Leaned YES 882 times, NO 783 times. Over 63 days of history the
