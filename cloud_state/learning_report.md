...
Written 02 Sep 2026 10:26am California time by `check.py --report`.
...
| fees paid | $228.08 |
| contracts looked at | 872 |
| retired (old rule, not counted) | 10 |
| of those, settled and learned from | 871 |
| actual calls (graded GOOD) | 142 |
| calls that have settled | 142 |
| alerts that reached the phone | 90 of 90 |
...
The 63-day study is worth 30 observations per row below. So 871 live
...
| 50-55% | 0.558 | 0.529 | 187 (98 hit) | -0.029 ** |
...
Leaned YES 478 times, NO 394 times. Over 63 days of history the
