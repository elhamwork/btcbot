...
Written 31 Aug 2026 5:09pm California time by `check.py --report`.
...
| fees paid | $185.10 |
| contracts looked at | 707 |
| retired (old rule, not counted) | 10 |
| of those, settled and learned from | 706 |
...
The 63-day study is worth 30 observations per row below. So 706 live
...
| 50-55% | 0.558 | 0.542 | 156 (84 hit) | -0.016 |
...
Leaned YES 384 times, NO 323 times. Over 63 days of history the
