...
Written 02 Sep 2026 4:59am California time by `check.py --report`.
...
| fees paid | $222.52 |
| contracts looked at | 850 |
| retired (old rule, not counted) | 10 |
| of those, settled and learned from | 849 |
...
The 63-day study is worth 30 observations per row below. So 849 live
...
Leaned YES 468 times, NO 382 times. Over 63 days of history the
