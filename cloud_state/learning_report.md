...
Written 09 Sep 2026 10:00am California time by `check.py --report`.
...
| fees paid | $346.03 |
| contracts looked at | 1534 |
| retired (old rule, not counted) | 10 |
| of those, settled and learned from | 1533 |
...
The 63-day study is worth 30 observations per row below. So 1533 live
...
| 45-50% | 0.497 | 0.480 | 307 (147 hit) | -0.016 |
...
Leaned YES 811 times, NO 723 times. Over 63 days of history the
