...
Written 30 Aug 2026 10:07am California time by `check.py --report`.
...
| fees paid | $156.32 |
| contracts looked at | 586 |
| retired (old rule, not counted) | 10 |
| of those, settled and learned from | 585 |
...
The 63-day study is worth 30 observations per row below. So 585 live
...
| 40-45% | 0.384 | 0.367 | 75 (27 hit) | -0.017 |
...
Leaned YES 328 times, NO 258 times. Over 63 days of history the
