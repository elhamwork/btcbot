...
Written 13 Sep 2026 8:09am California time by `check.py --report`.

## The short version

| | |
|---|---|
| **paper account** | **$1,630.37** (started $1,000, +63.0%) |
| best / worst it has been | $1,630.37 / $746.12 |
| fees paid | $420.28 |
| contracts looked at | 1903 |
| retired (old rule, not counted) | 10 |
| of those, settled and learned from | 1902 |
| actual calls (graded GOOD) | 263 |
| calls that have settled | 262 |
| alerts that reached the phone | 211 of 211 |
| calls made before delivery was recorded | 52 |
| calls right | 217 of 262 (83%) |
...
The 63-day study is worth 30 observations per row below. So 1902 live
...
Leaned YES 1024 times, NO 879 times. Over 63 days of history the
...
|---|---|---|---|---|---|
| 15:03 | KXBTC15M-26SEP131115-15 | NO | 0.82 | $163.04 | $33.73 |
