...
Written 10 Sep 2026 3:41pm California time by `check.py --report`.
...
| fees paid | $385.61 |
| contracts looked at | 1645 |
| retired (old rule, not counted) | 10 |
| of those, settled and learned from | 1644 |
...
The 63-day study is worth 30 observations per row below. So 1644 live
...
| 50-55% | 0.558 | 0.518 | 346 (178 hit) | -0.040 ** |
| 55-60% | 0.605 | 0.531 | 236 (123 hit) | -0.074 ** |
| 60-65% | 0.678 | 0.589 | 125 (71 hit) | -0.089 ** |
...
Leaned YES 868 times, NO 777 times. Over 63 days of history the
