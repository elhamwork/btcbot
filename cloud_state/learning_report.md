...
Written 06 Sep 2026 7:17am California time by `check.py --report`.
...
| fees paid | $290.50 |
| contracts looked at | 1236 |
| retired (old rule, not counted) | 10 |
| of those, settled and learned from | 1235 |
| actual calls (graded GOOD) | 186 |
| calls that have settled | 186 |
| alerts that reached the phone | 134 of 134 |
...
The 63-day study is worth 30 observations per row below. So 1235 live
...
| 55-60% | 0.605 | 0.548 | 182 (98 hit) | -0.057 ** |
...
Leaned YES 662 times, NO 574 times. Over 63 days of history the
