...
Written 12 Sep 2026 3:27pm California time by `check.py --report`.
...
| fees paid | $411.66 |
| contracts looked at | 1836 |
| retired (old rule, not counted) | 10 |
| of those, settled and learned from | 1835 |
...
The 63-day study is worth 30 observations per row below. So 1835 live
...
Leaned YES 982 times, NO 854 times. Over 63 days of history the
