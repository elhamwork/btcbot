...
Written 11 Sep 2026 11:35pm California time by `check.py --report`.

## The short version

| | |
|---|---|
| **paper account** | **$1,376.64** (started $1,000, +37.7%) |
| best / worst it has been | $1,511.25 / $746.12 |
| fees paid | $405.43 |
| contracts looked at | 1773 |
| retired (old rule, not counted) | 10 |
| of those, settled and learned from | 1772 |
| actual calls (graded GOOD) | 256 |
| calls that have settled | 255 |
| alerts that reached the phone | 204 of 204 |
| calls made before delivery was recorded | 52 |
| calls right | 210 of 255 (82%) |
...
The 63-day study is worth 30 observations per row below. So 1772 live
...
| 35-40% | 0.354 | 0.376 | 126 (48 hit) | +0.022 ** |
| 40-45% | 0.384 | 0.404 | 224 (91 hit) | +0.019 |
| 45-50% | 0.497 | 0.471 | 356 (167 hit) | -0.026 ** |
| 50-55% | 0.558 | 0.519 | 374 (193 hit) | -0.039 ** |
| 55-60% | 0.605 | 0.539 | 258 (137 hit) | -0.066 ** |
| 60-65% | 0.678 | 0.600 | 139 (81 hit) | -0.078 ** |
| 65-70% | 0.738 | 0.671 | 85 (55 hit) | -0.067 ** |
...
| grade | times |
|---|---|
| NONE (no disagreement) | 907 |
| WEAK (50-70c) | 269 |
| GOOD | 244 |
| BAD (cheap side) | 225 |
| WEAK (small disagreement) | 98 |
| BAD (last 5 min) | 12 |
...
Leaned YES 943 times, NO 830 times. Over 63 days of history the
...
|---|---|---|---|---|---|
| 06:32 | KXBTC15M-26SEP120245-45 | YES | 0.78 | $137.67 | $36.70 |
