...
Written 03 Sep 2026 6:36am California time by `check.py --report`.
...
| fees paid | $237.61 |
| contracts looked at | 945 |
| retired (old rule, not counted) | 10 |
| of those, settled and learned from | 944 |
...
The 63-day study is worth 30 observations per row below. So 944 live
...
Leaned YES 513 times, NO 432 times. Over 63 days of history the
