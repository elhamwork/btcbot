...
Written 31 Aug 2026 4:59pm California time by `check.py --report`.
...
| fees paid | $185.10 |
| contracts looked at | 706 |
| retired (old rule, not counted) | 10 |
| of those, settled and learned from | 705 |
...
The 63-day study is worth 30 observations per row below. So 705 live
...
| 50-55% | 0.558 | 0.539 | 155 (83 hit) | -0.019 |
...
Leaned YES 383 times, NO 323 times. Over 63 days of history the
