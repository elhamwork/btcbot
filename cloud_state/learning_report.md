...
Written 12 Sep 2026 3:48am California time by `check.py --report`.
...
| fees paid | $407.55 |
| contracts looked at | 1790 |
| retired (old rule, not counted) | 10 |
| of those, settled and learned from | 1789 |
...
The 63-day study is worth 30 observations per row below. So 1789 live
...
| 50-55% | 0.558 | 0.520 | 379 (196 hit) | -0.038 ** |
| 55-60% | 0.605 | 0.539 | 265 (141 hit) | -0.065 ** |
| 60-65% | 0.678 | 0.602 | 140 (82 hit) | -0.076 ** |
...
Leaned YES 958 times, NO 832 times. Over 63 days of history the
