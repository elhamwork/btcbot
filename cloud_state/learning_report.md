...
Written 31 Aug 2026 2:36am California time by `check.py --report`.
...
| fees paid | $174.74 |
| contracts looked at | 652 |
| retired (old rule, not counted) | 10 |
| of those, settled and learned from | 651 |
...
The 63-day study is worth 30 observations per row below. So 651 live
...
Leaned YES 358 times, NO 294 times. Over 63 days of history the
