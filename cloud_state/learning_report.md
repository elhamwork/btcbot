...
Written 28 Aug 2026 10:51pm California time by `check.py --report`.
...
| fees paid | $115.87 |
| contracts looked at | 447 |
| retired (old rule, not counted) | 10 |
| of those, settled and learned from | 446 |
...
The 63-day study is worth 30 observations per row below. So 446 live
...
| 50-55% | 0.558 | 0.529 | 98 (51 hit) | -0.029 ** |
...
Leaned YES 243 times, NO 204 times. Over 63 days of history the
