...
Written 02 Sep 2026 6:36pm California time by `check.py --report`.
...
| of those, settled and learned from | 904 |
...
The 63-day study is worth 30 observations per row below. So 904 live
