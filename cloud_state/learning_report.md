...
Written 29 Aug 2026 11:42pm California time by `check.py --report`.
...
| fees paid | $149.89 |
| contracts looked at | 544 |
| retired (old rule, not counted) | 10 |
| of those, settled and learned from | 543 |
...
The 63-day study is worth 30 observations per row below. So 543 live
...
| 55-60% | 0.605 | 0.560 | 72 (39 hit) | -0.045 ** |
...
Leaned YES 306 times, NO 238 times. Over 63 days of history the
