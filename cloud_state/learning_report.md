...
Written 30 Aug 2026 12:17am California time by `check.py --report`.
...
| fees paid | $149.89 |
| contracts looked at | 547 |
| retired (old rule, not counted) | 10 |
| of those, settled and learned from | 546 |
...
The 63-day study is worth 30 observations per row below. So 546 live
...
| 45-50% | 0.497 | 0.440 | 106 (45 hit) | -0.056 ** |
...
Leaned YES 306 times, NO 241 times. Over 63 days of history the
