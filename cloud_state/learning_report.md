...
Written 01 Sep 2026 4:17pm California time by `check.py --report`.
...
| fees paid | $206.50 |
| contracts looked at | 800 |
| retired (old rule, not counted) | 10 |
| of those, settled and learned from | 799 |
...
The 63-day study is worth 30 observations per row below. So 799 live
...
Leaned YES 442 times, NO 358 times. Over 63 days of history the
