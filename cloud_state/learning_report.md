...
Written 07 Sep 2026 7:19am California time by `check.py --report`.
...
| fees paid | $309.66 |
| contracts looked at | 1332 |
| retired (old rule, not counted) | 10 |
| of those, settled and learned from | 1331 |
...
The 63-day study is worth 30 observations per row below. So 1331 live
...
| 50-55% | 0.558 | 0.527 | 279 (146 hit) | -0.031 ** |
...
Leaned YES 710 times, NO 622 times. Over 63 days of history the
