...
Written 29 Aug 2026 2:52pm California time by `check.py --report`.
...
| fees paid | $139.26 |
| contracts looked at | 509 |
| retired (old rule, not counted) | 10 |
| of those, settled and learned from | 508 |
...
The 63-day study is worth 30 observations per row below. So 508 live
...
Leaned YES 285 times, NO 224 times. Over 63 days of history the
