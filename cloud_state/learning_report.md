...
Written 05 Sep 2026 6:27am California time by `check.py --report`.
...
| fees paid | $273.17 |
| contracts looked at | 1136 |
| retired (old rule, not counted) | 10 |
| of those, settled and learned from | 1135 |
...
The 63-day study is worth 30 observations per row below. So 1135 live
...
| 50-55% | 0.558 | 0.527 | 241 (126 hit) | -0.031 ** |
...
Leaned YES 616 times, NO 520 times. Over 63 days of history the
