...
Written 09 Sep 2026 7:06pm California time by `check.py --report`.
...
| fees paid | $354.20 |
| contracts looked at | 1571 |
| retired (old rule, not counted) | 10 |
| of those, settled and learned from | 1570 |
| actual calls (graded GOOD) | 225 |
| calls that have settled | 225 |
| alerts that reached the phone | 173 of 173 |
...
The 63-day study is worth 30 observations per row below. So 1570 live
...
Leaned YES 829 times, NO 742 times. Over 63 days of history the
