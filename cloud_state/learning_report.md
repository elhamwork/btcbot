...
Written 29 Aug 2026 1:43am California time by `check.py --report`.
...
| fees paid | $121.55 |
| contracts looked at | 458 |
| retired (old rule, not counted) | 10 |
| of those, settled and learned from | 457 |
...
The 63-day study is worth 30 observations per row below. So 457 live
...
Leaned YES 248 times, NO 210 times. Over 63 days of history the
