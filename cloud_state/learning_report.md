...
Written 04 Sep 2026 3:41pm California time by `check.py --report`.
...
| fees paid | $263.92 |
| contracts looked at | 1077 |
| retired (old rule, not counted) | 10 |
| of those, settled and learned from | 1076 |
...
The 63-day study is worth 30 observations per row below. So 1076 live
...
| 55-60% | 0.605 | 0.556 | 159 (87 hit) | -0.049 ** |
...
Leaned YES 588 times, NO 489 times. Over 63 days of history the
