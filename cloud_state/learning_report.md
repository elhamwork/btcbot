...
Written 30 Aug 2026 9:36pm California time by `check.py --report`.
...
| fees paid | $170.13 |
| contracts looked at | 632 |
| retired (old rule, not counted) | 10 |
| of those, settled and learned from | 631 |
...
The 63-day study is worth 30 observations per row below. So 631 live
...
Leaned YES 347 times, NO 285 times. Over 63 days of history the
