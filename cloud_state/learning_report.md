...
Written 28 Aug 2026 7:37am California time by `check.py --report`.
...
| fees paid | $99.20 |
| contracts looked at | 399 |
| retired (old rule, not counted) | 10 |
| of those, settled and learned from | 397 |
...
The 63-day study is worth 30 observations per row below. So 397 live
...
Leaned YES 221 times, NO 178 times. Over 63 days of history the
