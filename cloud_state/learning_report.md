...
Written 27 Aug 2026 9:16pm California time by `check.py --report`.
...
| of those, settled and learned from | 366 |
...
The 63-day study is worth 30 observations per row below. So 366 live
...
| 40-45% | 0.384 | 0.340 | 48 (15 hit) | -0.044 ** |
