...
Written 11 Sep 2026 10:40pm California time by `check.py --report`.
...
| fees paid | $403.18 |
| contracts looked at | 1769 |
| retired (old rule, not counted) | 10 |
| of those, settled and learned from | 1768 |
...
The 63-day study is worth 30 observations per row below. So 1768 live
...
| 60-65% | 0.678 | 0.597 | 138 (80 hit) | -0.081 ** |
...
Leaned YES 940 times, NO 829 times. Over 63 days of history the
