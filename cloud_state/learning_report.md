...
Written 09 Sep 2026 11:11am California time by `check.py --report`.
...
| fees paid | $348.08 |
| contracts looked at | 1539 |
| retired (old rule, not counted) | 10 |
| of those, settled and learned from | 1538 |
...
The 63-day study is worth 30 observations per row below. So 1538 live
...
| 50-55% | 0.558 | 0.520 | 323 (167 hit) | -0.037 ** |
...
Leaned YES 813 times, NO 726 times. Over 63 days of history the
