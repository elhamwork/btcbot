...
Written 28 Aug 2026 7:27pm California time by `check.py --report`.

## The short version

| | |
|---|---|
| **paper account** | **$1,228.43** (started $1,000, +22.8%) |
| best / worst it has been | $1,279.61 / $926.62 |
| fees paid | $109.76 |
| contracts looked at | 433 |
| retired (old rule, not counted) | 10 |
| of those, settled and learned from | 432 |
| actual calls (graded GOOD) | 70 |
| calls that have settled | 69 |
| alerts that reached the phone | 18 of 18 |
| calls made before delivery was recorded | 52 |
| calls right | 58 of 69 (84%) |
...
The 63-day study is worth 30 observations per row below. So 432 live
...
| 40-45% | 0.384 | 0.354 | 62 (21 hit) | -0.031 ** |
| 45-50% | 0.497 | 0.434 | 85 (35 hit) | -0.063 ** |
| 50-55% | 0.558 | 0.518 | 93 (47 hit) | -0.040 ** |
| 55-60% | 0.605 | 0.560 | 56 (30 hit) | -0.045 ** |
| 60-65% | 0.678 | 0.645 | 31 (19 hit) | -0.033 ** |
...
Leaned YES 234 times, NO 199 times. Over 63 days of history the
...
|---|---|---|---|---|---|
| 02:18 | KXBTC15M-26AUG282230-30 | NO | 0.82 | $122.84 | $25.41 |
