...
Written 02 Sep 2026 7:49pm California time by `check.py --report`.
...
| fees paid | $233.24 |
| contracts looked at | 910 |
| retired (old rule, not counted) | 10 |
| of those, settled and learned from | 909 |
...
The 63-day study is worth 30 observations per row below. So 909 live
...
| 50-55% | 0.558 | 0.534 | 196 (104 hit) | -0.023 ** |
...
Leaned YES 494 times, NO 416 times. Over 63 days of history the
