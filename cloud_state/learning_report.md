...
Written 08 Sep 2026 6:26pm California time by `check.py --report`.
...
| fees paid | $331.83 |
| contracts looked at | 1472 |
| retired (old rule, not counted) | 10 |
| of those, settled and learned from | 1471 |
...
The 63-day study is worth 30 observations per row below. So 1471 live
...
Leaned YES 780 times, NO 692 times. Over 63 days of history the
