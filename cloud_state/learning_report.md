...
Written 09 Sep 2026 5:09am California time by `check.py --report`.
...
| fees paid | $344.34 |
| contracts looked at | 1515 |
| retired (old rule, not counted) | 10 |
| of those, settled and learned from | 1514 |
| actual calls (graded GOOD) | 220 |
| calls that have settled | 220 |
| alerts that reached the phone | 168 of 168 |
...
The 63-day study is worth 30 observations per row below. So 1514 live
...
| 55-60% | 0.605 | 0.535 | 219 (115 hit) | -0.070 ** |
| 60-65% | 0.678 | 0.586 | 114 (64 hit) | -0.092 ** |
...
Leaned YES 803 times, NO 712 times. Over 63 days of history the
