...
Written 10 Sep 2026 12:25pm California time by `check.py --report`.
...
| fees paid | $382.14 |
| contracts looked at | 1632 |
| retired (old rule, not counted) | 10 |
| of those, settled and learned from | 1631 |
| actual calls (graded GOOD) | 242 |
| calls that have settled | 242 |
| alerts that reached the phone | 190 of 190 |
...
The 63-day study is worth 30 observations per row below. So 1631 live
...
| 55-60% | 0.605 | 0.531 | 232 (121 hit) | -0.074 ** |
...
Leaned YES 860 times, NO 772 times. Over 63 days of history the
