...
Written 02 Sep 2026 10:51pm California time by `check.py --report`.
...
| of those, settled and learned from | 921 |
...
The 63-day study is worth 30 observations per row below. So 921 live
