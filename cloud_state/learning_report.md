...
Written 11 Sep 2026 3:48am California time by `check.py --report`.
...
| fees paid | $388.68 |
| contracts looked at | 1694 |
| retired (old rule, not counted) | 10 |
| of those, settled and learned from | 1693 |
...
The 63-day study is worth 30 observations per row below. So 1693 live
...
| 50-55% | 0.558 | 0.516 | 361 (185 hit) | -0.042 ** |
...
Leaned YES 901 times, NO 793 times. Over 63 days of history the
