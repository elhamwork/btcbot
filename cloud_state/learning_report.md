...
Written 02 Sep 2026 7:07pm California time by `check.py --report`.
...
| fees paid | $233.24 |
| contracts looked at | 907 |
| retired (old rule, not counted) | 10 |
| of those, settled and learned from | 906 |
...
The 63-day study is worth 30 observations per row below. So 906 live
...
Leaned YES 491 times, NO 416 times. Over 63 days of history the
