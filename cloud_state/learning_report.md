...
Written 03 Sep 2026 8:30pm California time by `check.py --report`.
...
| of those, settled and learned from | 999 |
...
The 63-day study is worth 30 observations per row below. So 999 live
