...
Written 26 Aug 2026 7:38am California time by `check.py --report`.

## The short version

| | |
|---|---|
| **paper account** | **$1,120.67** (started $1,000, +12.1%) |
| best / worst it has been | $1,214.01 / $926.62 |
| fees paid | $57.60 |
| contracts looked at | 274 |
| retired (old rule, not counted) | 10 |
| of those, settled and learned from | 273 |
| actual calls (graded GOOD) | 39 |
| calls that have settled | 39 |
| calls right | 33 of 39 (85%) |
...
The 63-day study is worth 30 observations per row below. So 273 live
...
| 40-45% | 0.384 | 0.382 | 29 (11 hit) | -0.002 |
| 45-50% | 0.497 | 0.467 | 49 (22 hit) | -0.030 ** |
| 50-55% | 0.558 | 0.514 | 57 (28 hit) | -0.044 ** |
| 55-60% | 0.605 | 0.551 | 41 (21 hit) | -0.054 ** |
...
Leaned YES 161 times, NO 113 times. Over 63 days of history the
