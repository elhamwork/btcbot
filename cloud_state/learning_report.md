...
Written 30 Aug 2026 5:41am California time by `check.py --report`.
...
| fees paid | $152.00 |
| contracts looked at | 568 |
| retired (old rule, not counted) | 10 |
| of those, settled and learned from | 567 |
...
The 63-day study is worth 30 observations per row below. So 567 live
...
| 50-55% | 0.558 | 0.535 | 134 (71 hit) | -0.023 ** |
...
Leaned YES 320 times, NO 248 times. Over 63 days of history the
