...
Written 12 Sep 2026 7:30pm California time by `check.py --report`.
...
| fees paid | $411.66 |
| contracts looked at | 1852 |
| retired (old rule, not counted) | 10 |
| of those, settled and learned from | 1851 |
...
The 63-day study is worth 30 observations per row below. So 1851 live
...
| 40-45% | 0.384 | 0.401 | 231 (93 hit) | +0.016 |
...
Leaned YES 994 times, NO 858 times. Over 63 days of history the
