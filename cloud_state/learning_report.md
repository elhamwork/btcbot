...
Written 01 Sep 2026 8:20am California time by `check.py --report`.
...
| of those, settled and learned from | 767 |
...
The 63-day study is worth 30 observations per row below. So 767 live
