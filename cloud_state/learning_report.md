...
Written 10 Sep 2026 9:40pm California time by `check.py --report`.
...
| fees paid | $387.27 |
| contracts looked at | 1669 |
| retired (old rule, not counted) | 10 |
| of those, settled and learned from | 1668 |
...
The 63-day study is worth 30 observations per row below. So 1668 live
...
| 55-60% | 0.605 | 0.541 | 242 (129 hit) | -0.064 ** |
...
Leaned YES 886 times, NO 783 times. Over 63 days of history the
