...
Written 04 Sep 2026 2:05am California time by `check.py --report`.
...
| fees paid | $253.95 |
| contracts looked at | 1023 |
| retired (old rule, not counted) | 10 |
| of those, settled and learned from | 1022 |
...
The 63-day study is worth 30 observations per row below. So 1022 live
...
| 45-50% | 0.497 | 0.482 | 194 (93 hit) | -0.015 |
...
Leaned YES 557 times, NO 466 times. Over 63 days of history the
