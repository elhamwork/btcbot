...
Written 01 Sep 2026 7:20am California time by `check.py --report`.
...
| fees paid | $203.00 |
| contracts looked at | 764 |
| retired (old rule, not counted) | 10 |
| of those, settled and learned from | 763 |
...
The 63-day study is worth 30 observations per row below. So 763 live
...
Leaned YES 420 times, NO 344 times. Over 63 days of history the
