...
Written 01 Sep 2026 2:58am California time by `check.py --report`.
...
| fees paid | $195.64 |
| contracts looked at | 746 |
| retired (old rule, not counted) | 10 |
| of those, settled and learned from | 745 |
...
The 63-day study is worth 30 observations per row below. So 745 live
...
| 45-50% | 0.497 | 0.448 | 144 (63 hit) | -0.049 ** |
...
Leaned YES 409 times, NO 337 times. Over 63 days of history the
