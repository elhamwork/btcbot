...
Written 06 Sep 2026 11:18pm California time by `check.py --report`.
...
| fees paid | $306.83 |
| contracts looked at | 1300 |
| retired (old rule, not counted) | 10 |
| of those, settled and learned from | 1299 |
...
The 63-day study is worth 30 observations per row below. So 1299 live
...
| 40-45% | 0.384 | 0.399 | 167 (67 hit) | +0.014 |
| 45-50% | 0.497 | 0.480 | 253 (121 hit) | -0.017 |
| 50-55% | 0.558 | 0.532 | 272 (144 hit) | -0.025 ** |
| 55-60% | 0.605 | 0.542 | 190 (101 hit) | -0.063 ** |
...
Leaned YES 691 times, NO 609 times. Over 63 days of history the
