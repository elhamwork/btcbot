...
Written 03 Sep 2026 5:29am California time by `check.py --report`.
...
| of those, settled and learned from | 939 |
...
The 63-day study is worth 30 observations per row below. So 939 live
