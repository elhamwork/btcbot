...
Written 12 Sep 2026 9:48am California time by `check.py --report`.
...
| fees paid | $409.43 |
| contracts looked at | 1814 |
| retired (old rule, not counted) | 10 |
| of those, settled and learned from | 1813 |
...
The 63-day study is worth 30 observations per row below. So 1813 live
...
| 45-50% | 0.497 | 0.470 | 368 (172 hit) | -0.027 ** |
...
Leaned YES 968 times, NO 846 times. Over 63 days of history the
