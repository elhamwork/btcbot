...
Written 28 Aug 2026 9:36pm California time by `check.py --report`.
...
| fees paid | $115.87 |
| contracts looked at | 442 |
| retired (old rule, not counted) | 10 |
| of those, settled and learned from | 441 |
...
The 63-day study is worth 30 observations per row below. So 441 live
...
Leaned YES 239 times, NO 203 times. Over 63 days of history the
