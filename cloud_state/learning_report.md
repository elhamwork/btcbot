...
Written 12 Sep 2026 11:29am California time by `check.py --report`.
...
| fees paid | $409.43 |
| contracts looked at | 1820 |
| retired (old rule, not counted) | 10 |
| of those, settled and learned from | 1819 |
| actual calls (graded GOOD) | 257 |
| calls that have settled | 257 |
| alerts that reached the phone | 205 of 205 |
...
The 63-day study is worth 30 observations per row below. So 1819 live
...
| 35-40% | 0.354 | 0.373 | 127 (48 hit) | +0.019 |
| 40-45% | 0.384 | 0.401 | 226 (91 hit) | +0.016 |
| 45-50% | 0.497 | 0.466 | 371 (172 hit) | -0.031 ** |
| 50-55% | 0.558 | 0.516 | 384 (197 hit) | -0.041 ** |
...
Leaned YES 971 times, NO 849 times. Over 63 days of history the
