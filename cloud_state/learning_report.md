...
Written 02 Sep 2026 4:11pm California time by `check.py --report`.
...
| fees paid | $232.57 |
| contracts looked at | 895 |
| retired (old rule, not counted) | 10 |
| of those, settled and learned from | 894 |
...
The 63-day study is worth 30 observations per row below. So 894 live
...
Leaned YES 488 times, NO 407 times. Over 63 days of history the
