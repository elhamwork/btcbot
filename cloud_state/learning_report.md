...
Written 10 Sep 2026 11:09pm California time by `check.py --report`.
...
| fees paid | $387.27 |
| contracts looked at | 1675 |
| retired (old rule, not counted) | 10 |
| of those, settled and learned from | 1674 |
...
The 63-day study is worth 30 observations per row below. So 1674 live
...
| 40-45% | 0.384 | 0.403 | 212 (86 hit) | +0.019 |
...
Leaned YES 888 times, NO 787 times. Over 63 days of history the
