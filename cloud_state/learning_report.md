...
Written 12 Sep 2026 6:24pm California time by `check.py --report`.
...
| fees paid | $411.66 |
| contracts looked at | 1848 |
| retired (old rule, not counted) | 10 |
| of those, settled and learned from | 1847 |
...
The 63-day study is worth 30 observations per row below. So 1847 live
...
Leaned YES 992 times, NO 856 times. Over 63 days of history the
