...
Written 06 Sep 2026 4:08am California time by `check.py --report`.
...
| fees paid | $287.06 |
| contracts looked at | 1223 |
| retired (old rule, not counted) | 10 |
| of those, settled and learned from | 1222 |
...
The 63-day study is worth 30 observations per row below. So 1222 live
...
| 40-45% | 0.384 | 0.403 | 155 (63 hit) | +0.018 |
...
Leaned YES 654 times, NO 569 times. Over 63 days of history the
