...
Written 06 Sep 2026 11:18am California time by `check.py --report`.
...
| fees paid | $295.52 |
| contracts looked at | 1252 |
| retired (old rule, not counted) | 10 |
| of those, settled and learned from | 1251 |
...
The 63-day study is worth 30 observations per row below. So 1251 live
...
| 35-40% | 0.354 | 0.380 | 90 (35 hit) | +0.026 ** |
...
Leaned YES 667 times, NO 585 times. Over 63 days of history the
