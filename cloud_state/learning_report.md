...
Written 31 Aug 2026 2:57pm California time by `check.py --report`.
...
| fees paid | $184.04 |
| contracts looked at | 698 |
| retired (old rule, not counted) | 10 |
| of those, settled and learned from | 697 |
...
The 63-day study is worth 30 observations per row below. So 697 live
...
Leaned YES 378 times, NO 320 times. Over 63 days of history the
