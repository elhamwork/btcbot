...
Written 10 Sep 2026 6:14am California time by `check.py --report`.
...
| fees paid | $374.69 |
| contracts looked at | 1607 |
| retired (old rule, not counted) | 10 |
| of those, settled and learned from | 1606 |
...
The 63-day study is worth 30 observations per row below. So 1606 live
...
| 50-55% | 0.558 | 0.523 | 335 (174 hit) | -0.035 ** |
...
Leaned YES 849 times, NO 758 times. Over 63 days of history the
