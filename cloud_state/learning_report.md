...
Written 27 Aug 2026 2:43am California time by `check.py --report`.
...
| fees paid | $72.48 |
| contracts looked at | 321 |
| retired (old rule, not counted) | 10 |
| of those, settled and learned from | 320 |
...
The 63-day study is worth 30 observations per row below. So 320 live
...
Leaned YES 186 times, NO 135 times. Over 63 days of history the
