...
Written 30 Aug 2026 3:46pm California time by `check.py --report`.
...
| of those, settled and learned from | 607 |
...
The 63-day study is worth 30 observations per row below. So 607 live
...
| 30-35% | 0.286 | 0.273 | 16 (4 hit) | -0.012 |
