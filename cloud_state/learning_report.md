...
Written 12 Sep 2026 8:27am California time by `check.py --report`.
...
| fees paid | $409.43 |
| contracts looked at | 1808 |
| retired (old rule, not counted) | 10 |
| of those, settled and learned from | 1807 |
...
The 63-day study is worth 30 observations per row below. So 1807 live
...
| 45-50% | 0.497 | 0.471 | 365 (171 hit) | -0.026 ** |
...
Leaned YES 966 times, NO 842 times. Over 63 days of history the
