...
Written 28 Aug 2026 6:41am California time by `check.py --report`.
...
| fees paid | $98.02 |
| contracts looked at | 395 |
| retired (old rule, not counted) | 10 |
| of those, settled and learned from | 393 |
...
The 63-day study is worth 30 observations per row below. So 393 live
...
Leaned YES 218 times, NO 177 times. Over 63 days of history the
