...
Written 30 Aug 2026 1:22pm California time by `check.py --report`.
...
| of those, settled and learned from | 598 |
...
The 63-day study is worth 30 observations per row below. So 598 live
