...
Written 11 Sep 2026 2:15am California time by `check.py --report`.
...
| fees paid | $388.68 |
| contracts looked at | 1687 |
| retired (old rule, not counted) | 10 |
| of those, settled and learned from | 1686 |
...
The 63-day study is worth 30 observations per row below. So 1686 live
...
| 50-55% | 0.558 | 0.519 | 359 (185 hit) | -0.039 ** |
...
Leaned YES 897 times, NO 790 times. Over 63 days of history the
