...
Written 03 Sep 2026 2:50am California time by `check.py --report`.
...
| of those, settled and learned from | 929 |
...
The 63-day study is worth 30 observations per row below. So 929 live
