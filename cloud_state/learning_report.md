...
Written 08 Sep 2026 7:42pm California time by `check.py --report`.
...
| fees paid | $331.83 |
| contracts looked at | 1477 |
| retired (old rule, not counted) | 10 |
| of those, settled and learned from | 1476 |
| actual calls (graded GOOD) | 212 |
| calls that have settled | 212 |
| alerts that reached the phone | 160 of 160 |
...
The 63-day study is worth 30 observations per row below. So 1476 live
...
| 45-50% | 0.497 | 0.480 | 293 (140 hit) | -0.017 |
...
Leaned YES 782 times, NO 695 times. Over 63 days of history the
