...
Written 08 Sep 2026 1:17pm California time by `check.py --report`.
...
| fees paid | $326.24 |
| contracts looked at | 1452 |
| retired (old rule, not counted) | 10 |
| of those, settled and learned from | 1451 |
...
The 63-day study is worth 30 observations per row below. So 1451 live
...
Leaned YES 767 times, NO 685 times. Over 63 days of history the
