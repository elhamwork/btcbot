...
Written 03 Sep 2026 4:21pm California time by `check.py --report`.
...
| fees paid | $242.43 |
| contracts looked at | 984 |
| retired (old rule, not counted) | 10 |
| of those, settled and learned from | 983 |
...
The 63-day study is worth 30 observations per row below. So 983 live
...
| 55-60% | 0.605 | 0.551 | 141 (76 hit) | -0.054 ** |
...
Leaned YES 535 times, NO 449 times. Over 63 days of history the
