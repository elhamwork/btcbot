...
Written 28 Aug 2026 6:17pm California time by `check.py --report`.
...
| fees paid | $109.76 |
| contracts looked at | 429 |
| retired (old rule, not counted) | 10 |
| of those, settled and learned from | 428 |
...
The 63-day study is worth 30 observations per row below. So 428 live
...
| 45-50% | 0.497 | 0.433 | 83 (34 hit) | -0.064 ** |
...
Leaned YES 233 times, NO 196 times. Over 63 days of history the
