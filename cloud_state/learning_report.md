...
Written 08 Sep 2026 12:20am California time by `check.py --report`.
...
| fees paid | $317.43 |
| contracts looked at | 1400 |
| retired (old rule, not counted) | 10 |
| of those, settled and learned from | 1399 |
...
The 63-day study is worth 30 observations per row below. So 1399 live
...
| 35-40% | 0.354 | 0.384 | 102 (40 hit) | +0.029 ** |
...
Leaned YES 743 times, NO 657 times. Over 63 days of history the
