...
Written 29 Aug 2026 3:12pm California time by `check.py --report`.
...
| fees paid | $139.26 |
| contracts looked at | 510 |
| retired (old rule, not counted) | 10 |
| of those, settled and learned from | 509 |
...
The 63-day study is worth 30 observations per row below. So 509 live
...
| 50-55% | 0.558 | 0.532 | 118 (62 hit) | -0.026 ** |
...
Leaned YES 286 times, NO 224 times. Over 63 days of history the
