...
Written 07 Sep 2026 3:58pm California time by `check.py --report`.
...
| fees paid | $312.69 |
| contracts looked at | 1366 |
| retired (old rule, not counted) | 10 |
| of those, settled and learned from | 1365 |
...
The 63-day study is worth 30 observations per row below. So 1365 live
...
Leaned YES 728 times, NO 638 times. Over 63 days of history the
