...
Written 31 Aug 2026 9:30am California time by `check.py --report`.
...
| of those, settled and learned from | 676 |
...
The 63-day study is worth 30 observations per row below. So 676 live
...
| 35-40% | 0.354 | 0.384 | 42 (17 hit) | +0.030 ** |
