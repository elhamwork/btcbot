...
Written 07 Sep 2026 2:04am California time by `check.py --report`.
...
| fees paid | $306.83 |
| contracts looked at | 1311 |
| retired (old rule, not counted) | 10 |
| of those, settled and learned from | 1310 |
...
The 63-day study is worth 30 observations per row below. So 1310 live
...
| 45-50% | 0.497 | 0.477 | 255 (121 hit) | -0.020 |
...
Leaned YES 697 times, NO 614 times. Over 63 days of history the
