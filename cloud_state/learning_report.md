...
Written 30 Aug 2026 8:31pm California time by `check.py --report`.
...
| fees paid | $169.27 |
| contracts looked at | 628 |
| retired (old rule, not counted) | 10 |
| of those, settled and learned from | 626 |
...
The 63-day study is worth 30 observations per row below. So 626 live
...
Leaned YES 345 times, NO 283 times. Over 63 days of history the
