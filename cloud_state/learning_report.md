...
Written 12 Sep 2026 5:55am California time by `check.py --report`.
...
| fees paid | $407.55 |
| contracts looked at | 1798 |
| retired (old rule, not counted) | 10 |
| of those, settled and learned from | 1797 |
...
The 63-day study is worth 30 observations per row below. So 1797 live
...
| 45-50% | 0.497 | 0.472 | 360 (169 hit) | -0.025 ** |
...
Leaned YES 962 times, NO 836 times. Over 63 days of history the
