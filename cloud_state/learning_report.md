...
Written 12 Sep 2026 8:47am California time by `check.py --report`.
...
| fees paid | $409.43 |
| contracts looked at | 1810 |
| retired (old rule, not counted) | 10 |
| of those, settled and learned from | 1809 |
...
The 63-day study is worth 30 observations per row below. So 1809 live
...
Leaned YES 966 times, NO 844 times. Over 63 days of history the
