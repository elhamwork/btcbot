...
Written 30 Aug 2026 12:49pm California time by `check.py --report`.
...
| fees paid | $159.79 |
| contracts looked at | 597 |
| retired (old rule, not counted) | 10 |
| of those, settled and learned from | 596 |
...
The 63-day study is worth 30 observations per row below. So 596 live
...
Leaned YES 334 times, NO 263 times. Over 63 days of history the
