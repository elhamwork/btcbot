...
Written 29 Aug 2026 6:42am California time by `check.py --report`.
...
| fees paid | $123.26 |
| contracts looked at | 476 |
| retired (old rule, not counted) | 10 |
| of those, settled and learned from | 475 |
...
The 63-day study is worth 30 observations per row below. So 475 live
...
| 60-65% | 0.678 | 0.667 | 35 (23 hit) | -0.011 |
...
Leaned YES 262 times, NO 214 times. Over 63 days of history the
