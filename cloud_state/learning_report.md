...
Written 01 Sep 2026 3:43am California time by `check.py --report`.
...
| fees paid | $197.59 |
| contracts looked at | 749 |
| retired (old rule, not counted) | 10 |
| of those, settled and learned from | 748 |
...
The 63-day study is worth 30 observations per row below. So 748 live
...
Leaned YES 412 times, NO 337 times. Over 63 days of history the
