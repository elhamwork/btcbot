...
Written 10 Sep 2026 10:13am California time by `check.py --report`.
...
| fees paid | $380.84 |
| contracts looked at | 1623 |
| retired (old rule, not counted) | 10 |
| of those, settled and learned from | 1622 |
| actual calls (graded GOOD) | 241 |
| calls that have settled | 241 |
| alerts that reached the phone | 189 of 189 |
...
The 63-day study is worth 30 observations per row below. So 1622 live
...
| 40-45% | 0.384 | 0.394 | 205 (81 hit) | +0.009 |
...
Leaned YES 856 times, NO 767 times. Over 63 days of history the
