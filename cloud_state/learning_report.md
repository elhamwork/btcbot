...
Written 29 Aug 2026 8:24pm California time by `check.py --report`.
...
| fees paid | $146.82 |
| contracts looked at | 531 |
| retired (old rule, not counted) | 10 |
| of those, settled and learned from | 530 |
...
The 63-day study is worth 30 observations per row below. So 530 live
...
| 50-55% | 0.558 | 0.537 | 124 (66 hit) | -0.020 ** |
...
Leaned YES 299 times, NO 232 times. Over 63 days of history the
