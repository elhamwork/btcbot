...
Written 02 Sep 2026 5:48pm California time by `check.py --report`.
...
| fees paid | $233.24 |
| contracts looked at | 902 |
| retired (old rule, not counted) | 10 |
| of those, settled and learned from | 901 |
...
The 63-day study is worth 30 observations per row below. So 901 live
...
Leaned YES 490 times, NO 412 times. Over 63 days of history the
