...
Written 04 Sep 2026 6:27pm California time by `check.py --report`.
...
| fees paid | $267.08 |
| contracts looked at | 1088 |
| retired (old rule, not counted) | 10 |
| of those, settled and learned from | 1087 |
...
The 63-day study is worth 30 observations per row below. So 1087 live
...
| 40-45% | 0.384 | 0.393 | 134 (53 hit) | +0.009 |
...
Leaned YES 591 times, NO 497 times. Over 63 days of history the
