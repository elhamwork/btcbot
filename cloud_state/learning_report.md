...
Written 27 Aug 2026 3:21am California time by `check.py --report`.
...
| fees paid | $72.48 |
| contracts looked at | 324 |
| retired (old rule, not counted) | 10 |
| of those, settled and learned from | 323 |
...
The 63-day study is worth 30 observations per row below. So 323 live
...
| 40-45% | 0.384 | 0.366 | 37 (13 hit) | -0.018 |
| 45-50% | 0.497 | 0.465 | 58 (26 hit) | -0.032 ** |
...
Leaned YES 186 times, NO 138 times. Over 63 days of history the
