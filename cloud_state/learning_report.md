...
Written 28 Aug 2026 10:36pm California time by `check.py --report`.
...
| fees paid | $115.87 |
| contracts looked at | 446 |
| retired (old rule, not counted) | 10 |
| of those, settled and learned from | 445 |
...
The 63-day study is worth 30 observations per row below. So 445 live
...
| 50-55% | 0.558 | 0.525 | 97 (50 hit) | -0.032 ** |
...
Leaned YES 242 times, NO 204 times. Over 63 days of history the
