...
Written 12 Sep 2026 9:12am California time by `check.py --report`.
...
| fees paid | $409.43 |
| contracts looked at | 1811 |
| retired (old rule, not counted) | 10 |
| of those, settled and learned from | 1810 |
...
The 63-day study is worth 30 observations per row below. So 1810 live
...
| 45-50% | 0.497 | 0.471 | 367 (172 hit) | -0.026 ** |
| 50-55% | 0.558 | 0.516 | 382 (196 hit) | -0.041 ** |
| 55-60% | 0.605 | 0.539 | 269 (143 hit) | -0.066 ** |
...
Leaned YES 966 times, NO 845 times. Over 63 days of history the
