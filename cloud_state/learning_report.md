...
Written 04 Sep 2026 11:55pm California time by `check.py --report`.
...
| fees paid | $269.11 |
| contracts looked at | 1110 |
| retired (old rule, not counted) | 10 |
| of those, settled and learned from | 1109 |
...
The 63-day study is worth 30 observations per row below. So 1109 live
...
| 45-50% | 0.497 | 0.487 | 214 (104 hit) | -0.009 |
| 50-55% | 0.558 | 0.531 | 235 (124 hit) | -0.027 ** |
| 55-60% | 0.605 | 0.549 | 167 (90 hit) | -0.056 ** |
...
Leaned YES 603 times, NO 507 times. Over 63 days of history the
