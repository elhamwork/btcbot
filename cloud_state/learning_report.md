...
Written 31 Aug 2026 8:20am California time by `check.py --report`.
...
| of those, settled and learned from | 672 |
...
The 63-day study is worth 30 observations per row below. So 672 live
