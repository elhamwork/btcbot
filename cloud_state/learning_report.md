...
Written 25 Aug 2026 10:26am California time by `check.py --report`.

## The short version

| | |
|---|---|
| **paper account** | **$1,079.21** (started $1,000, +7.9%) |
...
| 40-45% | 0.384 | 0.363 | 21 (7 hit) | -0.021 ** |
...
Leaned YES 110 times, NO 79 times. Over 63 days of history the
