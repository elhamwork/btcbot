...
Written 01 Sep 2026 3:31pm California time by `check.py --report`.
...
| fees paid | $204.90 |
| contracts looked at | 797 |
| retired (old rule, not counted) | 10 |
| of those, settled and learned from | 795 |
...
The 63-day study is worth 30 observations per row below. So 795 live
...
| 45-50% | 0.497 | 0.453 | 151 (67 hit) | -0.044 ** |
...
Leaned YES 440 times, NO 357 times. Over 63 days of history the
