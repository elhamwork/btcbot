...
Written 03 Sep 2026 1:31pm California time by `check.py --report`.
...
| fees paid | $240.99 |
| contracts looked at | 973 |
| retired (old rule, not counted) | 10 |
| of those, settled and learned from | 971 |
...
The 63-day study is worth 30 observations per row below. So 971 live
...
Leaned YES 529 times, NO 444 times. Over 63 days of history the
