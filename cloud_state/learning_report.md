...
Written 11 Sep 2026 2:20am California time by `check.py --report`.
...
| fees paid | $388.68 |
| contracts looked at | 1688 |
| retired (old rule, not counted) | 10 |
| of those, settled and learned from | 1687 |
| actual calls (graded GOOD) | 246 |
| calls that have settled | 246 |
| alerts that reached the phone | 194 of 194 |
...
The 63-day study is worth 30 observations per row below. So 1687 live
...
| 40-45% | 0.384 | 0.405 | 213 (87 hit) | +0.021 ** |
| 45-50% | 0.497 | 0.478 | 336 (160 hit) | -0.019 |
| 50-55% | 0.558 | 0.517 | 360 (185 hit) | -0.040 ** |
| 55-60% | 0.605 | 0.539 | 245 (130 hit) | -0.066 ** |
| 60-65% | 0.678 | 0.591 | 128 (73 hit) | -0.087 ** |
| 65-70% | 0.738 | 0.674 | 83 (54 hit) | -0.064 ** |
...
Leaned YES 897 times, NO 791 times. Over 63 days of history the
