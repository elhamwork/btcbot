...
Written 09 Sep 2026 2:28pm California time by `check.py --report`.
...
| fees paid | $348.08 |
| contracts looked at | 1552 |
| retired (old rule, not counted) | 10 |
| of those, settled and learned from | 1551 |
...
The 63-day study is worth 30 observations per row below. So 1551 live
...
Leaned YES 821 times, NO 731 times. Over 63 days of history the
