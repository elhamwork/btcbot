...
Written 12 Sep 2026 12:56am California time by `check.py --report`.
...
| fees paid | $407.55 |
| contracts looked at | 1778 |
| retired (old rule, not counted) | 10 |
| of those, settled and learned from | 1777 |
...
The 63-day study is worth 30 observations per row below. So 1777 live
...
| 45-50% | 0.497 | 0.470 | 357 (167 hit) | -0.027 ** |
| 50-55% | 0.558 | 0.519 | 374 (193 hit) | -0.039 ** |
| 55-60% | 0.605 | 0.537 | 261 (138 hit) | -0.068 ** |
...
Leaned YES 946 times, NO 832 times. Over 63 days of history the
