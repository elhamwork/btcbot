...
Written 30 Aug 2026 6:31pm California time by `check.py --report`.
...
| fees paid | $169.27 |
| contracts looked at | 620 |
| retired (old rule, not counted) | 10 |
| of those, settled and learned from | 618 |
...
The 63-day study is worth 30 observations per row below. So 618 live
...
| 45-50% | 0.497 | 0.430 | 121 (50 hit) | -0.067 ** |
| 50-55% | 0.558 | 0.539 | 142 (76 hit) | -0.019 |
...
Leaned YES 343 times, NO 277 times. Over 63 days of history the
