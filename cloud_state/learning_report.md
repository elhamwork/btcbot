...
Written 01 Sep 2026 2:38am California time by `check.py --report`.
...
| fees paid | $195.64 |
| contracts looked at | 745 |
| retired (old rule, not counted) | 10 |
| of those, settled and learned from | 744 |
...
The 63-day study is worth 30 observations per row below. So 744 live
...
Leaned YES 409 times, NO 336 times. Over 63 days of history the
