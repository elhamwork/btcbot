...
Written 02 Sep 2026 6:55am California time by `check.py --report`.
...
| fees paid | $225.96 |
| contracts looked at | 858 |
| retired (old rule, not counted) | 10 |
| of those, settled and learned from | 857 |
...
The 63-day study is worth 30 observations per row below. So 857 live
...
| 45-50% | 0.497 | 0.461 | 165 (75 hit) | -0.036 ** |
| 50-55% | 0.558 | 0.531 | 186 (98 hit) | -0.027 ** |
| 55-60% | 0.605 | 0.540 | 122 (64 hit) | -0.065 ** |
...
Leaned YES 471 times, NO 387 times. Over 63 days of history the
