...
Written 25 Aug 2026 1:21pm California time by `check.py --report`.

## The short version

| | |
|---|---|
| **paper account** | **$1,103.08** (started $1,000, +10.3%) |
| best / worst it has been | $1,141.86 / $926.64 |
| fees paid | $38.96 |
| contracts looked at | 201 |
| retired (old rule, not counted) | 10 |
| of those, settled and learned from | 200 |
| actual calls (graded GOOD) | 28 |
| calls that have settled | 28 |
| calls right | 24 of 28 (86%) |
...
The 63-day study is worth 30 observations per row below. So 200 live
...
| 35-40% | 0.354 | 0.332 | 20 (6 hit) | -0.022 ** |
| 40-45% | 0.384 | 0.369 | 23 (8 hit) | -0.016 |
| 45-50% | 0.497 | 0.466 | 32 (14 hit) | -0.031 ** |
| 50-55% | 0.558 | 0.546 | 41 (22 hit) | -0.012 |
| 55-60% | 0.605 | 0.603 | 25 (15 hit) | -0.002 |
| 60-65% | 0.678 | 0.674 | 15 (10 hit) | -0.004 |
| 65-70% | 0.738 | 0.708 | 14 (9 hit) | -0.030 ** |
...
Leaned YES 119 times, NO 82 times. Over 63 days of history the
