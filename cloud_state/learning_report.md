...
Written 01 Sep 2026 12:27am California time by `check.py --report`.
...
| fees paid | $193.54 |
| contracts looked at | 736 |
| retired (old rule, not counted) | 10 |
| of those, settled and learned from | 735 |
...
The 63-day study is worth 30 observations per row below. So 735 live
...
| 55-60% | 0.605 | 0.536 | 99 (51 hit) | -0.069 ** |
...
Leaned YES 402 times, NO 334 times. Over 63 days of history the
