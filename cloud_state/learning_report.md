...
Written 29 Aug 2026 5:58pm California time by `check.py --report`.
...
| of those, settled and learned from | 520 |
...
The 63-day study is worth 30 observations per row below. So 520 live
...
| 45-50% | 0.497 | 0.448 | 97 (42 hit) | -0.049 ** |
