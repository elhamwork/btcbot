...
Written 12 Sep 2026 12:25am California time by `check.py --report`.
...
| fees paid | $407.55 |
| contracts looked at | 1776 |
| retired (old rule, not counted) | 10 |
| of those, settled and learned from | 1775 |
...
The 63-day study is worth 30 observations per row below. So 1775 live
...
| 55-60% | 0.605 | 0.538 | 260 (138 hit) | -0.067 ** |
...
Leaned YES 946 times, NO 830 times. Over 63 days of history the
