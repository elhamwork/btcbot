...
Written 09 Sep 2026 5:47pm California time by `check.py --report`.
...
| fees paid | $352.21 |
| contracts looked at | 1566 |
| retired (old rule, not counted) | 10 |
| of those, settled and learned from | 1565 |
...
The 63-day study is worth 30 observations per row below. So 1565 live
...
Leaned YES 828 times, NO 738 times. Over 63 days of history the
