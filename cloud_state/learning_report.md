...
Written 30 Aug 2026 8:36pm California time by `check.py --report`.
...
| of those, settled and learned from | 627 |
...
The 63-day study is worth 30 observations per row below. So 627 live
...
| 45-50% | 0.497 | 0.441 | 124 (53 hit) | -0.056 ** |
