...
Written 30 Aug 2026 9:21pm California time by `check.py --report`.
...
| of those, settled and learned from | 630 |
...
The 63-day study is worth 30 observations per row below. So 630 live
