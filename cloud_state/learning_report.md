...
Written 06 Sep 2026 6:01pm California time by `check.py --report`.
...
| of those, settled and learned from | 1277 |
...
The 63-day study is worth 30 observations per row below. So 1277 live
...
| 55-60% | 0.605 | 0.547 | 188 (101 hit) | -0.058 ** |
