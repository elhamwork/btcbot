...
Written 04 Sep 2026 8:33am California time by `check.py --report`.
...
| fees paid | $257.18 |
| contracts looked at | 1049 |
| retired (old rule, not counted) | 10 |
| of those, settled and learned from | 1048 |
...
The 63-day study is worth 30 observations per row below. So 1048 live
...
| 55-60% | 0.605 | 0.548 | 151 (81 hit) | -0.057 ** |
...
Leaned YES 571 times, NO 478 times. Over 63 days of history the
