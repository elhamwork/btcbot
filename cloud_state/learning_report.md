...
Written 31 Aug 2026 11:11pm California time by `check.py --report`.
...
| fees paid | $192.40 |
| contracts looked at | 731 |
| retired (old rule, not counted) | 10 |
| of those, settled and learned from | 730 |
...
The 63-day study is worth 30 observations per row below. So 730 live
...
Leaned YES 400 times, NO 331 times. Over 63 days of history the
