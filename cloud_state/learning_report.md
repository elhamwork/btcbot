...
Written 10 Sep 2026 3:52pm California time by `check.py --report`.
...
| fees paid | $385.61 |
| contracts looked at | 1646 |
| retired (old rule, not counted) | 10 |
| of those, settled and learned from | 1645 |
...
The 63-day study is worth 30 observations per row below. So 1645 live
...
Leaned YES 869 times, NO 777 times. Over 63 days of history the
