...
Written 05 Sep 2026 5:24am California time by `check.py --report`.
...
| fees paid | $273.17 |
| contracts looked at | 1132 |
| retired (old rule, not counted) | 10 |
| of those, settled and learned from | 1131 |
...
The 63-day study is worth 30 observations per row below. So 1131 live
...
| 55-60% | 0.605 | 0.548 | 171 (92 hit) | -0.057 ** |
...
Leaned YES 614 times, NO 518 times. Over 63 days of history the
