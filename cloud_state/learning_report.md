...
Written 12 Sep 2026 5:54pm California time by `check.py --report`.
...
| fees paid | $411.66 |
| contracts looked at | 1846 |
| retired (old rule, not counted) | 10 |
| of those, settled and learned from | 1845 |
...
The 63-day study is worth 30 observations per row below. So 1845 live
...
Leaned YES 990 times, NO 856 times. Over 63 days of history the
