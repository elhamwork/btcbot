...
Written 04 Sep 2026 10:04am California time by `check.py --report`.
...
| fees paid | $257.18 |
| contracts looked at | 1055 |
| retired (old rule, not counted) | 10 |
| of those, settled and learned from | 1054 |
...
The 63-day study is worth 30 observations per row below. So 1054 live
...
| 40-45% | 0.384 | 0.401 | 131 (53 hit) | +0.016 |
...
Leaned YES 574 times, NO 481 times. Over 63 days of history the
