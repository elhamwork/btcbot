...
Written 04 Sep 2026 10:32pm California time by `check.py --report`.
...
| fees paid | $269.11 |
| contracts looked at | 1105 |
| retired (old rule, not counted) | 10 |
| of those, settled and learned from | 1104 |
...
The 63-day study is worth 30 observations per row below. So 1104 live
...
Leaned YES 601 times, NO 504 times. Over 63 days of history the
