...
Written 06 Sep 2026 4:17pm California time by `check.py --report`.
...
| fees paid | $304.72 |
| contracts looked at | 1272 |
| retired (old rule, not counted) | 10 |
| of those, settled and learned from | 1271 |
...
The 63-day study is worth 30 observations per row below. So 1271 live
...
| 40-45% | 0.384 | 0.401 | 161 (65 hit) | +0.016 |
...
Leaned YES 677 times, NO 595 times. Over 63 days of history the
