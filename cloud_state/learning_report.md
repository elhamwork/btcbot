...
Written 08 Sep 2026 9:00am California time by `check.py --report`.
...
| fees paid | $324.53 |
| contracts looked at | 1434 |
| retired (old rule, not counted) | 10 |
| of those, settled and learned from | 1433 |
...
The 63-day study is worth 30 observations per row below. So 1433 live
...
Leaned YES 758 times, NO 676 times. Over 63 days of history the
