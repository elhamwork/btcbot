...
Written 03 Sep 2026 3:26pm California time by `check.py --report`.
...
| of those, settled and learned from | 979 |
...
The 63-day study is worth 30 observations per row below. So 979 live
