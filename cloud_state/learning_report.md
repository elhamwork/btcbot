...
Written 04 Sep 2026 6:32pm California time by `check.py --report`.
...
| fees paid | $267.08 |
| contracts looked at | 1089 |
| retired (old rule, not counted) | 10 |
| of those, settled and learned from | 1088 |
...
The 63-day study is worth 30 observations per row below. So 1088 live
...
Leaned YES 592 times, NO 497 times. Over 63 days of history the
