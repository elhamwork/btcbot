...
Written 10 Sep 2026 2:21pm California time by `check.py --report`.
...
| fees paid | $385.61 |
| contracts looked at | 1640 |
| retired (old rule, not counted) | 10 |
| of those, settled and learned from | 1639 |
...
The 63-day study is worth 30 observations per row below. So 1639 live
...
Leaned YES 865 times, NO 775 times. Over 63 days of history the
