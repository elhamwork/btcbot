...
Written 08 Sep 2026 12:49pm California time by `check.py --report`.
...
| fees paid | $326.24 |
| contracts looked at | 1450 |
| retired (old rule, not counted) | 10 |
| of those, settled and learned from | 1449 |
...
The 63-day study is worth 30 observations per row below. So 1449 live
...
| 45-50% | 0.497 | 0.482 | 287 (138 hit) | -0.014 |
...
Leaned YES 766 times, NO 684 times. Over 63 days of history the
