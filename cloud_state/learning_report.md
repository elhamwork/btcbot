...
Written 30 Aug 2026 10:01pm California time by `check.py --report`.
...
| of those, settled and learned from | 632 |
...
The 63-day study is worth 30 observations per row below. So 632 live
