...
Written 05 Sep 2026 1:44pm California time by `check.py --report`.
...
| fees paid | $278.41 |
| contracts looked at | 1165 |
| retired (old rule, not counted) | 10 |
| of those, settled and learned from | 1164 |
...
The 63-day study is worth 30 observations per row below. So 1164 live
...
Leaned YES 630 times, NO 535 times. Over 63 days of history the
