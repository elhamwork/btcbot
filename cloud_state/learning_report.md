...
Written 12 Sep 2026 3:52pm California time by `check.py --report`.
...
| fees paid | $411.66 |
| contracts looked at | 1838 |
| retired (old rule, not counted) | 10 |
| of those, settled and learned from | 1837 |
...
The 63-day study is worth 30 observations per row below. So 1837 live
...
Leaned YES 984 times, NO 854 times. Over 63 days of history the
