...
Written 04 Sep 2026 3:49am California time by `check.py --report`.
...
| fees paid | $253.95 |
| contracts looked at | 1030 |
| retired (old rule, not counted) | 10 |
| of those, settled and learned from | 1029 |
...
The 63-day study is worth 30 observations per row below. So 1029 live
...
| 45-50% | 0.497 | 0.482 | 196 (94 hit) | -0.015 |
...
Leaned YES 561 times, NO 469 times. Over 63 days of history the
