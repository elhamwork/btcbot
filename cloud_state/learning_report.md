...
Written 01 Sep 2026 4:44am California time by `check.py --report`.
...
| fees paid | $197.59 |
| contracts looked at | 753 |
| retired (old rule, not counted) | 10 |
| of those, settled and learned from | 752 |
...
The 63-day study is worth 30 observations per row below. So 752 live
...
| 55-60% | 0.605 | 0.531 | 104 (53 hit) | -0.074 ** |
...
Leaned YES 414 times, NO 339 times. Over 63 days of history the
