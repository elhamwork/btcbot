...
Written 28 Aug 2026 2:27pm California time by `check.py --report`.
...
| fees paid | $102.82 |
| contracts looked at | 413 |
| retired (old rule, not counted) | 10 |
| of those, settled and learned from | 411 |
...
The 63-day study is worth 30 observations per row below. So 411 live
...
Leaned YES 229 times, NO 184 times. Over 63 days of history the
