...
Written 01 Sep 2026 2:20pm California time by `check.py --report`.
...
| GOOD | 117 |
| BAD (cheap side) | 97 |
| WEAK (small disagreement) | 49 |
| BAD (last 5 min) | 11 |
| WEAK (5-10 min) | 5 |
| ALMOST (not confirmed yet) | 5 |

Leaned YES 440 times, NO 352 times. Over 63 days of history the
