...
Written 09 Sep 2026 6:20am California time by `check.py --report`.
...
| fees paid | $346.03 |
| contracts looked at | 1520 |
| retired (old rule, not counted) | 10 |
| of those, settled and learned from | 1519 |
...
The 63-day study is worth 30 observations per row below. So 1519 live
...
| 35-40% | 0.354 | 0.381 | 108 (42 hit) | +0.027 ** |
...
Leaned YES 806 times, NO 714 times. Over 63 days of history the
