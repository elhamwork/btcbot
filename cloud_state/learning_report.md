...
Written 04 Sep 2026 11:15am California time by `check.py --report`.
...
| fees paid | $258.84 |
| contracts looked at | 1059 |
| retired (old rule, not counted) | 10 |
| of those, settled and learned from | 1058 |
| actual calls (graded GOOD) | 167 |
| calls that have settled | 167 |
| alerts that reached the phone | 115 of 115 |
...
The 63-day study is worth 30 observations per row below. So 1058 live
...
| 55-60% | 0.605 | 0.547 | 153 (82 hit) | -0.058 ** |
| 60-65% | 0.678 | 0.578 | 83 (45 hit) | -0.100 ** |
| 65-70% | 0.738 | 0.664 | 56 (35 hit) | -0.073 ** |
...
Leaned YES 576 times, NO 483 times. Over 63 days of history the
