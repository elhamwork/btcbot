...
Written 04 Sep 2026 9:39am California time by `check.py --report`.
...
| fees paid | $257.18 |
| contracts looked at | 1053 |
| retired (old rule, not counted) | 10 |
| of those, settled and learned from | 1052 |
...
The 63-day study is worth 30 observations per row below. So 1052 live
...
| 50-55% | 0.558 | 0.533 | 223 (118 hit) | -0.025 ** |
...
Leaned YES 574 times, NO 479 times. Over 63 days of history the
