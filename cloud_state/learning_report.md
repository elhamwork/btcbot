...
Written 02 Sep 2026 8:25am California time by `check.py --report`.
...
| fees paid | $227.27 |
| contracts looked at | 864 |
| retired (old rule, not counted) | 10 |
| of those, settled and learned from | 863 |
...
The 63-day study is worth 30 observations per row below. So 863 live
...
| 55-60% | 0.605 | 0.537 | 123 (64 hit) | -0.068 ** |
...
Leaned YES 472 times, NO 392 times. Over 63 days of history the
