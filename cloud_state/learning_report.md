...
Written 12 Sep 2026 11:00pm California time by `check.py --report`.
...
| fees paid | $411.66 |
| contracts looked at | 1867 |
| retired (old rule, not counted) | 10 |
| of those, settled and learned from | 1865 |
...
The 63-day study is worth 30 observations per row below. So 1865 live
...
| 50-55% | 0.558 | 0.516 | 394 (202 hit) | -0.042 ** |
| 55-60% | 0.605 | 0.542 | 282 (151 hit) | -0.063 ** |
| 60-65% | 0.678 | 0.595 | 147 (85 hit) | -0.083 ** |
...
Leaned YES 1002 times, NO 865 times. Over 63 days of history the
