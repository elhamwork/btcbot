...
Written 30 Aug 2026 10:22pm California time by `check.py --report`.
...
| fees paid | $170.13 |
| contracts looked at | 635 |
| retired (old rule, not counted) | 10 |
| of those, settled and learned from | 634 |
...
The 63-day study is worth 30 observations per row below. So 634 live
...
| 50-55% | 0.558 | 0.536 | 145 (77 hit) | -0.022 ** |
...
Leaned YES 349 times, NO 286 times. Over 63 days of history the
