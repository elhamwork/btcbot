...
Written 01 Sep 2026 5:39am California time by `check.py --report`.

## The short version

| | |
|---|---|
| **paper account** | **$856.25** (started $1,000, -14.4%) |
| best / worst it has been | $1,511.25 / $831.40 |
| fees paid | $198.99 |
| contracts looked at | 757 |
| retired (old rule, not counted) | 10 |
| of those, settled and learned from | 756 |
| actual calls (graded GOOD) | 121 |
| calls that have settled | 120 |
| alerts that reached the phone | 69 of 69 |
| calls made before delivery was recorded | 52 |
| calls right | 97 of 120 (81%) |
...
The 63-day study is worth 30 observations per row below. So 756 live
...
| 20-25% | 0.178 | 0.162 | 3 (0 hit) | -0.016 |
| 25-30% | 0.238 | 0.264 | 16 (5 hit) | +0.026 ** |
| 30-35% | 0.286 | 0.296 | 26 (8 hit) | +0.010 |
| 35-40% | 0.354 | 0.363 | 46 (17 hit) | +0.009 |
| 40-45% | 0.384 | 0.364 | 98 (35 hit) | -0.021 ** |
| 45-50% | 0.497 | 0.443 | 146 (63 hit) | -0.054 ** |
| 50-55% | 0.558 | 0.545 | 166 (90 hit) | -0.013 |
| 55-60% | 0.605 | 0.527 | 105 (53 hit) | -0.078 ** |
| 60-65% | 0.678 | 0.652 | 58 (37 hit) | -0.026 ** |
| 65-70% | 0.738 | 0.669 | 42 (26 hit) | -0.069 ** |
| 70-75% | 0.814 | 0.809 | 15 (12 hit) | -0.005 |
...
| grade | times |
|---|---|
| NONE (no disagreement) | 338 |
| WEAK (50-70c) | 146 |
| GOOD | 113 |
| BAD (cheap side) | 92 |
| WEAK (small disagreement) | 47 |
| BAD (last 5 min) | 11 |
| WEAK (5-10 min) | 5 |
| ALMOST (not confirmed yet) | 5 |

Leaned YES 416 times, NO 341 times. Over 63 days of history the
...
|---|---|---|---|---|---|
| 12:33 | KXBTC15M-26SEP010845-45 | NO | 0.74 | $85.63 | $28.53 |
