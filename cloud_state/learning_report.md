...
Written 07 Sep 2026 4:16am California time by `check.py --report`.
...
| fees paid | $308.56 |
| contracts looked at | 1320 |
| retired (old rule, not counted) | 10 |
| of those, settled and learned from | 1318 |
...
The 63-day study is worth 30 observations per row below. So 1318 live
...
| 50-55% | 0.558 | 0.527 | 277 (145 hit) | -0.031 ** |
| 55-60% | 0.605 | 0.543 | 195 (104 hit) | -0.062 ** |
...
Leaned YES 703 times, NO 617 times. Over 63 days of history the
