...
Written 12 Sep 2026 1:47am California time by `check.py --report`.
...
| fees paid | $407.55 |
| contracts looked at | 1782 |
| retired (old rule, not counted) | 10 |
| of those, settled and learned from | 1781 |
...
The 63-day study is worth 30 observations per row below. So 1781 live
...
| 50-55% | 0.558 | 0.522 | 376 (195 hit) | -0.036 ** |
...
Leaned YES 950 times, NO 832 times. Over 63 days of history the
