...
Written 28 Aug 2026 5:11pm California time by `check.py --report`.
...
| of those, settled and learned from | 423 |
...
The 63-day study is worth 30 observations per row below. So 423 live
...
| 40-45% | 0.384 | 0.366 | 59 (21 hit) | -0.019 |
