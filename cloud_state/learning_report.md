...
Written 11 Sep 2026 9:09am California time by `check.py --report`.
...
| fees paid | $391.76 |
| contracts looked at | 1715 |
| retired (old rule, not counted) | 10 |
| of those, settled and learned from | 1714 |
...
The 63-day study is worth 30 observations per row below. So 1714 live
...
| 40-45% | 0.384 | 0.401 | 216 (87 hit) | +0.016 |
...
Leaned YES 911 times, NO 804 times. Over 63 days of history the
