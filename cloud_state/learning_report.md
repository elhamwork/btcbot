...
Written 05 Sep 2026 10:07pm California time by `check.py --report`.
...
| fees paid | $284.46 |
| contracts looked at | 1199 |
| retired (old rule, not counted) | 10 |
| of those, settled and learned from | 1198 |
...
The 63-day study is worth 30 observations per row below. So 1198 live
...
| 55-60% | 0.605 | 0.551 | 179 (97 hit) | -0.054 ** |
...
Leaned YES 646 times, NO 553 times. Over 63 days of history the
