...
Written 02 Sep 2026 12:02pm California time by `check.py --report`.
...
| fees paid | $230.35 |
| contracts looked at | 879 |
| retired (old rule, not counted) | 10 |
| of those, settled and learned from | 878 |
...
The 63-day study is worth 30 observations per row below. So 878 live
...
| 50-55% | 0.558 | 0.526 | 190 (99 hit) | -0.032 ** |
...
Leaned YES 483 times, NO 396 times. Over 63 days of history the
