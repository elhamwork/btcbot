...
Written 10 Sep 2026 6:24am California time by `check.py --report`.
...
| fees paid | $374.69 |
| contracts looked at | 1608 |
| retired (old rule, not counted) | 10 |
| of those, settled and learned from | 1607 |
...
The 63-day study is worth 30 observations per row below. So 1607 live
...
| 50-55% | 0.558 | 0.521 | 336 (174 hit) | -0.037 ** |
...
Leaned YES 850 times, NO 758 times. Over 63 days of history the
