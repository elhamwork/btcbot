...
Written 05 Sep 2026 7:51pm California time by `check.py --report`.
...
| fees paid | $282.57 |
| contracts looked at | 1190 |
| retired (old rule, not counted) | 10 |
| of those, settled and learned from | 1189 |
...
The 63-day study is worth 30 observations per row below. So 1189 live
...
Leaned YES 639 times, NO 551 times. Over 63 days of history the
