...
Written 04 Sep 2026 4:55am California time by `check.py --report`.
...
| fees paid | $255.51 |
| contracts looked at | 1034 |
| retired (old rule, not counted) | 10 |
| of those, settled and learned from | 1033 |
| actual calls (graded GOOD) | 165 |
| calls that have settled | 165 |
| alerts that reached the phone | 113 of 113 |
...
The 63-day study is worth 30 observations per row below. So 1033 live
...
| 35-40% | 0.354 | 0.373 | 71 (27 hit) | +0.018 |
| 40-45% | 0.384 | 0.389 | 128 (50 hit) | +0.005 |
| 45-50% | 0.497 | 0.484 | 197 (95 hit) | -0.013 |
| 50-55% | 0.558 | 0.537 | 217 (116 hit) | -0.020 ** |
| 55-60% | 0.605 | 0.543 | 149 (79 hit) | -0.062 ** |
| 60-65% | 0.678 | 0.580 | 81 (44 hit) | -0.098 ** |
...
Leaned YES 563 times, NO 471 times. Over 63 days of history the
