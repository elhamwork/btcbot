...
Written 07 Sep 2026 4:18pm California time by `check.py --report`.
...
| fees paid | $312.69 |
| contracts looked at | 1368 |
| retired (old rule, not counted) | 10 |
| of those, settled and learned from | 1367 |
...
The 63-day study is worth 30 observations per row below. So 1367 live
...
| 45-50% | 0.497 | 0.485 | 267 (129 hit) | -0.012 |
...
Leaned YES 729 times, NO 639 times. Over 63 days of history the
