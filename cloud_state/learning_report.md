...
Written 03 Sep 2026 4:11pm California time by `check.py --report`.
...
| fees paid | $242.43 |
| contracts looked at | 983 |
| retired (old rule, not counted) | 10 |
| of those, settled and learned from | 982 |
...
The 63-day study is worth 30 observations per row below. So 982 live
...
Leaned YES 534 times, NO 449 times. Over 63 days of history the
