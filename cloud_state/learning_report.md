...
Written 30 Aug 2026 12:58am California time by `check.py --report`.
...
| fees paid | $149.89 |
| contracts looked at | 549 |
| retired (old rule, not counted) | 10 |
| of those, settled and learned from | 548 |
...
The 63-day study is worth 30 observations per row below. So 548 live
...
| 45-50% | 0.497 | 0.437 | 107 (45 hit) | -0.060 ** |
| 50-55% | 0.558 | 0.540 | 127 (68 hit) | -0.018 |
...
Leaned YES 308 times, NO 241 times. Over 63 days of history the
