...
Written 07 Sep 2026 2:52pm California time by `check.py --report`.
...
| fees paid | $312.69 |
| contracts looked at | 1362 |
| retired (old rule, not counted) | 10 |
| of those, settled and learned from | 1361 |
...
The 63-day study is worth 30 observations per row below. So 1361 live
...
Leaned YES 727 times, NO 635 times. Over 63 days of history the
