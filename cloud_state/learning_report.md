...
Written 03 Sep 2026 10:18am California time by `check.py --report`.
...
| fees paid | $238.80 |
| contracts looked at | 960 |
| retired (old rule, not counted) | 10 |
| of those, settled and learned from | 959 |
...
The 63-day study is worth 30 observations per row below. So 959 live
...
Leaned YES 523 times, NO 437 times. Over 63 days of history the
