...
Written 31 Aug 2026 12:08am California time by `check.py --report`.
...
| fees paid | $172.64 |
| contracts looked at | 642 |
| retired (old rule, not counted) | 10 |
| of those, settled and learned from | 641 |
...
The 63-day study is worth 30 observations per row below. So 641 live
...
Leaned YES 352 times, NO 290 times. Over 63 days of history the
