...
Written 02 Sep 2026 3:56am California time by `check.py --report`.
...
| of those, settled and learned from | 845 |
...
The 63-day study is worth 30 observations per row below. So 845 live
...
| 45-50% | 0.497 | 0.455 | 161 (72 hit) | -0.042 ** |
