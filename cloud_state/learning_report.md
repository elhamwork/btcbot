...
Written 05 Sep 2026 2:14pm California time by `check.py --report`.
...
| fees paid | $278.41 |
| contracts looked at | 1167 |
| retired (old rule, not counted) | 10 |
| of those, settled and learned from | 1166 |
...
The 63-day study is worth 30 observations per row below. So 1166 live
...
| 45-50% | 0.497 | 0.478 | 223 (106 hit) | -0.019 |
...
Leaned YES 631 times, NO 536 times. Over 63 days of history the
