...
Written 25 Aug 2026 5:57pm California time by `check.py --report`.

## The short version

| | |
|---|---|
| **paper account** | **$1,184.30** (started $1,000, +18.4%) |
| best / worst it has been | $1,184.30 / $926.64 |
| fees paid | $43.29 |
...
| calls right | 26 of 30 (87%) |
| break-even needed | 80% |
| paper P&L | +8.0% per dollar staked |
...
| 50-55% | 0.558 | 0.536 | 46 (24 hit) | -0.022 ** |
| 55-60% | 0.605 | 0.552 | 30 (15 hit) | -0.052 ** |
| 60-65% | 0.678 | 0.688 | 17 (12 hit) | +0.010 |
...
Leaned YES 133 times, NO 86 times. Over 63 days of history the
