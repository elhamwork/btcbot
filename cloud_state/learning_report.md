...
Written 02 Sep 2026 12:26am California time by `check.py --report`.
...
| of those, settled and learned from | 831 |
...
The 63-day study is worth 30 observations per row below. So 831 live
