...
Written 01 Sep 2026 7:10am California time by `check.py --report`.

## The short version

| | |
|---|---|
| **paper account** | **$898.30** (started $1,000, -10.2%) |
| best / worst it has been | $1,511.25 / $831.40 |
| fees paid | $201.42 |
| contracts looked at | 763 |
| retired (old rule, not counted) | 10 |
| of those, settled and learned from | 762 |
| actual calls (graded GOOD) | 123 |
| calls that have settled | 122 |
| alerts that reached the phone | 71 of 71 |
| calls made before delivery was recorded | 52 |
| calls right | 99 of 122 (81%) |
...
The 63-day study is worth 30 observations per row below. So 762 live
...
| 35-40% | 0.354 | 0.359 | 47 (17 hit) | +0.005 |
| 40-45% | 0.384 | 0.364 | 98 (35 hit) | -0.021 ** |
| 45-50% | 0.497 | 0.449 | 148 (65 hit) | -0.048 ** |
| 50-55% | 0.558 | 0.542 | 167 (90 hit) | -0.016 |
| 55-60% | 0.605 | 0.531 | 106 (54 hit) | -0.074 ** |
| 60-65% | 0.678 | 0.644 | 59 (37 hit) | -0.034 ** |
...
Leaned YES 419 times, NO 344 times. Over 63 days of history the
...
|---|---|---|---|---|---|
| 14:03 | KXBTC15M-26SEP011015-15 | YES | 0.75 | $89.83 | $28.36 |
