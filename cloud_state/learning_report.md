...
Written 31 Aug 2026 1:32am California time by `check.py --report`.
...
| fees paid | $174.74 |
| contracts looked at | 648 |
| retired (old rule, not counted) | 10 |
| of those, settled and learned from | 647 |
...
The 63-day study is worth 30 observations per row below. So 647 live
...
| 50-55% | 0.558 | 0.532 | 148 (78 hit) | -0.025 ** |
...
Leaned YES 355 times, NO 293 times. Over 63 days of history the
