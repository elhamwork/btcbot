...
Written 02 Sep 2026 9:45am California time by `check.py --report`.
...
| of those, settled and learned from | 868 |
...
The 63-day study is worth 30 observations per row below. So 868 live
