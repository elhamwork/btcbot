...
Written 11 Sep 2026 6:55am California time by `check.py --report`.
...
| fees paid | $391.76 |
| contracts looked at | 1706 |
| retired (old rule, not counted) | 10 |
| of those, settled and learned from | 1705 |
...
The 63-day study is worth 30 observations per row below. So 1705 live
...
| 50-55% | 0.558 | 0.517 | 364 (187 hit) | -0.041 ** |
...
Leaned YES 907 times, NO 799 times. Over 63 days of history the
