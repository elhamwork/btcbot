...
Written 29 Aug 2026 4:41am California time by `check.py --report`.
...
| of those, settled and learned from | 467 |
...
The 63-day study is worth 30 observations per row below. So 467 live
