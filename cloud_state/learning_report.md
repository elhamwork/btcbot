...
Written 30 Aug 2026 7:42pm California time by `check.py --report`.
...
| fees paid | $169.27 |
| contracts looked at | 624 |
| retired (old rule, not counted) | 10 |
| of those, settled and learned from | 623 |
...
The 63-day study is worth 30 observations per row below. So 623 live
...
Leaned YES 344 times, NO 280 times. Over 63 days of history the
