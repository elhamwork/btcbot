...
Written 09 Sep 2026 3:38am California time by `check.py --report`.
...
| fees paid | $343.28 |
| contracts looked at | 1509 |
| retired (old rule, not counted) | 10 |
| of those, settled and learned from | 1508 |
...
The 63-day study is worth 30 observations per row below. So 1508 live
...
| 50-55% | 0.558 | 0.528 | 318 (167 hit) | -0.030 ** |
...
Leaned YES 801 times, NO 708 times. Over 63 days of history the
