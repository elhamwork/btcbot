...
Written 14 Sep 2026 5:47am California time by `check.py --report`.

## The short version

| | |
|---|---|
| **paper account** | **$1,971.29** (started $1,000, +97.1%) |
| best / worst it has been | $1,971.29 / $746.12 |
| fees paid | $469.41 |
| contracts looked at | 1990 |
| retired (old rule, not counted) | 10 |
| of those, settled and learned from | 1989 |
...
The 63-day study is worth 30 observations per row below. So 1989 live
...
Leaned YES 1072 times, NO 918 times. Over 63 days of history the
