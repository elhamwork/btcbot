...
Written 29 Aug 2026 10:09pm California time by `check.py --report`.
...
| fees paid | $149.89 |
| contracts looked at | 538 |
| retired (old rule, not counted) | 10 |
| of those, settled and learned from | 537 |
...
The 63-day study is worth 30 observations per row below. So 537 live
...
| 45-50% | 0.497 | 0.450 | 101 (44 hit) | -0.047 ** |
...
Leaned YES 303 times, NO 235 times. Over 63 days of history the
