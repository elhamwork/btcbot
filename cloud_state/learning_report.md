...
Written 03 Sep 2026 8:35pm California time by `check.py --report`.
...
| fees paid | $248.44 |
| contracts looked at | 1001 |
| retired (old rule, not counted) | 10 |
| of those, settled and learned from | 1000 |
...
The 63-day study is worth 30 observations per row below. So 1000 live
...
| 50-55% | 0.558 | 0.538 | 213 (114 hit) | -0.020 |
...
Leaned YES 548 times, NO 453 times. Over 63 days of history the
