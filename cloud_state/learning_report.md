...
Written 02 Sep 2026 4:42pm California time by `check.py --report`.
...
| fees paid | $232.57 |
| contracts looked at | 897 |
| retired (old rule, not counted) | 10 |
| of those, settled and learned from | 896 |
...
The 63-day study is worth 30 observations per row below. So 896 live
...
| 60-65% | 0.678 | 0.616 | 68 (40 hit) | -0.062 ** |
...
Leaned YES 489 times, NO 408 times. Over 63 days of history the
