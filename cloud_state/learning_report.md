...
Written 06 Sep 2026 12:48am California time by `check.py --report`.
...
| fees paid | $285.48 |
| contracts looked at | 1210 |
| retired (old rule, not counted) | 10 |
| of those, settled and learned from | 1209 |
...
The 63-day study is worth 30 observations per row below. So 1209 live
...
| 45-50% | 0.497 | 0.485 | 236 (114 hit) | -0.012 |
...
Leaned YES 651 times, NO 559 times. Over 63 days of history the
