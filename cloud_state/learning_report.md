...
Written 08 Sep 2026 5:36pm California time by `check.py --report`.
...
| of those, settled and learned from | 1468 |
...
The 63-day study is worth 30 observations per row below. So 1468 live
...
| 50-55% | 0.558 | 0.518 | 307 (158 hit) | -0.039 ** |
