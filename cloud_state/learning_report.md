...
Written 27 Aug 2026 11:56am California time by `check.py --report`.
...
| fees paid | $81.30 |
| contracts looked at | 346 |
| retired (old rule, not counted) | 10 |
| of those, settled and learned from | 345 |
...
The 63-day study is worth 30 observations per row below. So 345 live
...
| 40-45% | 0.384 | 0.350 | 43 (14 hit) | -0.035 ** |
...
Leaned YES 193 times, NO 153 times. Over 63 days of history the
