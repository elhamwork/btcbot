...
Written 29 Aug 2026 10:19pm California time by `check.py --report`.
...
| fees paid | $149.89 |
| contracts looked at | 539 |
| retired (old rule, not counted) | 10 |
| of those, settled and learned from | 538 |
...
The 63-day study is worth 30 observations per row below. So 538 live
...
Leaned YES 303 times, NO 236 times. Over 63 days of history the
