...
Written 28 Aug 2026 4:40am California time by `check.py --report`.
...
| of those, settled and learned from | 386 |
...
The 63-day study is worth 30 observations per row below. So 386 live
...
| 50-55% | 0.558 | 0.519 | 85 (43 hit) | -0.038 ** |
