...
Written 12 Sep 2026 10:31am California time by `check.py --report`.
...
| fees paid | $409.43 |
| contracts looked at | 1817 |
| retired (old rule, not counted) | 10 |
| of those, settled and learned from | 1815 |
...
The 63-day study is worth 30 observations per row below. So 1815 live
...
| 55-60% | 0.605 | 0.535 | 271 (143 hit) | -0.070 ** |
...
Leaned YES 971 times, NO 846 times. Over 63 days of history the
