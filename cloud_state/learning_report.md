...
Written 07 Sep 2026 3:45am California time by `check.py --report`.
...
| fees paid | $308.56 |
| contracts looked at | 1317 |
| retired (old rule, not counted) | 10 |
| of those, settled and learned from | 1316 |
...
The 63-day study is worth 30 observations per row below. So 1316 live
...
| 45-50% | 0.497 | 0.480 | 257 (123 hit) | -0.016 |
...
Leaned YES 701 times, NO 616 times. Over 63 days of history the
