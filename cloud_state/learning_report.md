...
Written 27 Aug 2026 12:06pm California time by `check.py --report`.
...
| of those, settled and learned from | 346 |
...
The 63-day study is worth 30 observations per row below. So 346 live
...
| 45-50% | 0.497 | 0.467 | 64 (29 hit) | -0.030 ** |
