...
Written 08 Sep 2026 2:35am California time by `check.py --report`.
...
| GOOD | 195 |
| BAD (cheap side) | 183 |
| WEAK (small disagreement) | 79 |
| BAD (last 5 min) | 11 |
| ALMOST (not confirmed yet) | 8 |
| WEAK (5-10 min) | 5 |

Leaned YES 747 times, NO 662 times. Over 63 days of history the
