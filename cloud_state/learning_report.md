...
Written 26 Aug 2026 10:36pm California time by `check.py --report`.
...
| fees paid | $70.43 |
| contracts looked at | 313 |
| retired (old rule, not counted) | 10 |
| of those, settled and learned from | 312 |
...
The 63-day study is worth 30 observations per row below. So 312 live
...
Leaned YES 181 times, NO 132 times. Over 63 days of history the
