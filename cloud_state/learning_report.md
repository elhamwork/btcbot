...
Written 07 Sep 2026 8:04pm California time by `check.py --report`.
...
| fees paid | $314.03 |
| contracts looked at | 1383 |
| retired (old rule, not counted) | 10 |
| of those, settled and learned from | 1382 |
...
The 63-day study is worth 30 observations per row below. So 1382 live
...
| 45-50% | 0.497 | 0.485 | 273 (132 hit) | -0.012 |
...
Leaned YES 733 times, NO 650 times. Over 63 days of history the
