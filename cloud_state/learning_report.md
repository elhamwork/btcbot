...
Written 28 Aug 2026 2:35am California time by `check.py --report`.
...
| of those, settled and learned from | 378 |
...
The 63-day study is worth 30 observations per row below. So 378 live
