...
Written 09 Sep 2026 11:40am California time by `check.py --report`.
...
| fees paid | $348.08 |
| contracts looked at | 1541 |
| retired (old rule, not counted) | 10 |
| of those, settled and learned from | 1540 |
| actual calls (graded GOOD) | 222 |
| calls that have settled | 222 |
| alerts that reached the phone | 170 of 170 |
...
The 63-day study is worth 30 observations per row below. So 1540 live
...
| 35-40% | 0.354 | 0.383 | 110 (43 hit) | +0.029 ** |
| 40-45% | 0.384 | 0.393 | 195 (77 hit) | +0.009 |
| 45-50% | 0.497 | 0.481 | 311 (149 hit) | -0.016 |
| 50-55% | 0.558 | 0.519 | 324 (167 hit) | -0.039 ** |
| 55-60% | 0.605 | 0.538 | 221 (117 hit) | -0.067 ** |
| 60-65% | 0.678 | 0.591 | 116 (66 hit) | -0.087 ** |
| 65-70% | 0.738 | 0.674 | 77 (50 hit) | -0.064 ** |
...
Leaned YES 814 times, NO 727 times. Over 63 days of history the
