...
Written 07 Sep 2026 11:58am California time by `check.py --report`.
...
| fees paid | $311.46 |
| contracts looked at | 1350 |
| retired (old rule, not counted) | 10 |
| of those, settled and learned from | 1349 |
...
The 63-day study is worth 30 observations per row below. So 1349 live
...
| 55-60% | 0.605 | 0.548 | 202 (109 hit) | -0.057 ** |
...
Leaned YES 720 times, NO 630 times. Over 63 days of history the
