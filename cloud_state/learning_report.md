...
Written 12 Sep 2026 11:09am California time by `check.py --report`.
...
| fees paid | $409.43 |
| contracts looked at | 1819 |
| retired (old rule, not counted) | 10 |
| of those, settled and learned from | 1818 |
...
The 63-day study is worth 30 observations per row below. So 1818 live
...
| 45-50% | 0.497 | 0.467 | 370 (172 hit) | -0.030 ** |
...
Leaned YES 971 times, NO 848 times. Over 63 days of history the
