...
Written 06 Sep 2026 9:12pm California time by `check.py --report`.
...
| fees paid | $306.83 |
| contracts looked at | 1291 |
| retired (old rule, not counted) | 10 |
| of those, settled and learned from | 1290 |
...
The 63-day study is worth 30 observations per row below. So 1290 live
...
| 50-55% | 0.558 | 0.529 | 270 (142 hit) | -0.029 ** |
...
Leaned YES 687 times, NO 604 times. Over 63 days of history the
