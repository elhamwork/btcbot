...
Written 31 Aug 2026 12:53pm California time by `check.py --report`.
...
| of those, settled and learned from | 689 |
...
The 63-day study is worth 30 observations per row below. So 689 live
...
| 40-45% | 0.384 | 0.360 | 91 (32 hit) | -0.025 ** |
