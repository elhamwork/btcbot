...
Written 29 Aug 2026 3:42pm California time by `check.py --report`.
...
| fees paid | $139.26 |
| contracts looked at | 512 |
| retired (old rule, not counted) | 10 |
| of those, settled and learned from | 511 |
...
The 63-day study is worth 30 observations per row below. So 511 live
...
Leaned YES 288 times, NO 224 times. Over 63 days of history the
