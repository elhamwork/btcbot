...
Written 07 Sep 2026 7:49am California time by `check.py --report`.
...
| fees paid | $309.66 |
| contracts looked at | 1334 |
| retired (old rule, not counted) | 10 |
| of those, settled and learned from | 1333 |
...
The 63-day study is worth 30 observations per row below. So 1333 live
...
| 45-50% | 0.497 | 0.482 | 260 (125 hit) | -0.014 |
...
Leaned YES 710 times, NO 624 times. Over 63 days of history the
