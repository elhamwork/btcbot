...
Written 06 Sep 2026 11:54am California time by `check.py --report`.
...
| fees paid | $295.52 |
| contracts looked at | 1254 |
| retired (old rule, not counted) | 10 |
| of those, settled and learned from | 1253 |
| actual calls (graded GOOD) | 189 |
| calls that have settled | 189 |
| alerts that reached the phone | 137 of 137 |
...
The 63-day study is worth 30 observations per row below. So 1253 live
...
| 50-55% | 0.558 | 0.528 | 261 (137 hit) | -0.029 ** |
...
Leaned YES 669 times, NO 585 times. Over 63 days of history the
