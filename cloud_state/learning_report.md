...
Written 14 Sep 2026 3:21am California time by `check.py --report`.
...
| of those, settled and learned from | 1979 |
...
The 63-day study is worth 30 observations per row below. So 1979 live
...
| 50-55% | 0.558 | 0.516 | 419 (215 hit) | -0.042 ** |
