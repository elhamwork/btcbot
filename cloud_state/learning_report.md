...
Written 27 Aug 2026 2:22am California time by `check.py --report`.

## The short version

| | |
|---|---|
| **paper account** | **$1,206.68** (started $1,000, +20.7%) |
| best / worst it has been | $1,279.61 / $926.62 |
| fees paid | $72.48 |
| contracts looked at | 320 |
| retired (old rule, not counted) | 10 |
| of those, settled and learned from | 319 |
...
The 63-day study is worth 30 observations per row below. So 319 live
...
| 40-45% | 0.384 | 0.372 | 36 (13 hit) | -0.013 |
| 45-50% | 0.497 | 0.470 | 57 (26 hit) | -0.027 ** |
| 50-55% | 0.558 | 0.512 | 73 (36 hit) | -0.046 ** |
| 55-60% | 0.605 | 0.573 | 47 (26 hit) | -0.032 ** |
...
Leaned YES 186 times, NO 134 times. Over 63 days of history the
