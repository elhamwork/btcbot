...
Written 04 Sep 2026 2:58am California time by `check.py --report`.
...
| fees paid | $253.95 |
| contracts looked at | 1026 |
| retired (old rule, not counted) | 10 |
| of those, settled and learned from | 1025 |
...
The 63-day study is worth 30 observations per row below. So 1025 live
...
| 60-65% | 0.678 | 0.585 | 80 (44 hit) | -0.093 ** |
...
Leaned YES 559 times, NO 467 times. Over 63 days of history the
