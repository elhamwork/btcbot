...
Written 29 Aug 2026 5:07am California time by `check.py --report`.
...
| fees paid | $121.55 |
| contracts looked at | 470 |
| retired (old rule, not counted) | 10 |
| of those, settled and learned from | 469 |
...
The 63-day study is worth 30 observations per row below. So 469 live
...
| 50-55% | 0.558 | 0.513 | 106 (53 hit) | -0.045 ** |
...
Leaned YES 257 times, NO 213 times. Over 63 days of history the
