...
Written 09 Sep 2026 3:19pm California time by `check.py --report`.
...
| fees paid | $350.03 |
| contracts looked at | 1556 |
| retired (old rule, not counted) | 10 |
| of those, settled and learned from | 1555 |
...
The 63-day study is worth 30 observations per row below. So 1555 live
...
| 45-50% | 0.497 | 0.478 | 313 (149 hit) | -0.019 |
...
Leaned YES 822 times, NO 734 times. Over 63 days of history the
