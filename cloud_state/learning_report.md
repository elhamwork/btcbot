...
Written 07 Sep 2026 2:19am California time by `check.py --report`.
...
| fees paid | $306.83 |
| contracts looked at | 1312 |
| retired (old rule, not counted) | 10 |
| of those, settled and learned from | 1311 |
...
The 63-day study is worth 30 observations per row below. So 1311 live
...
| 40-45% | 0.384 | 0.395 | 169 (67 hit) | +0.010 |
...
Leaned YES 697 times, NO 615 times. Over 63 days of history the
