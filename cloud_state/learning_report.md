...
Written 02 Sep 2026 11:24pm California time by `check.py --report`.
...
| fees paid | $236.74 |
| contracts looked at | 924 |
| retired (old rule, not counted) | 10 |
| of those, settled and learned from | 923 |
...
The 63-day study is worth 30 observations per row below. So 923 live
...
| 35-40% | 0.354 | 0.369 | 61 (23 hit) | +0.015 |
...
| 60-65% | 0.678 | 0.594 | 75 (42 hit) | -0.084 ** |
...
Leaned YES 500 times, NO 424 times. Over 63 days of history the
