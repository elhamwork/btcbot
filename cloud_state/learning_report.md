...
Written 03 Sep 2026 2:45am California time by `check.py --report`.
...
| fees paid | $236.74 |
| contracts looked at | 930 |
| retired (old rule, not counted) | 10 |
| of those, settled and learned from | 928 |
...
The 63-day study is worth 30 observations per row below. So 928 live
...
| 50-55% | 0.558 | 0.532 | 199 (105 hit) | -0.026 ** |
...
Leaned YES 503 times, NO 427 times. Over 63 days of history the
