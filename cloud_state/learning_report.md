...
Written 31 Aug 2026 3:27am California time by `check.py --report`.
...
| fees paid | $176.51 |
| contracts looked at | 655 |
| retired (old rule, not counted) | 10 |
| of those, settled and learned from | 654 |
...
The 63-day study is worth 30 observations per row below. So 654 live
...
Leaned YES 359 times, NO 296 times. Over 63 days of history the
