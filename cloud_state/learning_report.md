...
Written 29 Aug 2026 1:53am California time by `check.py --report`.
...
| fees paid | $121.55 |
| contracts looked at | 459 |
| retired (old rule, not counted) | 10 |
| of those, settled and learned from | 458 |
...
The 63-day study is worth 30 observations per row below. So 458 live
...
Leaned YES 248 times, NO 211 times. Over 63 days of history the
