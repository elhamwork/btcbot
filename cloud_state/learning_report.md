...
Written 08 Sep 2026 1:24am California time by `check.py --report`.
...
| fees paid | $318.84 |
| contracts looked at | 1404 |
| retired (old rule, not counted) | 10 |
| of those, settled and learned from | 1403 |
...
The 63-day study is worth 30 observations per row below. So 1403 live
...
| 55-60% | 0.605 | 0.545 | 209 (112 hit) | -0.060 ** |
...
Leaned YES 744 times, NO 660 times. Over 63 days of history the
