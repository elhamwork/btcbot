...
Written 13 Sep 2026 2:08am California time by `check.py --report`.
...
| fees paid | $413.22 |
| contracts looked at | 1879 |
| retired (old rule, not counted) | 10 |
| of those, settled and learned from | 1878 |
| actual calls (graded GOOD) | 259 |
| calls that have settled | 259 |
| alerts that reached the phone | 207 of 207 |
...
The 63-day study is worth 30 observations per row below. So 1878 live
...
| 45-50% | 0.497 | 0.458 | 378 (172 hit) | -0.039 ** |
| 50-55% | 0.558 | 0.512 | 397 (202 hit) | -0.045 ** |
| 55-60% | 0.605 | 0.543 | 285 (153 hit) | -0.062 ** |
| 60-65% | 0.678 | 0.597 | 148 (86 hit) | -0.081 ** |
...
Leaned YES 1008 times, NO 871 times. Over 63 days of history the
