...
Written 29 Aug 2026 12:15pm California time by `check.py --report`.
...
| of those, settled and learned from | 497 |
...
The 63-day study is worth 30 observations per row below. So 497 live
