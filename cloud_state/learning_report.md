...
Written 01 Sep 2026 7:37pm California time by `check.py --report`.
...
| fees paid | $208.28 |
| contracts looked at | 813 |
| retired (old rule, not counted) | 10 |
| of those, settled and learned from | 812 |
...
The 63-day study is worth 30 observations per row below. So 812 live
...
Leaned YES 450 times, NO 363 times. Over 63 days of history the
