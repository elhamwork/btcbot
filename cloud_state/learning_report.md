...
Written 30 Aug 2026 11:57pm California time by `check.py --report`.
...
| fees paid | $172.64 |
| contracts looked at | 641 |
| retired (old rule, not counted) | 10 |
| of those, settled and learned from | 640 |
...
The 63-day study is worth 30 observations per row below. So 640 live
...
| 40-45% | 0.384 | 0.373 | 84 (31 hit) | -0.011 |
...
Leaned YES 352 times, NO 289 times. Over 63 days of history the
