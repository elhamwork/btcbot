...
Written 13 Sep 2026 5:13pm California time by `check.py --report`.
...
| fees paid | $445.35 |
| contracts looked at | 1939 |
| retired (old rule, not counted) | 10 |
| of those, settled and learned from | 1938 |
...
The 63-day study is worth 30 observations per row below. So 1938 live
...
| 45-50% | 0.497 | 0.457 | 390 (177 hit) | -0.040 ** |
...
Leaned YES 1048 times, NO 891 times. Over 63 days of history the
