...
Written 05 Sep 2026 9:22pm California time by `check.py --report`.
...
| fees paid | $284.46 |
| contracts looked at | 1196 |
| retired (old rule, not counted) | 10 |
| of those, settled and learned from | 1195 |
...
The 63-day study is worth 30 observations per row below. So 1195 live
...
Leaned YES 643 times, NO 553 times. Over 63 days of history the
