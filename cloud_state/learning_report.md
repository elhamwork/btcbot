...
Written 28 Aug 2026 2:25am California time by `check.py --report`.
...
| fees paid | $91.54 |
| contracts looked at | 378 |
| retired (old rule, not counted) | 10 |
| of those, settled and learned from | 377 |
...
The 63-day study is worth 30 observations per row below. So 377 live
...
Leaned YES 205 times, NO 173 times. Over 63 days of history the
