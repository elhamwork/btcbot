...
Written 06 Sep 2026 1:38pm California time by `check.py --report`.
...
| fees paid | $297.46 |
| contracts looked at | 1261 |
| retired (old rule, not counted) | 10 |
| of those, settled and learned from | 1260 |
...
The 63-day study is worth 30 observations per row below. So 1260 live
...
Leaned YES 670 times, NO 591 times. Over 63 days of history the
