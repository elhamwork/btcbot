...
Written 09 Sep 2026 4:21pm California time by `check.py --report`.
...
| fees paid | $350.03 |
| contracts looked at | 1560 |
| retired (old rule, not counted) | 10 |
| of those, settled and learned from | 1559 |
...
The 63-day study is worth 30 observations per row below. So 1559 live
...
Leaned YES 824 times, NO 736 times. Over 63 days of history the
