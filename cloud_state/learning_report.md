...
Written 12 Sep 2026 12:05am California time by `check.py --report`.
...
| fees paid | $407.55 |
| contracts looked at | 1775 |
| retired (old rule, not counted) | 10 |
| of those, settled and learned from | 1774 |
...
The 63-day study is worth 30 observations per row below. So 1774 live
...
| 55-60% | 0.605 | 0.537 | 259 (137 hit) | -0.068 ** |
...
Leaned YES 945 times, NO 830 times. Over 63 days of history the
