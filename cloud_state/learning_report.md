...
Written 12 Sep 2026 7:06am California time by `check.py --report`.
...
| fees paid | $407.55 |
| contracts looked at | 1803 |
| retired (old rule, not counted) | 10 |
| of those, settled and learned from | 1802 |
...
The 63-day study is worth 30 observations per row below. So 1802 live
...
| 45-50% | 0.497 | 0.470 | 363 (170 hit) | -0.026 ** |
...
Leaned YES 964 times, NO 839 times. Over 63 days of history the
