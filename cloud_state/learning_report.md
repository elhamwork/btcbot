...
Written 11 Sep 2026 2:01pm California time by `check.py --report`.
...
| fees paid | $394.66 |
| contracts looked at | 1735 |
| retired (old rule, not counted) | 10 |
| of those, settled and learned from | 1733 |
...
The 63-day study is worth 30 observations per row below. So 1733 live
...
Leaned YES 919 times, NO 816 times. Over 63 days of history the
