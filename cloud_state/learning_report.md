...
Written 29 Aug 2026 7:13pm California time by `check.py --report`.

## The short version

| | |
|---|---|
| **paper account** | **$1,161.84** (started $1,000, +16.2%) |
| best / worst it has been | $1,433.36 / $926.62 |
| fees paid | $144.70 |
| contracts looked at | 526 |
| retired (old rule, not counted) | 10 |
| of those, settled and learned from | 525 |
| actual calls (graded GOOD) | 88 |
| calls that have settled | 87 |
| alerts that reached the phone | 36 of 36 |
| calls made before delivery was recorded | 52 |
| calls right | 72 of 87 (83%) |
...
The 63-day study is worth 30 observations per row below. So 525 live
...
Leaned YES 295 times, NO 231 times. Over 63 days of history the
...
|---|---|---|---|---|---|
| 02:04 | KXBTC15M-26AUG292215-15 | YES | 0.74 | $116.18 | $38.70 |
