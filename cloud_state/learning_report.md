...
Written 01 Sep 2026 11:40am California time by `check.py --report`.
...
| fees paid | $203.91 |
| contracts looked at | 781 |
| retired (old rule, not counted) | 10 |
| of those, settled and learned from | 780 |
...
The 63-day study is worth 30 observations per row below. So 780 live
...
Leaned YES 432 times, NO 349 times. Over 63 days of history the
