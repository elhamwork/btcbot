...
Written 09 Sep 2026 6:51pm California time by `check.py --report`.
...
| fees paid | $354.20 |
| contracts looked at | 1570 |
| retired (old rule, not counted) | 10 |
| of those, settled and learned from | 1569 |
...
The 63-day study is worth 30 observations per row below. So 1569 live
...
| 40-45% | 0.384 | 0.393 | 198 (78 hit) | +0.008 |
...
Leaned YES 829 times, NO 741 times. Over 63 days of history the
