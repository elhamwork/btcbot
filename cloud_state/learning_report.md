...
Written 09 Sep 2026 10:48pm California time by `check.py --report`.
...
| fees paid | $364.05 |
| contracts looked at | 1586 |
| retired (old rule, not counted) | 10 |
| of those, settled and learned from | 1585 |
...
The 63-day study is worth 30 observations per row below. So 1585 live
...
| 50-55% | 0.558 | 0.524 | 332 (173 hit) | -0.034 ** |
...
Leaned YES 839 times, NO 747 times. Over 63 days of history the
