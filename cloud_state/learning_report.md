...
Written 01 Sep 2026 12:42am California time by `check.py --report`.
...
| fees paid | $193.54 |
| contracts looked at | 737 |
| retired (old rule, not counted) | 10 |
| of those, settled and learned from | 736 |
...
The 63-day study is worth 30 observations per row below. So 736 live
...
| 55-60% | 0.605 | 0.540 | 100 (52 hit) | -0.065 ** |
...
Leaned YES 403 times, NO 334 times. Over 63 days of history the
