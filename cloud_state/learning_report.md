...
Written 07 Sep 2026 4:13pm California time by `check.py --report`.
...
| fees paid | $312.69 |
| contracts looked at | 1367 |
| retired (old rule, not counted) | 10 |
| of those, settled and learned from | 1366 |
...
The 63-day study is worth 30 observations per row below. So 1366 live
...
Leaned YES 728 times, NO 639 times. Over 63 days of history the
