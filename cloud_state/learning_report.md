...
Written 31 Aug 2026 1:06am California time by `check.py --report`.
...
| of those, settled and learned from | 645 |
...
The 63-day study is worth 30 observations per row below. So 645 live
