...
Written 29 Aug 2026 7:18pm California time by `check.py --report`.
...
| fees paid | $146.82 |
| contracts looked at | 527 |
| retired (old rule, not counted) | 10 |
| of those, settled and learned from | 526 |
...
The 63-day study is worth 30 observations per row below. So 526 live
...
| 50-55% | 0.558 | 0.531 | 122 (64 hit) | -0.027 ** |
...
Leaned YES 296 times, NO 231 times. Over 63 days of history the
