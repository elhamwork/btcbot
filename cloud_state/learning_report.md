...
Written 07 Sep 2026 7:11pm California time by `check.py --report`.
...
| fees paid | $314.03 |
| contracts looked at | 1379 |
| retired (old rule, not counted) | 10 |
| of those, settled and learned from | 1378 |
...
The 63-day study is worth 30 observations per row below. So 1378 live
...
Leaned YES 732 times, NO 647 times. Over 63 days of history the
